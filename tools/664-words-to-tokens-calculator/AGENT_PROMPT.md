# AGENT PROMPT: Build Words to Tokens Calculator

You are a tool-building agent. Your job is to build ONE tool: **Words to Tokens Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/words-to-tokens-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/words-to-tokens-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/words-to-tokens-calculator**
