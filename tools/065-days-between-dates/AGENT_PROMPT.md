---
You are building Tool #065: Days Between Dates
...
6. /tool-empire-v3/tools/065-days-between-dates/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Days Between Dates
Target keyword: days between dates calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full days between dates with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "days between dates calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/days-between-dates/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/days-between-dates.ts
...
/tool-empire-v3/src/app/tools/days-between-dates/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Days Between Dates Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free days between dates. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/065-days-between-dates/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Days Between Dates is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/065-days-between-dates/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/days-between-dates**
