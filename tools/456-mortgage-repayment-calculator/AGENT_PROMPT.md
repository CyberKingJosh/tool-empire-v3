# AGENT PROMPT: Build Mortgage Repayment Calculator

You are a tool-building agent. Your job is to build ONE tool: **Mortgage Repayment Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mortgage-repayment-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mortgage-repayment-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mortgage-repayment-calculator**
