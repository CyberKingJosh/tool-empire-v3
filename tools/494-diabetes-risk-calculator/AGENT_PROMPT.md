# AGENT PROMPT: Build Diabetes Risk Calculator

You are a tool-building agent. Your job is to build ONE tool: **Diabetes Risk Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/diabetes-risk-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/diabetes-risk-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/diabetes-risk-calculator**
