# AGENT PROMPT: Build Speech to Text

You are a tool-building agent. Your job is to build ONE tool: **Speech to Text**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/speech-to-text.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/speech-to-text/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/speech-to-text**
