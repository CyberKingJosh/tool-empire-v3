---
You are building Tool #079: Weight Converter
...
6. /tool-empire-v3/tools/079-weight-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Weight Converter
Target keyword: weight converter
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full weight converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "weight converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/weight-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/weight-converter.ts
...
/tool-empire-v3/src/app/tools/weight-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Weight Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free weight converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/079-weight-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Weight Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/079-weight-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/weight-converter**
