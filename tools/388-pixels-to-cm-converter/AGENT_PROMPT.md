# AGENT PROMPT: Build PIXELS to CM Converter

You are a tool-building agent. Your job is to build ONE tool: **PIXELS to CM Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pixels-to-cm-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pixels-to-cm-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pixels-to-cm-converter**
