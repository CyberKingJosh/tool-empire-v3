# AGENT PROMPT: Build Whiteboard Online

You are a tool-building agent. Your job is to build ONE tool: **Whiteboard Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/whiteboard-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/whiteboard-online/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/whiteboard-online**
