# AGENT PROMPT: Build Invoice Template AU

Build ONE tool: **Invoice Template AU**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: invoice-template-au | Category: finance | Type: A | Tier: One
Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/invoice-template-au.ts (logic) + src/app/tools/invoice-template-au/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/invoice-template-au**
