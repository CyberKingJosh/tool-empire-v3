# AGENT PROMPT: Build Tennis String Tension Calc

You are a tool-building agent. Build ONE tool: **Tennis String Tension Calc**.
...
## Tool: Tennis String Tension Calc
- Slug: tennis-string-tension-calc | Category: general | Type: A | Tier: Two | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/tennis-string-tension-calc.ts — pure logic
2. Create src/app/tools/tennis-string-tension-calc/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/tennis-string-tension-calc**
