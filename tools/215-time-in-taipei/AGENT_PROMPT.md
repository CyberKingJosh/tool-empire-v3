# AGENT PROMPT: Build Time in Taipei

You are a tool-building agent. Your job is to build ONE tool: **Time in Taipei**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-taipei.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-taipei/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-taipei**
