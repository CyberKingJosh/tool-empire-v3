# AGENT PROMPT: Build Time in New York

You are a tool-building agent. Your job is to build ONE tool: **Time in New York**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-new-york.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-new-york/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-new-york**
