# AGENT PROMPT: Build Kilojoules to Calories

You are a tool-building agent. Build ONE tool: **Kilojoules to Calories**.
...
## Tool: Kilojoules to Calories
- Slug: kilojoules-to-calories | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/kilojoules-to-calories.ts — pure logic
2. Create src/app/tools/kilojoules-to-calories/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/kilojoules-to-calories**
