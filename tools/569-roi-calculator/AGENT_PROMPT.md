# AGENT PROMPT: Build ROI Calculator

You are a tool-building agent. Your job is to build ONE tool: **ROI Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/roi-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/roi-calculator/page.tsx` — full page component
