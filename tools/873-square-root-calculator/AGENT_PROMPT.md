# AGENT PROMPT: Build Square Root Calculator

You are a tool-building agent. Your job is to build ONE tool: **Square Root Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/square-root-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/square-root-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/square-root-calculator**
