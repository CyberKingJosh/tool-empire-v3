# AGENT PROMPT: Build Snowboard Size Calculator

You are a tool-building agent. Build ONE tool: **Snowboard Size Calculator**.
...
## Tool: Snowboard Size Calculator
- Slug: snowboard-size-calculator | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/snowboard-size-calculator.ts — pure logic
2. Create src/app/tools/snowboard-size-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/snowboard-size-calculator**
