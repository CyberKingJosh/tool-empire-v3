# AGENT PROMPT: Build Melbourne to Tokyo Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Melbourne to Tokyo Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Melbourne to Tokyo Time Difference
- **Slug**: melbourne-to-tokyo-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/melbourne-to-tokyo-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/melbourne-to-tokyo-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/melbourne-to-tokyo-time-difference**
