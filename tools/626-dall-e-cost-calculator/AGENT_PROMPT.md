# AGENT PROMPT: Build DALL-E Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **DALL-E Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dall-e-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dall-e-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dall-e-cost-calculator**
