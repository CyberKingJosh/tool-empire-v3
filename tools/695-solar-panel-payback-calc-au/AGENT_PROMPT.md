# AGENT PROMPT: Build Solar Panel Payback Calc AU

You are a tool-building agent. Your job is to build ONE tool: **Solar Panel Payback Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/solar-panel-payback-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/solar-panel-payback-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/solar-panel-payback-calc-au**
