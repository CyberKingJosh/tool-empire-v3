# AGENT PROMPT: Build LMI Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **LMI Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/lmi-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/lmi-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/lmi-calculator-au**
