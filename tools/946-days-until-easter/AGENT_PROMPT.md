# AGENT PROMPT: Build Days Until Easter

You are a tool-building agent. Build ONE tool: **Days Until Easter**.
...
## Tool: Days Until Easter
- Slug: days-until-easter | Category: date | Type: A | Tier: One | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-easter.ts — pure logic
2. Create src/app/tools/days-until-easter/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-easter**
