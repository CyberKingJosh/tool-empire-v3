---
You are building Tool #131: Body Fat Calculator
...
6. /tool-empire-v3/tools/131-body-fat-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Body Fat Calculator
Target keyword: body fat percentage calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full body fat calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "body fat percentage calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/body-fat-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/body-fat-calculator.ts
...
/tool-empire-v3/src/app/tools/body-fat-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Body Fat Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free body fat calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/131-body-fat-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Body Fat Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/131-body-fat-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/body-fat-calculator**
