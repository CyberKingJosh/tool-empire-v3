# AGENT PROMPT: Build Time in Jakarta

You are a tool-building agent. Your job is to build ONE tool: **Time in Jakarta**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-jakarta.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-jakarta/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-jakarta**
