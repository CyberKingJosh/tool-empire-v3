# AGENT PROMPT: Build Time in Los Angeles

You are a tool-building agent. Your job is to build ONE tool: **Time in Los Angeles**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-los-angeles.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-los-angeles/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-los-angeles**
