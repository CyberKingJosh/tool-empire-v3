# AGENT PROMPT: Build KW to HP Converter

You are a tool-building agent. Your job is to build ONE tool: **KW to HP Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/kw-to-hp-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/kw-to-hp-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/kw-to-hp-converter**
