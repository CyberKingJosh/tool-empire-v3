# AGENT PROMPT: Build Pet Weight Calculator

You are a tool-building agent. Your job is to build ONE tool: **Pet Weight Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pet-weight-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pet-weight-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pet-weight-calculator**
