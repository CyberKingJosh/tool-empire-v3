# AGENT PROMPT: Build CUPS to GRAMS Converter

You are a tool-building agent. Your job is to build ONE tool: **CUPS to GRAMS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cups-to-grams-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cups-to-grams-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cups-to-grams-converter**
