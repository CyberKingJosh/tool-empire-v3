# AGENT PROMPT: Build CELSIUS to FAHRENHEIT Converter

You are a tool-building agent. Your job is to build ONE tool: **CELSIUS to FAHRENHEIT Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/celsius-to-fahrenheit-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/celsius-to-fahrenheit-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/celsius-to-fahrenheit-converter**
