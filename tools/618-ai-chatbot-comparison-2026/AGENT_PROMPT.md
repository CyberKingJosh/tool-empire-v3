# AGENT PROMPT: Build AI Chatbot Comparison 2026

You are a tool-building agent. Your job is to build ONE tool: **AI Chatbot Comparison 2026**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-chatbot-comparison-2026.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-chatbot-comparison-2026/page.tsx` — full page component
