# AGENT PROMPT: Build UUID Generator

You are a tool-building agent. Your job is to build ONE tool: **UUID Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/uuid-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/uuid-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/uuid-generator**
