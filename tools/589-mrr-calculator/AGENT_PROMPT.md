# AGENT PROMPT: Build MRR Calculator

You are a tool-building agent. Your job is to build ONE tool: **MRR Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mrr-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mrr-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mrr-calculator**
