# AGENT PROMPT: Build GB to TB Converter

You are a tool-building agent. Your job is to build ONE tool: **GB to TB Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gb-to-tb-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gb-to-tb-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gb-to-tb-converter**
