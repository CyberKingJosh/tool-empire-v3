# AGENT PROMPT: Build Random Password Generator

You are a tool-building agent. Your job is to build ONE tool: **Random Password Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/random-password-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/random-password-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/random-password-generator**
