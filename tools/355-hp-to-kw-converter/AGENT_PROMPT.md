# AGENT PROMPT: Build HP to KW Converter

You are a tool-building agent. Your job is to build ONE tool: **HP to KW Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hp-to-kw-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hp-to-kw-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hp-to-kw-converter**
