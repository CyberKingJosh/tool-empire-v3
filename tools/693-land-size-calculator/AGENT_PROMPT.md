# AGENT PROMPT: Build Land Size Calculator

You are a tool-building agent. Your job is to build ONE tool: **Land Size Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/land-size-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/land-size-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/land-size-calculator**
