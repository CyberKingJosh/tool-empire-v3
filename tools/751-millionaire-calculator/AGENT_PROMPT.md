# AGENT PROMPT: Build Millionaire Calculator

You are a tool-building agent. Your job is to build ONE tool: **Millionaire Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/millionaire-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/millionaire-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/millionaire-calculator**
