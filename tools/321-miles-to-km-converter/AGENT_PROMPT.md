# AGENT PROMPT: Build MILES to KM Converter

You are a tool-building agent. Your job is to build ONE tool: **MILES to KM Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/miles-to-km-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/miles-to-km-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/miles-to-km-converter**
