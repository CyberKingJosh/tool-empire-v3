# AGENT PROMPT: Build CUPS to ML Converter

You are a tool-building agent. Your job is to build ONE tool: **CUPS to ML Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cups-to-ml-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cups-to-ml-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cups-to-ml-converter**
