# AGENT PROMPT: Build Taxi Fare Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Taxi Fare Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/taxi-fare-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/taxi-fare-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/taxi-fare-calculator-au**
