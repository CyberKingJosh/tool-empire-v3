# AGENT PROMPT: Build Private Health Compare AU

You are a tool-building agent. Your job is to build ONE tool: **Private Health Compare AU**.
...
## Step 2 — Tool Summary
- **Name**: Private Health Compare AU
- **Slug**: private-health-compare-au
- **Category**: health
...
## Step 4 — Build Steps
1. Create `src/lib/tools/private-health-compare-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/private-health-compare-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/private-health-compare-au**
