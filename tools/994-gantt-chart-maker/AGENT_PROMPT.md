# AGENT PROMPT: Build Gantt Chart Maker

Build ONE tool: **Gantt Chart Maker**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: gantt-chart-maker | Category: general | Type: A | Tier: One
Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/gantt-chart-maker.ts (logic) + src/app/tools/gantt-chart-maker/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/gantt-chart-maker**
