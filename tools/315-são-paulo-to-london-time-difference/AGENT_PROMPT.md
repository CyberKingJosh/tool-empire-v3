# AGENT PROMPT: Build São Paulo to London Time Difference

You are a tool-building agent. Your job is to build ONE tool: **São Paulo to London Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: São Paulo to London Time Difference
- **Slug**: são-paulo-to-london-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/são-paulo-to-london-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/são-paulo-to-london-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/são-paulo-to-london-time-difference**
