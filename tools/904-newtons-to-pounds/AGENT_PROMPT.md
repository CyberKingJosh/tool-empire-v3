# AGENT PROMPT: Build Newtons to Pounds

You are a tool-building agent. Build ONE tool: **Newtons to Pounds**.
...
## Tool: Newtons to Pounds
- Slug: newtons-to-pounds | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/newtons-to-pounds.ts — pure logic
2. Create src/app/tools/newtons-to-pounds/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/newtons-to-pounds**
