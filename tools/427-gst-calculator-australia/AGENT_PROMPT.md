# AGENT PROMPT: Build GST Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **GST Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gst-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gst-calculator-australia/page.tsx` — full page component
