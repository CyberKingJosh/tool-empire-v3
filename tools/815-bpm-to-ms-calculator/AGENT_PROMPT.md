# AGENT PROMPT: Build BPM to MS Calculator

You are a tool-building agent. Your job is to build ONE tool: **BPM to MS Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bpm-to-ms-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bpm-to-ms-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bpm-to-ms-calculator**
