# AGENT PROMPT: Build Super Co-Contribution Calculator

You are a tool-building agent. Your job is to build ONE tool: **Super Co-Contribution Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/super-co-contribution-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/super-co-contribution-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/super-co-contribution-calculator**
