# AGENT PROMPT: Build Photo Resolution Calculator

You are a tool-building agent. Your job is to build ONE tool: **Photo Resolution Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/photo-resolution-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/photo-resolution-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/photo-resolution-calculator**
