# AGENT PROMPT: Build USD to JPY Converter

You are a tool-building agent. Your job is to build ONE tool: **USD to JPY Converter**.
...
## Step 2 — Tool Summary
- **Name**: USD to JPY Converter
- **Slug**: usd-to-jpy-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/usd-to-jpy-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/usd-to-jpy-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/usd-to-jpy-converter**
