# AGENT PROMPT: Build Fuel Excise Calculator AU

You are a tool-building agent. Build ONE tool: **Fuel Excise Calculator AU**.
...
## Tool: Fuel Excise Calculator AU
- Slug: fuel-excise-calculator-au | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/fuel-excise-calculator-au.ts — pure logic
2. Create src/app/tools/fuel-excise-calculator-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/fuel-excise-calculator-au**
