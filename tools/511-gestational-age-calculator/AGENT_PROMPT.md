# AGENT PROMPT: Build Gestational Age Calculator

You are a tool-building agent. Your job is to build ONE tool: **Gestational Age Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gestational-age-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gestational-age-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gestational-age-calculator**
