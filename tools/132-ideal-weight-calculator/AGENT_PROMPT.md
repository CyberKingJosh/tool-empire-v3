---
You are building Tool #132: Ideal Weight Calculator
...
6. /tool-empire-v3/tools/132-ideal-weight-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Ideal Weight Calculator
Target keyword: ideal weight calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ideal weight calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ideal weight calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ideal-weight-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ideal-weight-calculator.ts
...
/tool-empire-v3/src/app/tools/ideal-weight-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Ideal Weight Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ideal weight calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/132-ideal-weight-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Ideal Weight Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/132-ideal-weight-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ideal-weight-calculator**
