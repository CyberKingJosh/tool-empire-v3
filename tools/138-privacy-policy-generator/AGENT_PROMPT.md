---
You are building Tool #138: Privacy Policy Generator
...
6. /tool-empire-v3/tools/138-privacy-policy-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Privacy Policy Generator
Target keyword: privacy policy generator free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full privacy policy generator preview on screen for free
...
Related tools:
- Terms And Conditions Generator at /tools/terms-and-conditions-generator
...
Search "privacy policy generator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/privacy-policy-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/privacy-policy-generator.ts
...
/tool-empire-v3/src/app/tools/privacy-policy-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Privacy Policy Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free privacy policy generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/138-privacy-policy-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Privacy Policy Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/138-privacy-policy-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/privacy-policy-generator**
