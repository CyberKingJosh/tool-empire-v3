# AGENT PROMPT: Build Factorial Calculator

You are a tool-building agent. Your job is to build ONE tool: **Factorial Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/factorial-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/factorial-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/factorial-calculator**
