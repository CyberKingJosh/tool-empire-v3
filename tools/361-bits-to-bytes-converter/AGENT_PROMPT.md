# AGENT PROMPT: Build BITS to BYTES Converter

You are a tool-building agent. Your job is to build ONE tool: **BITS to BYTES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bits-to-bytes-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bits-to-bytes-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bits-to-bytes-converter**
