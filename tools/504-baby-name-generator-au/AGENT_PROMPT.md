# AGENT PROMPT: Build Baby Name Generator AU

You are a tool-building agent. Your job is to build ONE tool: **Baby Name Generator AU**.
...
## Step 2 — Tool Summary
- **Name**: Baby Name Generator AU
- **Slug**: baby-name-generator-au
- **Category**: health
...
## Step 4 — Build Steps
1. Create `src/lib/tools/baby-name-generator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/baby-name-generator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/baby-name-generator-au**
