# AGENT PROMPT: Build MINUTES to HOURS Converter

You are a tool-building agent. Your job is to build ONE tool: **MINUTES to HOURS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/minutes-to-hours-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/minutes-to-hours-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/minutes-to-hours-converter**
