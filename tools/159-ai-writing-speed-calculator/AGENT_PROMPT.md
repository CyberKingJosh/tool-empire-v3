---
You are building Tool #159: AI Writing Speed Calculator
...
6. /tool-empire-v3/tools/159-ai-writing-speed-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Writing Speed Calculator
Target keyword: ai writing speed calculator words per dollar
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ai writing speed calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai writing speed calculator words per dollar". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-writing-speed-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-writing-speed-calculator.ts
...
/tool-empire-v3/src/app/tools/ai-writing-speed-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Writing Speed Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai writing speed calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/159-ai-writing-speed-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Writing Speed Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/159-ai-writing-speed-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-writing-speed-calculator**
