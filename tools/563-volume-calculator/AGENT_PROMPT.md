# AGENT PROMPT: Build Volume Calculator

You are a tool-building agent. Your job is to build ONE tool: **Volume Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/volume-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/volume-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/volume-calculator**
