# AGENT PROMPT: Build Robots.txt Generator

You are a tool-building agent. Your job is to build ONE tool: **Robots.txt Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/robots.txt-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/robots.txt-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/robots.txt-generator**
