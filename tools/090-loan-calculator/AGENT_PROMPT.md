---
You are building Tool #090: Loan Calculator
...
6. /tool-empire-v3/tools/090-loan-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Loan Calculator
Target keyword: loan calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full loan calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "loan calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/loan-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/loan-calculator.ts
...
/tool-empire-v3/src/app/tools/loan-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Loan Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free loan calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/090-loan-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Loan Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/090-loan-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/loan-calculator**
