# AGENT PROMPT: Build Time in Ho Chi Minh City

You are a tool-building agent. Your job is to build ONE tool: **Time in Ho Chi Minh City**.
...
## Step 3 — Design Brief
- Palette: Dark Clock (#1B2A4A background, #3B82F6 accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-ho-chi-minh-city.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-ho-chi-minh-city/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-ho-chi-minh-city**
