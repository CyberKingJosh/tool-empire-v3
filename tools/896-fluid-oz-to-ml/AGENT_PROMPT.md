# AGENT PROMPT: Build Fluid Oz to ML

You are a tool-building agent. Build ONE tool: **Fluid Oz to ML**.
...
## Tool: Fluid Oz to ML
- Slug: fluid-oz-to-ml | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/fluid-oz-to-ml.ts — pure logic
2. Create src/app/tools/fluid-oz-to-ml/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/fluid-oz-to-ml**
