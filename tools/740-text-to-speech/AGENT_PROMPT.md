# AGENT PROMPT: Build Text to Speech

You are a tool-building agent. Your job is to build ONE tool: **Text to Speech**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/text-to-speech.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/text-to-speech/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/text-to-speech**
