---
You are building Tool #021: Biological Age Calculator
...
6. /tool-empire-v3/tools/021-biological-age-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Biological Age Calculator
Target keyword: biological age calculator free online
...
API Cost: FREE
Beat difficulty: 4
Free tier: Full biological age calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
- BMI Calculator at /tools/bmi-calculator
...
Search "biological age calculator free online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/biological-age-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/biological-age-calculator.ts
...
/tool-empire-v3/src/app/tools/biological-age-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Biological Age Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free biological age calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/021-biological-age-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Biological Age Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/021-biological-age-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/biological-age-calculator**
