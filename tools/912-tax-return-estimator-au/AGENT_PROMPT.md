# AGENT PROMPT: Build Tax Return Estimator AU

You are a tool-building agent. Build ONE tool: **Tax Return Estimator AU**.
...
## Tool: Tax Return Estimator AU
- Slug: tax-return-estimator-au | Category: finance | Type: A | Tier: One | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/tax-return-estimator-au.ts — pure logic
2. Create src/app/tools/tax-return-estimator-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/tax-return-estimator-au**
