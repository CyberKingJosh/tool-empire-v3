# AGENT PROMPT: Build Water Intake Calculator

You are a tool-building agent. Your job is to build ONE tool: **Water Intake Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/water-intake-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/water-intake-calculator/page.tsx` — full page component
