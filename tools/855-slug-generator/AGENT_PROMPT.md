# AGENT PROMPT: Build Slug Generator

You are a tool-building agent. Your job is to build ONE tool: **Slug Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/slug-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/slug-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/slug-generator**
