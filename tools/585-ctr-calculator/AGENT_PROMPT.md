# AGENT PROMPT: Build CTR Calculator

You are a tool-building agent. Your job is to build ONE tool: **CTR Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ctr-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ctr-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ctr-calculator**
