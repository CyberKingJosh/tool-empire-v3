# AGENT PROMPT: Build Time in Helsinki

You are a tool-building agent. Your job is to build ONE tool: **Time in Helsinki**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-helsinki.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-helsinki/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-helsinki**
