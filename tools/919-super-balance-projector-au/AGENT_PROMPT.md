# AGENT PROMPT: Build Super Balance Projector AU

You are a tool-building agent. Build ONE tool: **Super Balance Projector AU**.
...
## Tool: Super Balance Projector AU
- Slug: super-balance-projector-au | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/super-balance-projector-au.ts — pure logic
2. Create src/app/tools/super-balance-projector-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/super-balance-projector-au**
