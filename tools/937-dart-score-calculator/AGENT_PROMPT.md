# AGENT PROMPT: Build Dart Score Calculator

You are a tool-building agent. Build ONE tool: **Dart Score Calculator**.
...
## Tool: Dart Score Calculator
- Slug: dart-score-calculator | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/dart-score-calculator.ts — pure logic
2. Create src/app/tools/dart-score-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/dart-score-calculator**
