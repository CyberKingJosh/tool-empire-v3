# AGENT PROMPT: Build Scientific Calculator

You are a tool-building agent. Your job is to build ONE tool: **Scientific Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/scientific-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/scientific-calculator/page.tsx` — full page component
