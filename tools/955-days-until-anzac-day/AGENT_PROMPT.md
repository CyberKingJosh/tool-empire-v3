# AGENT PROMPT: Build Days Until ANZAC Day

You are a tool-building agent. Build ONE tool: **Days Until ANZAC Day**.
...
## Tool: Days Until ANZAC Day
- Slug: days-until-anzac-day | Category: date | Type: A | Tier: Two | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-anzac-day.ts — pure logic
2. Create src/app/tools/days-until-anzac-day/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-anzac-day**
