# AGENT PROMPT: Build Protein Intake Calculator

You are a tool-building agent. Your job is to build ONE tool: **Protein Intake Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/protein-intake-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/protein-intake-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/protein-intake-calculator**
