# AGENT PROMPT: Build Citation Generator APA

You are a tool-building agent. Your job is to build ONE tool: **Citation Generator APA**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/citation-generator-apa.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/citation-generator-apa/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/citation-generator-apa**
