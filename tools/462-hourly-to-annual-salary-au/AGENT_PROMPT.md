# AGENT PROMPT: Build Hourly to Annual Salary AU

You are a tool-building agent. Your job is to build ONE tool: **Hourly to Annual Salary AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hourly-to-annual-salary-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hourly-to-annual-salary-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hourly-to-annual-salary-au**
