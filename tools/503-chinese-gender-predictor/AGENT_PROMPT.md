# AGENT PROMPT: Build Chinese Gender Predictor

You are a tool-building agent. Your job is to build ONE tool: **Chinese Gender Predictor**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/chinese-gender-predictor.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/chinese-gender-predictor/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/chinese-gender-predictor**
