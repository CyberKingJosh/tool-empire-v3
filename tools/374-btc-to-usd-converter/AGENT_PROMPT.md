# AGENT PROMPT: Build BTC to USD Converter

You are a tool-building agent. Your job is to build ONE tool: **BTC to USD Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/btc-to-usd-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/btc-to-usd-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/btc-to-usd-converter**
