# AGENT PROMPT: Build Font Pairing Tool

You are a tool-building agent. Your job is to build ONE tool: **Font Pairing Tool**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/font-pairing-tool.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/font-pairing-tool/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/font-pairing-tool**
