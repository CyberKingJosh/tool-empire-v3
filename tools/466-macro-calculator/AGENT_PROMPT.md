# AGENT PROMPT: Build Macro Calculator

You are a tool-building agent. Your job is to build ONE tool: **Macro Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/macro-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/macro-calculator/page.tsx` — full page component
