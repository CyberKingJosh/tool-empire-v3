# AGENT PROMPT: Build AI Carbon Footprint Calc

You are a tool-building agent. Your job is to build ONE tool: **AI Carbon Footprint Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-carbon-footprint-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-carbon-footprint-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-carbon-footprint-calc**
