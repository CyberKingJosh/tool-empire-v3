---
You are building Tool #112: GST Calculator Australia
...
6. /tool-empire-v3/tools/112-gst-calculator-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: GST Calculator Australia
Target keyword: gst calculator australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full gst calculator australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "gst calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/gst-calculator-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/gst-calculator-australia.ts
...
/tool-empire-v3/src/app/tools/gst-calculator-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'GST Calculator Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free gst calculator australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/112-gst-calculator-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. GST Calculator Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/112-gst-calculator-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/gst-calculator-australia**
