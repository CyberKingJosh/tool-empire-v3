# AGENT PROMPT: Build Home Loan Comparison AU

You are a tool-building agent. Your job is to build ONE tool: **Home Loan Comparison AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/home-loan-comparison-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/home-loan-comparison-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/home-loan-comparison-au**
