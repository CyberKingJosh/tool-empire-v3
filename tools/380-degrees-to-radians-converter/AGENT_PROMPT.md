# AGENT PROMPT: Build DEGREES to RADIANS Converter

You are a tool-building agent. Your job is to build ONE tool: **DEGREES to RADIANS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/degrees-to-radians-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/degrees-to-radians-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/degrees-to-radians-converter**
