---
You are building Tool #100: Aspect Ratio Calculator
...
6. /tool-empire-v3/tools/100-aspect-ratio-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Aspect Ratio Calculator
Target keyword: aspect ratio calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full aspect ratio calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "aspect ratio calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/aspect-ratio-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/aspect-ratio-calculator.ts
...
/tool-empire-v3/src/app/tools/aspect-ratio-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Aspect Ratio Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free aspect ratio calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/100-aspect-ratio-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Aspect Ratio Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/100-aspect-ratio-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/aspect-ratio-calculator**
