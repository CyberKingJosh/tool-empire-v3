# AGENT PROMPT: Build CSS Minifier

You are a tool-building agent. Your job is to build ONE tool: **CSS Minifier**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/css-minifier.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/css-minifier/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/css-minifier**
