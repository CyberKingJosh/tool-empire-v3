# AGENT PROMPT: Build NAUTICAL-MILES to KM Converter

You are a tool-building agent. Your job is to build ONE tool: **NAUTICAL-MILES to KM Converter**.
...
- **Slug**: nautical-miles-to-km-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/nautical-miles-to-km-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/nautical-miles-to-km-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/nautical-miles-to-km-converter**
