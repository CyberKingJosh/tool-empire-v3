# AGENT PROMPT: Build Time in Las Vegas

You are a tool-building agent. Your job is to build ONE tool: **Time in Las Vegas**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-las-vegas.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-las-vegas/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-las-vegas**
