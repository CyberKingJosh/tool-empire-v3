# AGENT PROMPT: Build RGB to CMYK Converter

You are a tool-building agent. Your job is to build ONE tool: **RGB to CMYK Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/rgb-to-cmyk-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/rgb-to-cmyk-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/rgb-to-cmyk-converter**
