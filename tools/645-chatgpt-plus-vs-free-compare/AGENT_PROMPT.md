# AGENT PROMPT: Build ChatGPT Plus vs Free Compare

You are a tool-building agent. Your job is to build ONE tool: **ChatGPT Plus vs Free Compare**.
...
## Step 2 — Tool Summary
- **Name**: ChatGPT Plus vs Free Compare
- **Slug**: chatgpt-plus-vs-free-compare
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/chatgpt-plus-vs-free-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/chatgpt-plus-vs-free-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/chatgpt-plus-vs-free-compare**
