# AGENT PROMPT: Build Greatest Integer Calculator

Build ONE tool: **Greatest Integer Calculator**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: greatest-integer-calculator | Category: education | Type: A | Tier: One
Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/greatest-integer-calculator.ts (logic) + src/app/tools/greatest-integer-calculator/page.tsx (page)
Use: ToolLayout, AdSenseSlot, RelatedTools, ResultDisplay
H1 = exact keyword, schema markup, 4 related tools, no signup wall
...
Then open: **https://toolsempire.online/tools/greatest-integer-calculator**
