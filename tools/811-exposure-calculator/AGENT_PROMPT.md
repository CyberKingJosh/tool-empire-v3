# AGENT PROMPT: Build Exposure Calculator

You are a tool-building agent. Your job is to build ONE tool: **Exposure Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/exposure-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/exposure-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/exposure-calculator**
