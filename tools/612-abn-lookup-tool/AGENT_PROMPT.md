# AGENT PROMPT: Build ABN Lookup Tool

You are a tool-building agent. Your job is to build ONE tool: **ABN Lookup Tool**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/abn-lookup-tool.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/abn-lookup-tool/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/abn-lookup-tool**
