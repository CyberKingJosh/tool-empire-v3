# AGENT PROMPT: Build Open Graph Preview

You are a tool-building agent. Your job is to build ONE tool: **Open Graph Preview**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/open-graph-preview.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/open-graph-preview/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/open-graph-preview**
