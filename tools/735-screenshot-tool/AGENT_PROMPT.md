# AGENT PROMPT: Build Screenshot Tool

You are a tool-building agent. Your job is to build ONE tool: **Screenshot Tool**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/screenshot-tool.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/screenshot-tool/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/screenshot-tool**
