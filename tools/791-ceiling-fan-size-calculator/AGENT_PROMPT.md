# AGENT PROMPT: Build Ceiling Fan Size Calculator

You are a tool-building agent. Your job is to build ONE tool: **Ceiling Fan Size Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ceiling-fan-size-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ceiling-fan-size-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ceiling-fan-size-calculator**
