# AGENT PROMPT: Build CM to PIXELS Converter

You are a tool-building agent. Your job is to build ONE tool: **CM to PIXELS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cm-to-pixels-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cm-to-pixels-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cm-to-pixels-converter**
