# AGENT PROMPT: Build Churn Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Churn Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/churn-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/churn-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/churn-rate-calculator**
