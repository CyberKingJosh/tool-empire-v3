# AGENT PROMPT: Build Medicare Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Medicare Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/medicare-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/medicare-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/medicare-calculator-au**
