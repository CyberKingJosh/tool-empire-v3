---
You are building Tool #081: Hex To RGB
...
6. /tool-empire-v3/tools/081-hex-to-rgb/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Hex To RGB
Target keyword: hex to rgb converter
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full hex to rgb with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "hex to rgb converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/hex-to-rgb/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/hex-to-rgb.ts
...
/tool-empire-v3/src/app/tools/hex-to-rgb/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Hex To RGB Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free hex to rgb. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/081-hex-to-rgb/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Hex To RGB is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/081-hex-to-rgb/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/hex-to-rgb**
