# AGENT PROMPT: Build Soil Calculator

You are a tool-building agent. Your job is to build ONE tool: **Soil Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/soil-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/soil-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/soil-calculator**
