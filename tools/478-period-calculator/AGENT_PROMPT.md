# AGENT PROMPT: Build Period Calculator

You are a tool-building agent. Your job is to build ONE tool: **Period Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/period-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/period-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/period-calculator**
