---
You are building Tool #094: JSON Formatter
...
6. /tool-empire-v3/tools/094-json-formatter/SPEC.md — your specific tool data
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full json formatter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "json formatter online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/json-formatter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/json-formatter.ts
...
/tool-empire-v3/src/app/tools/json-formatter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'JSON Formatter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free json formatter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/094-json-formatter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. JSON Formatter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/094-json-formatter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/json-formatter**
