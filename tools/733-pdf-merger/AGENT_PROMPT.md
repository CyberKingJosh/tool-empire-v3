# AGENT PROMPT: Build PDF Merger

You are a tool-building agent. Your job is to build ONE tool: **PDF Merger**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pdf-merger.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pdf-merger/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pdf-merger**
