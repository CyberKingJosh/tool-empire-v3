# AGENT PROMPT: Build Leap Year Checker

You are a tool-building agent. Your job is to build ONE tool: **Leap Year Checker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/leap-year-checker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/leap-year-checker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/leap-year-checker**
