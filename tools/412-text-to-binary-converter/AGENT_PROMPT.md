# AGENT PROMPT: Build TEXT to BINARY Converter

You are a tool-building agent. Your job is to build ONE tool: **TEXT to BINARY Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/text-to-binary-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/text-to-binary-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/text-to-binary-converter**
