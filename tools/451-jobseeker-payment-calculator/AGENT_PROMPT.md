# AGENT PROMPT: Build JobSeeker Payment Calculator

You are a tool-building agent. Your job is to build ONE tool: **JobSeeker Payment Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/jobseeker-payment-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/jobseeker-payment-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/jobseeker-payment-calculator**
