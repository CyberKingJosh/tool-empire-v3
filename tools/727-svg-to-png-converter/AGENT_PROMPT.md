# AGENT PROMPT: Build SVG to PNG Converter

You are a tool-building agent. Your job is to build ONE tool: **SVG to PNG Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/svg-to-png-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/svg-to-png-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/svg-to-png-converter**
