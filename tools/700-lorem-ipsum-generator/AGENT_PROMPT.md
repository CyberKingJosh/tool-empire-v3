# AGENT PROMPT: Build Lorem Ipsum Generator

You are a tool-building agent. Your job is to build ONE tool: **Lorem Ipsum Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/lorem-ipsum-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/lorem-ipsum-generator/page.tsx` — full page component
