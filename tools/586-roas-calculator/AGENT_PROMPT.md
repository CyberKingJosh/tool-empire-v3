# AGENT PROMPT: Build ROAS Calculator

You are a tool-building agent. Your job is to build ONE tool: **ROAS Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/roas-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/roas-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/roas-calculator**
