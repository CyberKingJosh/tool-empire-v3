---
You are building Tool #074: Fahrenheit To Celsius
...
6. /tool-empire-v3/tools/074-fahrenheit-to-celsius/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Fahrenheit To Celsius
Target keyword: fahrenheit to celsius
Monthly volume: 12,000,000
Difficulty: Easy
RPM: $4 AUD
Monetisation: Type A
Tier: 0
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full fahrenheit to celsius with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- unitconverters.net: Ad-heavy, cluttered layout
- convertworld.com: Outdated 2010s design
- google.com: Inline result, no explanation or sharing

Australian data needed: No
Related tools:
- Unit Converter at /tools/unit-converter
- Celsius To Fahrenheit at /tools/celsius-to-fahrenheit
- Cm To Inches at /tools/cm-to-inches
- Kg To Pounds at /tools/kg-to-pounds

Affiliate: XE Currency App — Real-time currency rates on mobile — xe.com/apps/

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: clean clinical
2. Differentiation: Bidirectional conversion — change either field and the other updates instantly
3. Unforgettable detail: The conversion result slides in from the right like a physical calculator tape printing
...
Search "fahrenheit to celsius". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/fahrenheit-to-celsius/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/fahrenheit-to-celsius.ts
...
/tool-empire-v3/src/app/tools/fahrenheit-to-celsius/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Fahrenheit To Celsius Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free fahrenheit to celsius. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/074-fahrenheit-to-celsius/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Fahrenheit To Celsius is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/074-fahrenheit-to-celsius/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/fahrenheit-to-celsius**
