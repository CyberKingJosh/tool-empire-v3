# AGENT PROMPT: Build TAFE Fee Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **TAFE Fee Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tafe-fee-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tafe-fee-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tafe-fee-calculator-au**
