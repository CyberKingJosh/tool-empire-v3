# AGENT PROMPT: Build HSL to HEX Converter

You are a tool-building agent. Your job is to build ONE tool: **HSL to HEX Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hsl-to-hex-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hsl-to-hex-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hsl-to-hex-converter**
