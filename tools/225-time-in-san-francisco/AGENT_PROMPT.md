# AGENT PROMPT: Build Time in San Francisco

You are a tool-building agent. Your job is to build ONE tool: **Time in San Francisco**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-san-francisco.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-san-francisco/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-san-francisco**
