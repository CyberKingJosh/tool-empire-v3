# AGENT PROMPT: Build Contraction Timer

You are a tool-building agent. Your job is to build ONE tool: **Contraction Timer**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/contraction-timer.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/contraction-timer/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/contraction-timer**
