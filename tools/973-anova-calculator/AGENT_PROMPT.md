# AGENT PROMPT: Build ANOVA Calculator

You are a tool-building agent. Build ONE tool: **ANOVA Calculator**.
...
## Tool: ANOVA Calculator
- Slug: anova-calculator | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/anova-calculator.ts — pure logic
2. Create src/app/tools/anova-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/anova-calculator**
