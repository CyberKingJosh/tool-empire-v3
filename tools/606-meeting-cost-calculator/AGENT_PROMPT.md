# AGENT PROMPT: Build Meeting Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Meeting Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/meeting-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/meeting-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/meeting-cost-calculator**
