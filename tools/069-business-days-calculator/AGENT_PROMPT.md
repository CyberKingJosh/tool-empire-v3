---
You are building Tool #069: Business Days Calculator
...
6. /tool-empire-v3/tools/069-business-days-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Business Days Calculator
Target keyword: business days calculator australia
Monthly volume: 4,000,000
Difficulty: Easy
RPM: $5 AUD
Monetisation: Type A
Tier: 0
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full business days calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- timeanddate.com/date: Cluttered, ads everywhere
- calculator.net/date-calculator: Old design, not mobile optimised
- daycount.cc: Basic, no sharing features

Australian data needed: Yes — Australian public holidays by state
Related tools:
- Public Holiday Clash Checker at /tools/public-holiday-clash-checker
- Age Calculator at /tools/age-calculator
- How Many Days Until at /tools/how-many-days-until
- Days Until Christmas at /tools/days-until-christmas

Affiliate: Google Calendar — Sync dates and reminders automatically — calendar.google.com

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: clean clinical
2. Differentiation: Instant result with shareable countdown link — pre-filled URL you can send to anyone
3. Unforgettable detail: The countdown number casts a subtle shadow that grows as the date approaches, creating urgency
...
Search "business days calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/business-days-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/business-days-calculator.ts
...
/tool-empire-v3/src/app/tools/business-days-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Business Days Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free business days calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/069-business-days-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Business Days Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/069-business-days-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/business-days-calculator**
