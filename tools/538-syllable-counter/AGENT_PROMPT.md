# AGENT PROMPT: Build Syllable Counter

You are a tool-building agent. Your job is to build ONE tool: **Syllable Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/syllable-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/syllable-counter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/syllable-counter**
