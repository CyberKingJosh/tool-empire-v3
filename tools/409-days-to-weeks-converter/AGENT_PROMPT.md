# AGENT PROMPT: Build DAYS to WEEKS Converter

You are a tool-building agent. Your job is to build ONE tool: **DAYS to WEEKS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/days-to-weeks-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/days-to-weeks-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/days-to-weeks-converter**
