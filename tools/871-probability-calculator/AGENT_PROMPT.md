# AGENT PROMPT: Build Probability Calculator

You are a tool-building agent. Your job is to build ONE tool: **Probability Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/probability-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/probability-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/probability-calculator**
