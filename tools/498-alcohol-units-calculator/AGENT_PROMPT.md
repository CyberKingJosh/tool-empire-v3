# AGENT PROMPT: Build Alcohol Units Calculator

You are a tool-building agent. Your job is to build ONE tool: **Alcohol Units Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/alcohol-units-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/alcohol-units-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/alcohol-units-calculator**
