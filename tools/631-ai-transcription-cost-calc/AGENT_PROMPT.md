# AGENT PROMPT: Build AI Transcription Cost Calc

You are a tool-building agent. Your job is to build ONE tool: **AI Transcription Cost Calc**.
...
## Step 2 — Tool Summary
- **Name**: AI Transcription Cost Calc
- **Slug**: ai-transcription-cost-calc
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-transcription-cost-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-transcription-cost-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-transcription-cost-calc**
