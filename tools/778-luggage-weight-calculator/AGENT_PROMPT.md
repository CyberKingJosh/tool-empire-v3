# AGENT PROMPT: Build Luggage Weight Calculator

You are a tool-building agent. Your job is to build ONE tool: **Luggage Weight Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/luggage-weight-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/luggage-weight-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/luggage-weight-calculator**
