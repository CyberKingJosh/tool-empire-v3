---
You are building Tool #119: Negative Gearing Calculator
...
6. /tool-empire-v3/tools/119-negative-gearing-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Negative Gearing Calculator
Target keyword: negative gearing calculator australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full negative gearing calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "negative gearing calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/negative-gearing-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/negative-gearing-calculator.ts
...
/tool-empire-v3/src/app/tools/negative-gearing-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Negative Gearing Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free negative gearing calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/119-negative-gearing-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Negative Gearing Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/119-negative-gearing-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/negative-gearing-calculator**
