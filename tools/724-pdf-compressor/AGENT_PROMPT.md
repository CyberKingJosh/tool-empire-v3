# AGENT PROMPT: Build PDF Compressor

You are a tool-building agent. Your job is to build ONE tool: **PDF Compressor**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pdf-compressor.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pdf-compressor/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pdf-compressor**
