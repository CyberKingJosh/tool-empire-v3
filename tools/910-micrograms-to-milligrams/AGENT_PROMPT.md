# AGENT PROMPT: Build Micrograms to Milligrams

You are a tool-building agent. Build ONE tool: **Micrograms to Milligrams**.
...
## Tool: Micrograms to Milligrams
- Slug: micrograms-to-milligrams | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/micrograms-to-milligrams.ts — pure logic
2. Create src/app/tools/micrograms-to-milligrams/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/micrograms-to-milligrams**
