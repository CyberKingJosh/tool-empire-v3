# AGENT PROMPT: Build Time in Tel Aviv

You are a tool-building agent. Your job is to build ONE tool: **Time in Tel Aviv**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-tel-aviv.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-tel-aviv/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-tel-aviv**
