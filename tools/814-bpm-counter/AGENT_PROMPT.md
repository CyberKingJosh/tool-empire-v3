# AGENT PROMPT: Build BPM Counter

You are a tool-building agent. Your job is to build ONE tool: **BPM Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bpm-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bpm-counter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bpm-counter**
