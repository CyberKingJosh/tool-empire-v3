# AGENT PROMPT: Build Regex Tester

You are a tool-building agent. Your job is to build ONE tool: **Regex Tester**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/regex-tester.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/regex-tester/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/regex-tester**
