---
You are building Tool #161: RAG Cost Calculator
...
6. /tool-empire-v3/tools/161-rag-cost-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: RAG Cost Calculator
Target keyword: rag pipeline cost calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full rag cost calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "rag pipeline cost calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/rag-cost-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/rag-cost-calculator.ts
...
/tool-empire-v3/src/app/tools/rag-cost-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'RAG Cost Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free rag cost calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/161-rag-cost-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. RAG Cost Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/161-rag-cost-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/rag-cost-calculator**
