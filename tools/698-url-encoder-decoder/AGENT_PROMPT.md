# AGENT PROMPT: Build URL Encoder Decoder

You are a tool-building agent. Your job is to build ONE tool: **URL Encoder Decoder**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/url-encoder-decoder.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/url-encoder-decoder/page.tsx` — full page component
