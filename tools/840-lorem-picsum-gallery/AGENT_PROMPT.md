# AGENT PROMPT: Build Lorem Picsum Gallery

You are a tool-building agent. Your job is to build ONE tool: **Lorem Picsum Gallery**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/lorem-picsum-gallery.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/lorem-picsum-gallery/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/lorem-picsum-gallery**
