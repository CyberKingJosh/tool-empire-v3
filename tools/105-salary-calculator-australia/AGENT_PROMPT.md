---
You are building Tool #105: Salary Calculator Australia
...
6. /tool-empire-v3/tools/105-salary-calculator-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Salary Calculator Australia
Target keyword: salary calculator australia 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full salary calculator australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "salary calculator australia 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/salary-calculator-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/salary-calculator-australia.ts
...
/tool-empire-v3/src/app/tools/salary-calculator-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Salary Calculator Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free salary calculator australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/105-salary-calculator-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Salary Calculator Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/105-salary-calculator-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/salary-calculator-australia**
