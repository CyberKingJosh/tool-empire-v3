# AGENT PROMPT: Build Podcast Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Podcast Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/podcast-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/podcast-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/podcast-cost-calculator**
