# AGENT PROMPT: Build ACN Lookup Tool

You are a tool-building agent. Your job is to build ONE tool: **ACN Lookup Tool**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/acn-lookup-tool.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/acn-lookup-tool/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/acn-lookup-tool**
