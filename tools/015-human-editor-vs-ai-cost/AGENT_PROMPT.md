---
You are building Tool #015: Human Editor vs AI Cost
...
6. /tool-empire-v3/tools/015-human-editor-vs-ai-cost/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Human Editor vs AI Cost
Target keyword: human editor vs ai proofreader cost roi
...
API Cost: FREE
Beat difficulty: 1
Free tier: Full human editor vs ai cost with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "human editor vs ai proofreader cost roi". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/human-editor-vs-ai-cost/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/human-editor-vs-ai-cost.ts
...
/tool-empire-v3/src/app/tools/human-editor-vs-ai-cost/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Human Editor vs AI Cost Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free human editor vs ai cost. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/015-human-editor-vs-ai-cost/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Human Editor vs AI Cost is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/015-human-editor-vs-ai-cost/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/human-editor-vs-ai-cost**
