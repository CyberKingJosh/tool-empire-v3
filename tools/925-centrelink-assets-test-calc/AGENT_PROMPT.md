# AGENT PROMPT: Build Centrelink Assets Test Calc

You are a tool-building agent. Build ONE tool: **Centrelink Assets Test Calc**.
...
## Tool: Centrelink Assets Test Calc
- Slug: centrelink-assets-test-calc | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/centrelink-assets-test-calc.ts — pure logic
2. Create src/app/tools/centrelink-assets-test-calc/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/centrelink-assets-test-calc**
