# AGENT PROMPT: Build Breastfeeding Calculator

You are a tool-building agent. Your job is to build ONE tool: **Breastfeeding Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/breastfeeding-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/breastfeeding-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/breastfeeding-calculator**
