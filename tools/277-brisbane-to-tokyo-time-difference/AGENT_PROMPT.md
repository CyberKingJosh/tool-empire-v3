# AGENT PROMPT: Build Brisbane to Tokyo Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Brisbane to Tokyo Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Brisbane to Tokyo Time Difference
- **Slug**: brisbane-to-tokyo-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/brisbane-to-tokyo-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/brisbane-to-tokyo-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/brisbane-to-tokyo-time-difference**
