# AGENT PROMPT: Build AI Token Usage Tracker

You are a tool-building agent. Your job is to build ONE tool: **AI Token Usage Tracker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-token-usage-tracker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-token-usage-tracker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-token-usage-tracker**
