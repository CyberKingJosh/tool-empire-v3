# AGENT PROMPT: Build Compost Calculator

You are a tool-building agent. Build ONE tool: **Compost Calculator**.
...
## Tool: Compost Calculator
- Slug: compost-calculator | Category: general | Type: A | Tier: Two | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/compost-calculator.ts — pure logic
2. Create src/app/tools/compost-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/compost-calculator**
