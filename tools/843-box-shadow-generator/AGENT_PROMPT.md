# AGENT PROMPT: Build Box Shadow Generator

You are a tool-building agent. Your job is to build ONE tool: **Box Shadow Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/box-shadow-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/box-shadow-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/box-shadow-generator**
