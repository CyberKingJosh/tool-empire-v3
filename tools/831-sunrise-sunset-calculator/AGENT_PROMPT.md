# AGENT PROMPT: Build Sunrise Sunset Calculator

You are a tool-building agent. Your job is to build ONE tool: **Sunrise Sunset Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sunrise-sunset-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sunrise-sunset-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sunrise-sunset-calculator**
