# AGENT PROMPT: Build Quarts to Liters

You are a tool-building agent. Build ONE tool: **Quarts to Liters**.
...
## Tool: Quarts to Liters
- Slug: quarts-to-liters | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/quarts-to-liters.ts — pure logic
2. Create src/app/tools/quarts-to-liters/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/quarts-to-liters**
