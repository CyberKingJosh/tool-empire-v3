---
You are building Tool #057: Countdown Timer
...
6. /tool-empire-v3/tools/057-countdown-timer/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Countdown Timer
Target keyword: countdown timer free online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full countdown timer with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "countdown timer free online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/countdown-timer/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/countdown-timer.ts
...
/tool-empire-v3/src/app/tools/countdown-timer/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Countdown Timer Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free countdown timer. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/057-countdown-timer/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Countdown Timer is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/057-countdown-timer/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/countdown-timer**
