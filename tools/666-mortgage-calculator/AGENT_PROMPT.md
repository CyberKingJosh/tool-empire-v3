# AGENT PROMPT: Build Mortgage Calculator

You are a tool-building agent. Your job is to build ONE tool: **Mortgage Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mortgage-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mortgage-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mortgage-calculator**
