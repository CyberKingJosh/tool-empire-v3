# AGENT PROMPT: Build Proportion Calculator

Build ONE tool: **Proportion Calculator**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: proportion-calculator | Category: education | Type: A | Tier: One
Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/proportion-calculator.ts (logic) + src/app/tools/proportion-calculator/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/proportion-calculator**
