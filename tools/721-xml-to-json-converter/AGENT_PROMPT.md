# AGENT PROMPT: Build XML to JSON Converter

You are a tool-building agent. Your job is to build ONE tool: **XML to JSON Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/xml-to-json-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/xml-to-json-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/xml-to-json-converter**
