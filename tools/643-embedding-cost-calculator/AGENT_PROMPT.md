# AGENT PROMPT: Build Embedding Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Embedding Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/embedding-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/embedding-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/embedding-cost-calculator**
