---
You are building Tool #165: Inflation Savings Australia
...
6. /tool-empire-v3/tools/165-inflation-savings-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Inflation Savings Australia
Target keyword: how much has inflation eaten my savings australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full inflation savings australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- globalrichlist.com: Outdated data, old design
- numbeo.com: Overwhelming data, not focused
- expatistan.com: Complex, not calculator-focused

Australian data needed: Yes — Australian dollar values, Australian cost data
Related tools:
- How Rich Am I Calculator at /tools/how-rich-am-i-calculator
- What Country Can I Afford at /tools/what-country-can-i-afford
- Salary In 1950 Calculator at /tools/salary-in-1950-calculator
- Carbon Footprint Commute AU at /tools/carbon-footprint-commute-au

Affiliate: Wise — Send money internationally with real exchange rates — wise.com

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: bold maximalist
2. Differentiation: Designed to generate a shareable image card that looks good on Twitter/LinkedIn
3. Unforgettable detail: The share button generates a beautiful image card (not just a URL) ready for social media
4. Font pairing: Bold Magazine (Bebas Neue + Nunito)
5. Colour palette: Unique per tool — choose something bold and unexpected

COMPETITOR RESEARCH — Do this before any code:
Search "how much has inflation eaten my savings australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/inflation-savings-australia/page.tsx
Import ToolLayout from shared. Set all props correctly.
Tier: 3 — 2 AdSense slots.
Tool interaction must be above fold on 375px mobile. Non-negotiable.

Step 2: Create /tool-empire-v3/src/lib/tools/inflation-savings-australia.ts
...
/tool-empire-v3/src/app/tools/inflation-savings-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Inflation Savings Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free inflation savings australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/165-inflation-savings-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Inflation Savings Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/165-inflation-savings-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/inflation-savings-australia**
