# AGENT PROMPT: Build GPT-4 vs Claude Comparison

You are a tool-building agent. Your job is to build ONE tool: **GPT-4 vs Claude Comparison**.
...
- **Slug**: gpt-4-vs-claude-comparison
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gpt-4-vs-claude-comparison.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gpt-4-vs-claude-comparison/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gpt-4-vs-claude-comparison**
