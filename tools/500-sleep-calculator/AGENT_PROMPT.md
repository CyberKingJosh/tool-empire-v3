# AGENT PROMPT: Build Sleep Calculator

You are a tool-building agent. Your job is to build ONE tool: **Sleep Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sleep-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sleep-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sleep-calculator**
