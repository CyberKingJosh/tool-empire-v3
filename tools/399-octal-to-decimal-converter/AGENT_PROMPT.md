# AGENT PROMPT: Build OCTAL to DECIMAL Converter

You are a tool-building agent. Your job is to build ONE tool: **OCTAL to DECIMAL Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/octal-to-decimal-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/octal-to-decimal-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/octal-to-decimal-converter**
