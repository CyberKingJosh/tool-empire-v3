# AGENT PROMPT: Build Centrelink Payment Calculator

You are a tool-building agent. Your job is to build ONE tool: **Centrelink Payment Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/centrelink-payment-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/centrelink-payment-calculator/page.tsx` — full page component
