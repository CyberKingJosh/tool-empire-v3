# AGENT PROMPT: Build Drink Calculator Party

You are a tool-building agent. Your job is to build ONE tool: **Drink Calculator Party**.
...
## Step 2 — Tool Summary
- **Name**: Drink Calculator Party
- **Slug**: drink-calculator-party
- **Category**: general
...
## Step 4 — Build Steps
1. Create `src/lib/tools/drink-calculator-party.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/drink-calculator-party/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/drink-calculator-party**
