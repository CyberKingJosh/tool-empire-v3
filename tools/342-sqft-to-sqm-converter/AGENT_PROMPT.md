# AGENT PROMPT: Build SQFT to SQM Converter

You are a tool-building agent. Your job is to build ONE tool: **SQFT to SQM Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sqft-to-sqm-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sqft-to-sqm-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sqft-to-sqm-converter**
