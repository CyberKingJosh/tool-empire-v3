# AGENT PROMPT: Build Screen Recorder Online

You are a tool-building agent. Your job is to build ONE tool: **Screen Recorder Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/screen-recorder-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/screen-recorder-online/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/screen-recorder-online**
