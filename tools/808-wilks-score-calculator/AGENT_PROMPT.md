# AGENT PROMPT: Build Wilks Score Calculator

You are a tool-building agent. Your job is to build ONE tool: **Wilks Score Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/wilks-score-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/wilks-score-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/wilks-score-calculator**
