---
You are building Tool #095: Color Picker
...
6. /tool-empire-v3/tools/095-color-picker/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Color Picker
Target keyword: color picker online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full color picker with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "color picker online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/color-picker/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/color-picker.ts
...
/tool-empire-v3/src/app/tools/color-picker/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Color Picker Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free color picker. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/095-color-picker/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Color Picker is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/095-color-picker/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/color-picker**
