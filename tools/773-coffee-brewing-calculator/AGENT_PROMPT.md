# AGENT PROMPT: Build Coffee Brewing Calculator

You are a tool-building agent. Your job is to build ONE tool: **Coffee Brewing Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/coffee-brewing-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/coffee-brewing-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/coffee-brewing-calculator**
