---
You are building Tool #158: AI Model Context Window Compare
...
6. /tool-empire-v3/tools/158-ai-model-context-window-compare/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Model Context Window Compare
Target keyword: ai model context window comparison 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ai model context window compare with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai model context window comparison 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-model-context-window-compare/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-model-context-window-compare.ts
...
/tool-empire-v3/src/app/tools/ai-model-context-window-compare/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Model Context Window Compare Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai model context window compare. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/158-ai-model-context-window-compare/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Model Context Window Compare is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/158-ai-model-context-window-compare/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-model-context-window-compare**
