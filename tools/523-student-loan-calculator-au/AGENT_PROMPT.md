# AGENT PROMPT: Build Student Loan Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Student Loan Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/student-loan-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/student-loan-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/student-loan-calculator-au**
