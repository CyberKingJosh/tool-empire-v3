# AGENT PROMPT: Build HECS HELP Repayment Calculator

You are a tool-building agent. Your job is to build ONE tool: **HECS HELP Repayment Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hecs-help-repayment-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hecs-help-repayment-calculator/page.tsx` — full page component
