# AGENT PROMPT: Build TSP to ML Converter

You are a tool-building agent. Your job is to build ONE tool: **TSP to ML Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tsp-to-ml-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tsp-to-ml-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tsp-to-ml-converter**
