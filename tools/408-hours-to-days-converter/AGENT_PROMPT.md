# AGENT PROMPT: Build HOURS to DAYS Converter

You are a tool-building agent. Your job is to build ONE tool: **HOURS to DAYS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hours-to-days-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hours-to-days-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hours-to-days-converter**
