# AGENT PROMPT: Build ML to CUPS Converter

You are a tool-building agent. Your job is to build ONE tool: **ML to CUPS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ml-to-cups-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ml-to-cups-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ml-to-cups-converter**
