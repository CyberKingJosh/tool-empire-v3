# AGENT PROMPT: Build LIGHT-YEARS to KM Converter

You are a tool-building agent. Your job is to build ONE tool: **LIGHT-YEARS to KM Converter**.
...
## Step 2 — Tool Summary
- **Name**: LIGHT-YEARS to KM Converter
- **Slug**: light-years-to-km-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/light-years-to-km-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/light-years-to-km-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/light-years-to-km-converter**
