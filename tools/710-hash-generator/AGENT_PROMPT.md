# AGENT PROMPT: Build Hash Generator

You are a tool-building agent. Your job is to build ONE tool: **Hash Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hash-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hash-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hash-generator**
