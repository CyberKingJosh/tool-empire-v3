# AGENT PROMPT: Build Time in Colombo

You are a tool-building agent. Your job is to build ONE tool: **Time in Colombo**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-colombo.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-colombo/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-colombo**
