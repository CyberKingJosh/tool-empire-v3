# AGENT PROMPT: Build Split Time Calculator

You are a tool-building agent. Build ONE tool: **Split Time Calculator**.
...
## Tool: Split Time Calculator
- Slug: split-time-calculator | Category: health | Type: A | Tier: One | API: FREE
- Palette: Green Health (#1A5C45 bg, #00E676 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/split-time-calculator.ts — pure logic
2. Create src/app/tools/split-time-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/split-time-calculator**
