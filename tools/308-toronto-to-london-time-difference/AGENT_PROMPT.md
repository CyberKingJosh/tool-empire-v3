# AGENT PROMPT: Build Toronto to London Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Toronto to London Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/toronto-to-london-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/toronto-to-london-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/toronto-to-london-time-difference**
