# AGENT PROMPT: Build IP Address Lookup

You are a tool-building agent. Your job is to build ONE tool: **IP Address Lookup**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ip-address-lookup.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ip-address-lookup/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ip-address-lookup**
