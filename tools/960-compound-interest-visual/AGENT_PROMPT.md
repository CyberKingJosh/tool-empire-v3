# AGENT PROMPT: Build Compound Interest Visual

You are a tool-building agent. Build ONE tool: **Compound Interest Visual**.
...
## Tool: Compound Interest Visual
- Slug: compound-interest-visual | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/compound-interest-visual.ts — pure logic
2. Create src/app/tools/compound-interest-visual/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/compound-interest-visual**
