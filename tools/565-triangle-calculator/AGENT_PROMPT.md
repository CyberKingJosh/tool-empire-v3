# AGENT PROMPT: Build Triangle Calculator

You are a tool-building agent. Your job is to build ONE tool: **Triangle Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/triangle-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/triangle-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/triangle-calculator**
