# AGENT PROMPT: Build MB to GB Converter

You are a tool-building agent. Your job is to build ONE tool: **MB to GB Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mb-to-gb-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mb-to-gb-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mb-to-gb-converter**
