# AGENT PROMPT: Build Days Until Valentines

You are a tool-building agent. Build ONE tool: **Days Until Valentines**.
...
## Tool: Days Until Valentines
- Slug: days-until-valentines | Category: date | Type: A | Tier: One | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-valentines.ts — pure logic
2. Create src/app/tools/days-until-valentines/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-valentines**
