# AGENT PROMPT: Build New York to Los Angeles Time Difference

You are a tool-building agent. Your job is to build ONE tool: **New York to Los Angeles Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/new-york-to-los-angeles-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/new-york-to-los-angeles-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/new-york-to-los-angeles-time-difference**
