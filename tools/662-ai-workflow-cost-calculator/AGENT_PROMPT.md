# AGENT PROMPT: Build AI Workflow Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Workflow Cost Calculator**.
...
## Step 2 — Tool Summary
- **Name**: AI Workflow Cost Calculator
- **Slug**: ai-workflow-cost-calculator
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-workflow-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-workflow-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-workflow-cost-calculator**
