---
You are building Tool #086: Password Generator
...
6. /tool-empire-v3/tools/086-password-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Password Generator
Target keyword: password generator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full password generator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "password generator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/password-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/password-generator.ts
...
/tool-empire-v3/src/app/tools/password-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Password Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free password generator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/086-password-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Password Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/086-password-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/password-generator**
