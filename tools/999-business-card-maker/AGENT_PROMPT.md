# AGENT PROMPT: Build Business Card Maker

Build ONE tool: **Business Card Maker**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: business-card-maker | Category: general | Type: A | Tier: One
Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/business-card-maker.ts (logic) + src/app/tools/business-card-maker/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/business-card-maker**
