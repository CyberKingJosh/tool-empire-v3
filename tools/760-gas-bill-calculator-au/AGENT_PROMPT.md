# AGENT PROMPT: Build Gas Bill Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Gas Bill Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gas-bill-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gas-bill-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gas-bill-calculator-au**
