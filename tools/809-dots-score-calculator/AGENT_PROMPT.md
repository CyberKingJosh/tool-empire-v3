# AGENT PROMPT: Build DOTS Score Calculator

You are a tool-building agent. Your job is to build ONE tool: **DOTS Score Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dots-score-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dots-score-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dots-score-calculator**
