# AGENT PROMPT: Build Squat Calculator

You are a tool-building agent. Your job is to build ONE tool: **Squat Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/squat-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/squat-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/squat-calculator**
