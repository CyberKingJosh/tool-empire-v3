# AGENT PROMPT: Build SMSF Pension Calculator

You are a tool-building agent. Your job is to build ONE tool: **SMSF Pension Calculator**.
...
## Step 2 — Tool Summary
- **Name**: SMSF Pension Calculator
- **Slug**: smsf-pension-calculator
- **Category**: finance
...
## Step 4 — Build Steps
1. Create `src/lib/tools/smsf-pension-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/smsf-pension-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/smsf-pension-calculator**
