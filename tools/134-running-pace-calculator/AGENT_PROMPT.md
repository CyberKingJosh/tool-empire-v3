---
You are building Tool #134: Running Pace Calculator
...
6. /tool-empire-v3/tools/134-running-pace-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Running Pace Calculator
Target keyword: running pace calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full running pace calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "running pace calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/running-pace-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/running-pace-calculator.ts
...
/tool-empire-v3/src/app/tools/running-pace-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Running Pace Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free running pace calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/134-running-pace-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Running Pace Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/134-running-pace-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/running-pace-calculator**
