# AGENT PROMPT: Build UTC to AEST Converter

You are a tool-building agent. Your job is to build ONE tool: **UTC to AEST Converter**.
...
## Step 2 — Tool Summary
- **Name**: UTC to AEST Converter
- **Slug**: utc-to-aest-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/utc-to-aest-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/utc-to-aest-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/utc-to-aest-converter**
