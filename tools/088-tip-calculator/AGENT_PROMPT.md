---
You are building Tool #088: Tip Calculator
...
6. /tool-empire-v3/tools/088-tip-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Tip Calculator
Target keyword: tip calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full tip calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "tip calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/tip-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/tip-calculator.ts
...
/tool-empire-v3/src/app/tools/tip-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Tip Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free tip calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/088-tip-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Tip Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/088-tip-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/tip-calculator**
