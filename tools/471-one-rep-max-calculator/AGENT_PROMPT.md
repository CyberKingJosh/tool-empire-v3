# AGENT PROMPT: Build One Rep Max Calculator

You are a tool-building agent. Your job is to build ONE tool: **One Rep Max Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/one-rep-max-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/one-rep-max-calculator/page.tsx` — full page component
