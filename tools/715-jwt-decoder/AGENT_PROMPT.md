# AGENT PROMPT: Build JWT Decoder

You are a tool-building agent. Your job is to build ONE tool: **JWT Decoder**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/jwt-decoder.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/jwt-decoder/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/jwt-decoder**
