# AGENT PROMPT: Build ML to OZ Converter

You are a tool-building agent. Your job is to build ONE tool: **ML to OZ Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ml-to-oz-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ml-to-oz-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ml-to-oz-converter**
