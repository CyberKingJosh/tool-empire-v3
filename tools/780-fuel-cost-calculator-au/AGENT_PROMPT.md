# AGENT PROMPT: Build Fuel Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Fuel Cost Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fuel-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fuel-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fuel-cost-calculator-au**
