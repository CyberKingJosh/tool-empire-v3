# AGENT PROMPT: Build Break Even Property Calculator

You are a tool-building agent. Your job is to build ONE tool: **Break Even Property Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/break-even-property-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/break-even-property-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/break-even-property-calculator**
