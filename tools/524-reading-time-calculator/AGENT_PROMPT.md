# AGENT PROMPT: Build Reading Time Calculator

You are a tool-building agent. Your job is to build ONE tool: **Reading Time Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/reading-time-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/reading-time-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/reading-time-calculator**
