# AGENT PROMPT: Build Pay Rise Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Pay Rise Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pay-rise-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pay-rise-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pay-rise-calculator-au**
