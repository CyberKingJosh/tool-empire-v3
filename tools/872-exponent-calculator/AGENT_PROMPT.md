# AGENT PROMPT: Build Exponent Calculator

You are a tool-building agent. Your job is to build ONE tool: **Exponent Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/exponent-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/exponent-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/exponent-calculator**
