# AGENT PROMPT: Build Words Per Page Calculator

You are a tool-building agent. Your job is to build ONE tool: **Words Per Page Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/words-per-page-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/words-per-page-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/words-per-page-calculator**
