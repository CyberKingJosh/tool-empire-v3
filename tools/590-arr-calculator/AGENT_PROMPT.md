# AGENT PROMPT: Build ARR Calculator

You are a tool-building agent. Your job is to build ONE tool: **ARR Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/arr-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/arr-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/arr-calculator**
