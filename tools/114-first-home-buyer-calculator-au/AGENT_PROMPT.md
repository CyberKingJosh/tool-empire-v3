---
You are building Tool #114: First Home Buyer Calculator AU
...
6. /tool-empire-v3/tools/114-first-home-buyer-calculator-au/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: First Home Buyer Calculator AU
Target keyword: first home buyer calculator australia 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full first home buyer calculator au with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "first home buyer calculator australia 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/first-home-buyer-calculator-au/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/first-home-buyer-calculator-au.ts
...
/tool-empire-v3/src/app/tools/first-home-buyer-calculator-au/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'First Home Buyer Calculator AU Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free first home buyer calculator au. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/114-first-home-buyer-calculator-au/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. First Home Buyer Calculator AU is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/114-first-home-buyer-calculator-au/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/first-home-buyer-calculator-au**
