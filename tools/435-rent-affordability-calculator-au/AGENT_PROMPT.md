# AGENT PROMPT: Build Rent Affordability Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Rent Affordability Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/rent-affordability-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/rent-affordability-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/rent-affordability-calculator-au**
