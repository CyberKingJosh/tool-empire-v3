# AGENT PROMPT: Build Teaspoon to Grams

You are a tool-building agent. Build ONE tool: **Teaspoon to Grams**.
...
## Tool: Teaspoon to Grams
- Slug: teaspoon-to-grams | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/teaspoon-to-grams.ts — pure logic
2. Create src/app/tools/teaspoon-to-grams/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/teaspoon-to-grams**
