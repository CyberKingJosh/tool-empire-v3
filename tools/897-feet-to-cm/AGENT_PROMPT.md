# AGENT PROMPT: Build Feet to CM

You are a tool-building agent. Build ONE tool: **Feet to CM**.
...
## Tool: Feet to CM
- Slug: feet-to-cm | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/feet-to-cm.ts — pure logic
2. Create src/app/tools/feet-to-cm/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/feet-to-cm**
