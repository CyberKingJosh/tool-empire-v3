# AGENT PROMPT: Build Time in Addis Ababa

You are a tool-building agent. Your job is to build ONE tool: **Time in Addis Ababa**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-addis-ababa.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-addis-ababa/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-addis-ababa**
