# AGENT PROMPT: Build Subdivision Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Subdivision Cost Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/subdivision-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/subdivision-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/subdivision-cost-calculator-au**
