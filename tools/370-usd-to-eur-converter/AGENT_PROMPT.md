# AGENT PROMPT: Build USD to EUR Converter

You are a tool-building agent. Your job is to build ONE tool: **USD to EUR Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/usd-to-eur-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/usd-to-eur-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/usd-to-eur-converter**
