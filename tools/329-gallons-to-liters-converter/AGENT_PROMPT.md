# AGENT PROMPT: Build GALLONS to LITERS Converter

You are a tool-building agent. Your job is to build ONE tool: **GALLONS to LITERS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gallons-to-liters-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gallons-to-liters-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gallons-to-liters-converter**
