# AGENT PROMPT: Build Avocado Toast Calculator

You are a tool-building agent. Your job is to build ONE tool: **Avocado Toast Calculator**.
...
## Step 3 — Design Brief
- Palette: Neon Pop (#0A0A0F background, #FF3366 accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/avocado-toast-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/avocado-toast-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/avocado-toast-calculator**
