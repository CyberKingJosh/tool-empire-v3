# AGENT PROMPT: Build Significant Figures Calc

You are a tool-building agent. Build ONE tool: **Significant Figures Calc**.
...
## Tool: Significant Figures Calc
- Slug: significant-figures-calc | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/significant-figures-calc.ts — pure logic
2. Create src/app/tools/significant-figures-calc/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/significant-figures-calc**
