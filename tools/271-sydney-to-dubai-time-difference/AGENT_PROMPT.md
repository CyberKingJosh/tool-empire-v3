# AGENT PROMPT: Build Sydney to Dubai Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Sydney to Dubai Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sydney-to-dubai-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sydney-to-dubai-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sydney-to-dubai-time-difference**
