# AGENT PROMPT: Build WPM Calculator

You are a tool-building agent. Your job is to build ONE tool: **WPM Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/wpm-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/wpm-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/wpm-calculator**
