# AGENT PROMPT: Build Simple Interest Calculator

You are a tool-building agent. Your job is to build ONE tool: **Simple Interest Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/simple-interest-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/simple-interest-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/simple-interest-calculator**
