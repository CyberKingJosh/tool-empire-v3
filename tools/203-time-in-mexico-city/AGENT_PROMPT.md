# AGENT PROMPT: Build Time in Mexico City

You are a tool-building agent. Your job is to build ONE tool: **Time in Mexico City**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-mexico-city.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-mexico-city/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-mexico-city**
