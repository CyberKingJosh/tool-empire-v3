# AGENT PROMPT: Build Fence Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Fence Cost Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fence-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fence-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fence-cost-calculator-au**
