# AGENT PROMPT: Build AI API Latency Compare

You are a tool-building agent. Your job is to build ONE tool: **AI API Latency Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-api-latency-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-api-latency-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-api-latency-compare**
