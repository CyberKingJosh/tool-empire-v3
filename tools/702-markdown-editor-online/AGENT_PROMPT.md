# AGENT PROMPT: Build Markdown Editor Online

You are a tool-building agent. Your job is to build ONE tool: **Markdown Editor Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/markdown-editor-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/markdown-editor-online/page.tsx` — full page component
