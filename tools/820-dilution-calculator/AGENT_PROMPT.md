# AGENT PROMPT: Build Dilution Calculator

You are a tool-building agent. Your job is to build ONE tool: **Dilution Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dilution-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dilution-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dilution-calculator**
