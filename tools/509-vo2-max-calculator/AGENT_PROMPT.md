# AGENT PROMPT: Build VO2 Max Calculator

You are a tool-building agent. Your job is to build ONE tool: **VO2 Max Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/vo2-max-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/vo2-max-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/vo2-max-calculator**
