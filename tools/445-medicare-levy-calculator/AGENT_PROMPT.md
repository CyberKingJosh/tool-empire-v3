# AGENT PROMPT: Build Medicare Levy Calculator

You are a tool-building agent. Your job is to build ONE tool: **Medicare Levy Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/medicare-levy-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/medicare-levy-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/medicare-levy-calculator**
