# AGENT PROMPT: Build HECTARES to ACRES Converter

You are a tool-building agent. Your job is to build ONE tool: **HECTARES to ACRES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hectares-to-acres-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hectares-to-acres-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hectares-to-acres-converter**
