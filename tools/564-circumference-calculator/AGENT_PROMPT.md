# AGENT PROMPT: Build Circumference Calculator

You are a tool-building agent. Your job is to build ONE tool: **Circumference Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/circumference-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/circumference-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/circumference-calculator**
