---
You are building Tool #143: Word Count Checker
...
6. /tool-empire-v3/tools/143-word-count-checker/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Word Count Checker
Target keyword: word count checker online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full word count checker with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "word count checker online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/word-count-checker/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/word-count-checker.ts
...
/tool-empire-v3/src/app/tools/word-count-checker/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Word Count Checker Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free word count checker. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/143-word-count-checker/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Word Count Checker is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/143-word-count-checker/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/word-count-checker**
