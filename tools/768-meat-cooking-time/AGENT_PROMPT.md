# AGENT PROMPT: Build Meat Cooking Time

You are a tool-building agent. Your job is to build ONE tool: **Meat Cooking Time**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/meat-cooking-time.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/meat-cooking-time/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/meat-cooking-time**
