# AGENT PROMPT: Build PT to PX Converter

You are a tool-building agent. Your job is to build ONE tool: **PT to PX Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pt-to-px-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pt-to-px-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pt-to-px-converter**
