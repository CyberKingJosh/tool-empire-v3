# AGENT PROMPT: Build Overtime Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Overtime Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/overtime-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/overtime-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/overtime-calculator-au**
