# AGENT PROMPT: Build Private Health Rebate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Private Health Rebate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/private-health-rebate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/private-health-rebate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/private-health-rebate-calculator**
