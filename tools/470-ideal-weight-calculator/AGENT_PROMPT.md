# AGENT PROMPT: Build Ideal Weight Calculator

You are a tool-building agent. Your job is to build ONE tool: **Ideal Weight Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ideal-weight-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ideal-weight-calculator/page.tsx` — full page component
