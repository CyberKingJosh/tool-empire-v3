# AGENT PROMPT: Build Days Until Halloween

You are a tool-building agent. Build ONE tool: **Days Until Halloween**.
...
## Tool: Days Until Halloween
- Slug: days-until-halloween | Category: date | Type: A | Tier: One | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-halloween.ts — pure logic
2. Create src/app/tools/days-until-halloween/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-halloween**
