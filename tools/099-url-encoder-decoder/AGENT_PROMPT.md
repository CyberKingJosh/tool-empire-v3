---
You are building Tool #099: URL Encoder Decoder
...
6. /tool-empire-v3/tools/099-url-encoder-decoder/SPEC.md — your specific tool data
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full url encoder decoder with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "url encoder decoder online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/url-encoder-decoder/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/url-encoder-decoder.ts
...
/tool-empire-v3/src/app/tools/url-encoder-decoder/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'URL Encoder Decoder Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free url encoder decoder. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/099-url-encoder-decoder/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. URL Encoder Decoder is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/099-url-encoder-decoder/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/url-encoder-decoder**
