# AGENT PROMPT: Build BTU to WATTS Converter

You are a tool-building agent. Your job is to build ONE tool: **BTU to WATTS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/btu-to-watts-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/btu-to-watts-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/btu-to-watts-converter**
