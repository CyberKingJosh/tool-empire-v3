# AGENT PROMPT: Build Area Calculator

You are a tool-building agent. Your job is to build ONE tool: **Area Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/area-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/area-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/area-calculator**
