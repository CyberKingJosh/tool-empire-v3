# AGENT PROMPT: Build Negative Gearing Calculator

You are a tool-building agent. Your job is to build ONE tool: **Negative Gearing Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/negative-gearing-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/negative-gearing-calculator/page.tsx` — full page component
