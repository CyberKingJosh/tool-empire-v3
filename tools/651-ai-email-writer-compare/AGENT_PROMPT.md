# AGENT PROMPT: Build AI Email Writer Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Email Writer Compare**.
...
## Step 2 — Tool Summary
- **Name**: AI Email Writer Compare
- **Slug**: ai-email-writer-compare
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-email-writer-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-email-writer-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-email-writer-compare**
