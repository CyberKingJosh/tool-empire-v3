# AGENT PROMPT: Build Waist to Hip Ratio

You are a tool-building agent. Your job is to build ONE tool: **Waist to Hip Ratio**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/waist-to-hip-ratio.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/waist-to-hip-ratio/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/waist-to-hip-ratio**
