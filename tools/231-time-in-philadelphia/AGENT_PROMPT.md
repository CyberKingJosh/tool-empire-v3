# AGENT PROMPT: Build Time in Philadelphia

You are a tool-building agent. Your job is to build ONE tool: **Time in Philadelphia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-philadelphia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-philadelphia/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-philadelphia**
