# AGENT PROMPT: Build Meta Tag Generator

You are a tool-building agent. Your job is to build ONE tool: **Meta Tag Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/meta-tag-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/meta-tag-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/meta-tag-generator**
