# AGENT PROMPT: Build Child Support Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Child Support Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/child-support-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/child-support-calculator-au/page.tsx` — full page component
