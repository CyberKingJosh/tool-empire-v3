---
You are building Tool #149: Midjourney Prompt Generator
...
6. /tool-empire-v3/tools/149-midjourney-prompt-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Midjourney Prompt Generator
Target keyword: midjourney prompt generator free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full midjourney prompt generator preview on screen for free
$1 AUD export: Yes — PDF of generated document
Pro tier: N/A
Competitors and their weaknesses:
- platform.openai.com/tokenizer: Only GPT models, no Claude/Gemini
- tokencounter.org: Basic, no cost calculation
- artificialanalysis.ai: Data-focused, not interactive calculator

Australian data needed: No
Related tools:
- AI Token Counter at /tools/ai-token-counter
- ChatGPT Cost Calculator at /tools/chatgpt-cost-calculator
- LLM Model Price Comparison at /tools/llm-model-price-comparison
- AI vs Freelancer Cost at /tools/ai-vs-freelancer-cost

Affiliate: Claude Pro — Advanced AI assistant for professionals — claude.ai/pro

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: dark technical
2. Differentiation: Compares ALL major models (Claude, GPT, Gemini, Llama) — no competitor does this comprehensively
3. Unforgettable detail: A terminal-style cursor blinks next to the result, and numbers count up in monospace font like a real API meter
4. Font pairing: Technical Precision (Space Grotesk 600-700 + JetBrains Mono)
5. Colour palette: Primary #0D1117 | Accent #58A6FF | Surface #161B22 | Text #C9D1D9 | Result #3FB950

COMPETITOR RESEARCH — Do this before any code:
Search "midjourney prompt generator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/midjourney-prompt-generator/page.tsx
Import ToolLayout from shared. Set all props correctly.
Tier: 2 — 2 AdSense slots.
Tool interaction must be above fold on 375px mobile. Non-negotiable.

Step 2: Create /tool-empire-v3/src/lib/tools/midjourney-prompt-generator.ts
...
/tool-empire-v3/src/app/tools/midjourney-prompt-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Midjourney Prompt Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free midjourney prompt generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/149-midjourney-prompt-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Midjourney Prompt Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/149-midjourney-prompt-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/midjourney-prompt-generator**
