# AGENT PROMPT: Build Time in Miami

You are a tool-building agent. Your job is to build ONE tool: **Time in Miami**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-miami.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-miami/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-miami**
