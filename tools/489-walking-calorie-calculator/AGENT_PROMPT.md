# AGENT PROMPT: Build Walking Calorie Calculator

You are a tool-building agent. Your job is to build ONE tool: **Walking Calorie Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/walking-calorie-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/walking-calorie-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/walking-calorie-calculator**
