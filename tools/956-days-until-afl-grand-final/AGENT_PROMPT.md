# AGENT PROMPT: Build Days Until AFL Grand Final

You are a tool-building agent. Build ONE tool: **Days Until AFL Grand Final**.
...
## Tool: Days Until AFL Grand Final
- Slug: days-until-afl-grand-final | Category: date | Type: A | Tier: Two | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-afl-grand-final.ts — pure logic
2. Create src/app/tools/days-until-afl-grand-final/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-afl-grand-final**
