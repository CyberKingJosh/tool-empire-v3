# AGENT PROMPT: Build Salary Sacrifice Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Salary Sacrifice Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/salary-sacrifice-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/salary-sacrifice-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/salary-sacrifice-calculator-au**
