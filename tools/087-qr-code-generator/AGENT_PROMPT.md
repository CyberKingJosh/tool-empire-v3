---
You are building Tool #087: QR Code Generator
...
6. /tool-empire-v3/tools/087-qr-code-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: QR Code Generator
Target keyword: qr code generator free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full qr code generator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "qr code generator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/qr-code-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/qr-code-generator.ts
...
/tool-empire-v3/src/app/tools/qr-code-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'QR Code Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free qr code generator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/087-qr-code-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. QR Code Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/087-qr-code-generator/ and resume from where it stopped."
...
Then open: **http://localhost:3000/tools/qr-code-generator**
