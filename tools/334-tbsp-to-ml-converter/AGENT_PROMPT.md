# AGENT PROMPT: Build TBSP to ML Converter

You are a tool-building agent. Your job is to build ONE tool: **TBSP to ML Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tbsp-to-ml-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tbsp-to-ml-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tbsp-to-ml-converter**
