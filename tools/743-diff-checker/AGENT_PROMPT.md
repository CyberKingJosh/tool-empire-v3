# AGENT PROMPT: Build Diff Checker

You are a tool-building agent. Your job is to build ONE tool: **Diff Checker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/diff-checker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/diff-checker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/diff-checker**
