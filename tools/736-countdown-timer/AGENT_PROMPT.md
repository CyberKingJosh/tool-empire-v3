# AGENT PROMPT: Build Countdown Timer

You are a tool-building agent. Your job is to build ONE tool: **Countdown Timer**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/countdown-timer.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/countdown-timer/page.tsx` — full page component
