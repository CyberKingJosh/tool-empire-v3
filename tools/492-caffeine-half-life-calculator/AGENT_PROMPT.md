# AGENT PROMPT: Build Caffeine Half Life Calculator

You are a tool-building agent. Your job is to build ONE tool: **Caffeine Half Life Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/caffeine-half-life-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/caffeine-half-life-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/caffeine-half-life-calculator**
