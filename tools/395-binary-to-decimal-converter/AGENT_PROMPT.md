# AGENT PROMPT: Build BINARY to DECIMAL Converter

You are a tool-building agent. Your job is to build ONE tool: **BINARY to DECIMAL Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/binary-to-decimal-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/binary-to-decimal-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/binary-to-decimal-converter**
