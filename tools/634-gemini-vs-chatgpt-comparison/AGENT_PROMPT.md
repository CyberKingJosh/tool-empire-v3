# AGENT PROMPT: Build Gemini vs ChatGPT Comparison

You are a tool-building agent. Your job is to build ONE tool: **Gemini vs ChatGPT Comparison**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gemini-vs-chatgpt-comparison.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gemini-vs-chatgpt-comparison/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gemini-vs-chatgpt-comparison**
