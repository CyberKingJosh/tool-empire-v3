# AGENT PROMPT: Build London to Los Angeles Time Difference

You are a tool-building agent. Your job is to build ONE tool: **London to Los Angeles Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: London to Los Angeles Time Difference
- **Slug**: london-to-los-angeles-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/london-to-los-angeles-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/london-to-los-angeles-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/london-to-los-angeles-time-difference**
