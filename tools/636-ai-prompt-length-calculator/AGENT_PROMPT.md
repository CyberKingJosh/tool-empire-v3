# AGENT PROMPT: Build AI Prompt Length Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Prompt Length Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-prompt-length-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-prompt-length-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-prompt-length-calculator**
