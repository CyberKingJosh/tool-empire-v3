# AGENT PROMPT: Build Downsizer Contribution Calculator

You are a tool-building agent. Your job is to build ONE tool: **Downsizer Contribution Calculator**.
...
## Step 3 — Design Brief
- Palette: Navy Finance (#0F4C75 background, #FFB400 accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/downsizer-contribution-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/downsizer-contribution-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/downsizer-contribution-calculator**
