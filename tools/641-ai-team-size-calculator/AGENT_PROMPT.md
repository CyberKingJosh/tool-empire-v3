# AGENT PROMPT: Build AI Team Size Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Team Size Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-team-size-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-team-size-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-team-size-calculator**
