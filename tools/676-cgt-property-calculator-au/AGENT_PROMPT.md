# AGENT PROMPT: Build CGT Property Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **CGT Property Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cgt-property-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cgt-property-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cgt-property-calculator-au**
