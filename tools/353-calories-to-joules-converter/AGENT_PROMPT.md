# AGENT PROMPT: Build CALORIES to JOULES Converter

You are a tool-building agent. Your job is to build ONE tool: **CALORIES to JOULES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/calories-to-joules-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/calories-to-joules-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/calories-to-joules-converter**
