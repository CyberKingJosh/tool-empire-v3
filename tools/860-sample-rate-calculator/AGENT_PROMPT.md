# AGENT PROMPT: Build Sample Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Sample Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sample-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sample-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sample-rate-calculator**
