# AGENT PROMPT: Build Percentage Calculator

You are a tool-building agent. Your job is to build ONE tool: **Percentage Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/percentage-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/percentage-calculator/page.tsx` — full page component
