# AGENT PROMPT: Build ACRES to HECTARES Converter

You are a tool-building agent. Your job is to build ONE tool: **ACRES to HECTARES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/acres-to-hectares-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/acres-to-hectares-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/acres-to-hectares-converter**
