---
You are building Tool #130: Macro Calculator
...
6. /tool-empire-v3/tools/130-macro-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Macro Calculator
Target keyword: macro calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full macro calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "macro calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/macro-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/macro-calculator.ts
...
/tool-empire-v3/src/app/tools/macro-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Macro Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free macro calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/130-macro-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Macro Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/130-macro-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/macro-calculator**
