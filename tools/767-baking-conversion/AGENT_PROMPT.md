# AGENT PROMPT: Build Baking Conversion

You are a tool-building agent. Your job is to build ONE tool: **Baking Conversion**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/baking-conversion.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/baking-conversion/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/baking-conversion**
