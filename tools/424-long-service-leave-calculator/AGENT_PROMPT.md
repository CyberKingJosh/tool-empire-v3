# AGENT PROMPT: Build Long Service Leave Calculator

You are a tool-building agent. Your job is to build ONE tool: **Long Service Leave Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/long-service-leave-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/long-service-leave-calculator/page.tsx` — full page component
