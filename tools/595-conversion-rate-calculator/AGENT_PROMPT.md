# AGENT PROMPT: Build Conversion Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Conversion Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/conversion-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/conversion-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/conversion-rate-calculator**
