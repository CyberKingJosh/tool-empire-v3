# AGENT PROMPT: Build Atmospheres to PSI

You are a tool-building agent. Build ONE tool: **Atmospheres to PSI**.
...
## Tool: Atmospheres to PSI
- Slug: atmospheres-to-psi | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/atmospheres-to-psi.ts — pure logic
2. Create src/app/tools/atmospheres-to-psi/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/atmospheres-to-psi**
