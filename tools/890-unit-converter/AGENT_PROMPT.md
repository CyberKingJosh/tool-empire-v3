# AGENT PROMPT: Build Unit Converter

You are a tool-building agent. Your job is to build ONE tool: **Unit Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/unit-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/unit-converter/page.tsx` — full page component
