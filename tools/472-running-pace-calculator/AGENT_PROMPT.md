# AGENT PROMPT: Build Running Pace Calculator

You are a tool-building agent. Your job is to build ONE tool: **Running Pace Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/running-pace-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/running-pace-calculator/page.tsx` — full page component
