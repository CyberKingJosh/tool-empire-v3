# AGENT PROMPT: Build KM to MILES Converter

You are a tool-building agent. Your job is to build ONE tool: **KM to MILES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/km-to-miles-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/km-to-miles-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/km-to-miles-converter**
