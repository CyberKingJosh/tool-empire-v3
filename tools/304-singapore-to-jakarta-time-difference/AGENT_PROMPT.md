# AGENT PROMPT: Build Singapore to Jakarta Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Singapore to Jakarta Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Singapore to Jakarta Time Difference
- **Slug**: singapore-to-jakarta-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/singapore-to-jakarta-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/singapore-to-jakarta-time-difference/page.tsx` — full page component
