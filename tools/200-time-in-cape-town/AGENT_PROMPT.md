# AGENT PROMPT: Build Time in Cape Town

You are a tool-building agent. Your job is to build ONE tool: **Time in Cape Town**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-cape-town.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-cape-town/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-cape-town**
