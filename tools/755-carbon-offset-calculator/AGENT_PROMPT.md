# AGENT PROMPT: Build Carbon Offset Calculator

You are a tool-building agent. Your job is to build ONE tool: **Carbon Offset Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/carbon-offset-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/carbon-offset-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/carbon-offset-calculator**
