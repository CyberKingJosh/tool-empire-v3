# AGENT PROMPT: Build Cups to Ounces

You are a tool-building agent. Build ONE tool: **Cups to Ounces**.
...
## Tool: Cups to Ounces
- Slug: cups-to-ounces | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/cups-to-ounces.ts — pure logic
2. Create src/app/tools/cups-to-ounces/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/cups-to-ounces**
