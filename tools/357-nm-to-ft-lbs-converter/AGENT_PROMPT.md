# AGENT PROMPT: Build NM to FT-LBS Converter

You are a tool-building agent. Your job is to build ONE tool: **NM to FT-LBS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/nm-to-ft-lbs-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/nm-to-ft-lbs-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/nm-to-ft-lbs-converter**
