# AGENT PROMPT: Build Ohms Law Calculator

You are a tool-building agent. Your job is to build ONE tool: **Ohms Law Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ohms-law-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ohms-law-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ohms-law-calculator**
