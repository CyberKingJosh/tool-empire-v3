# AGENT PROMPT: Build KG to STONES Converter

You are a tool-building agent. Your job is to build ONE tool: **KG to STONES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/kg-to-stones-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/kg-to-stones-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/kg-to-stones-converter**
