# AGENT PROMPT: Build Notepad Online

You are a tool-building agent. Your job is to build ONE tool: **Notepad Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/notepad-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/notepad-online/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/notepad-online**
