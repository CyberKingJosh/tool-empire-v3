# AGENT PROMPT: Build Business Name Generator AU

You are a tool-building agent. Your job is to build ONE tool: **Business Name Generator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/business-name-generator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/business-name-generator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/business-name-generator-au**
