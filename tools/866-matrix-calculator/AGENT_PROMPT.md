# AGENT PROMPT: Build Matrix Calculator

You are a tool-building agent. Your job is to build ONE tool: **Matrix Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/matrix-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/matrix-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/matrix-calculator**
