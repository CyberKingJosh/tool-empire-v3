# AGENT PROMPT: Build Cron Expression Generator

You are a tool-building agent. Your job is to build ONE tool: **Cron Expression Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cron-expression-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cron-expression-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cron-expression-generator**
