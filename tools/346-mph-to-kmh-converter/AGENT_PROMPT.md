# AGENT PROMPT: Build MPH to KMH Converter

You are a tool-building agent. Your job is to build ONE tool: **MPH to KMH Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mph-to-kmh-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mph-to-kmh-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mph-to-kmh-converter**
