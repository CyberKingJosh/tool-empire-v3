# AGENT PROMPT: Build HTAccess Generator

You are a tool-building agent. Your job is to build ONE tool: **HTAccess Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/htaccess-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/htaccess-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/htaccess-generator**
