# AGENT PROMPT: Build AI Video Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Video Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-video-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-video-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-video-cost-calculator**
