# AGENT PROMPT: Build Binary Calculator

You are a tool-building agent. Your job is to build ONE tool: **Binary Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/binary-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/binary-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/binary-calculator**
