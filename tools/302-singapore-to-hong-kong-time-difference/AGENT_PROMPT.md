# AGENT PROMPT: Build Singapore to Hong Kong Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Singapore to Hong Kong Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/singapore-to-hong-kong-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/singapore-to-hong-kong-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/singapore-to-hong-kong-time-difference**
