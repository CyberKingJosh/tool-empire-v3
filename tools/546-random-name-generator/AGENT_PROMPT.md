# AGENT PROMPT: Build Random Name Generator

You are a tool-building agent. Your job is to build ONE tool: **Random Name Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/random-name-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/random-name-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/random-name-generator**
