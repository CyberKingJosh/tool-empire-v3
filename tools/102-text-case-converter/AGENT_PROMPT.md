---
You are building Tool #102: Text Case Converter
...
6. /tool-empire-v3/tools/102-text-case-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Text Case Converter
Target keyword: text case converter online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full text case converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "text case converter online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/text-case-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/text-case-converter.ts
...
/tool-empire-v3/src/app/tools/text-case-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Text Case Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free text case converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/102-text-case-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Text Case Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/102-text-case-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/text-case-converter**
