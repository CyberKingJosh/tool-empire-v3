# AGENT PROMPT: Build Runway Calculator

You are a tool-building agent. Your job is to build ONE tool: **Runway Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/runway-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/runway-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/runway-calculator**
