# AGENT PROMPT: Build Due Date Calculator

You are a tool-building agent. Your job is to build ONE tool: **Due Date Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/due-date-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/due-date-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/due-date-calculator**
