# AGENT PROMPT: Build GPU Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **GPU Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gpu-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gpu-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gpu-cost-calculator**
