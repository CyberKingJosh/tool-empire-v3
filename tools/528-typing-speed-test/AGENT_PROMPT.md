# AGENT PROMPT: Build Typing Speed Test

You are a tool-building agent. Your job is to build ONE tool: **Typing Speed Test**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/typing-speed-test.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/typing-speed-test/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/typing-speed-test**
