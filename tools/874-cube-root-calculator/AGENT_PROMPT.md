# AGENT PROMPT: Build Cube Root Calculator

You are a tool-building agent. Your job is to build ONE tool: **Cube Root Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cube-root-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cube-root-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cube-root-calculator**
