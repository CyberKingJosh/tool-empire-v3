---
You are building Tool #073: Cm To Inches
...
6. /tool-empire-v3/tools/073-cm-to-inches/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Cm To Inches
Target keyword: cm to inches
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full cm to inches with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "cm to inches". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/cm-to-inches/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/cm-to-inches.ts
...
/tool-empire-v3/src/app/tools/cm-to-inches/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Cm To Inches Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free cm to inches. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/073-cm-to-inches/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Cm To Inches is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/073-cm-to-inches/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/cm-to-inches**
