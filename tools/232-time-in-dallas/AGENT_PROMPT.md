# AGENT PROMPT: Build Time in Dallas

You are a tool-building agent. Your job is to build ONE tool: **Time in Dallas**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-dallas.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-dallas/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-dallas**
