# AGENT PROMPT: Build Final Grade Calculator

You are a tool-building agent. Your job is to build ONE tool: **Final Grade Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/final-grade-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/final-grade-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/final-grade-calculator**
