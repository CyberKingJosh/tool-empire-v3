# AGENT PROMPT: Build HTML Encoder Decoder

You are a tool-building agent. Your job is to build ONE tool: **HTML Encoder Decoder**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/html-encoder-decoder.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/html-encoder-decoder/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/html-encoder-decoder**
