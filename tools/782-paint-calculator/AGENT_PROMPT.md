# AGENT PROMPT: Build Paint Calculator

You are a tool-building agent. Your job is to build ONE tool: **Paint Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/paint-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/paint-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/paint-calculator**
