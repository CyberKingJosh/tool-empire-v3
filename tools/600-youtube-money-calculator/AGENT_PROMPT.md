# AGENT PROMPT: Build YouTube Money Calculator

You are a tool-building agent. Your job is to build ONE tool: **YouTube Money Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/youtube-money-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/youtube-money-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/youtube-money-calculator**
