---
You are building Tool #035: Current Time In Los Angeles
...
6. /tool-empire-v3/tools/035-current-time-in-los-angeles/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Current Time In Los Angeles
Target keyword: current time in los angeles
Monthly volume: 22,000,000
Difficulty: Easy
RPM: $3 AUD
Monetisation: Type A
Tier: 0
Build time estimate: 15 min
Category: time
API Cost: FREE
Beat difficulty: N/A
Free tier: Full current time in los angeles with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- timeanddate.com: Cluttered with ads, information overload
- worldtimebuddy.com: Dated UI, not mobile-first
- time.is: Minimal but no conversion features

Australian data needed: No
Related tools:
- Overlap Hours Calculator at /tools/overlap-hours-calculator
- Global Meeting Time Optimizer at /tools/global-meeting-time-optimizer
- What Time Is It at /tools/what-time-is-it
- World Clock at /tools/world-clock

Affiliate: Toggl Track — Free time tracking for remote teams — toggl.com/track/

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: clean precise
2. Differentiation: Luxury watch aesthetic with dark theme — feels like a premium instrument catalogue, not a generic clock site
3. Unforgettable detail: The time display pulses subtly like a heartbeat every second, with a faint digital tick sound option
4. Font pairing: Technical Precision (Space Grotesk 600-700 + JetBrains Mono)
5. Colour palette: Primary #1B2A4A | Accent #3B82F6 | Surface #F8FAFC | Text #1E293B | Result #0F172A

COMPETITOR RESEARCH — Do this before any code:
Search "current time in los angeles". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/current-time-in-los-angeles/page.tsx
Import ToolLayout from shared. Set all props correctly.
Tier: 0 — 3 AdSense slots.
Tool interaction must be above fold on 375px mobile. Non-negotiable.

Step 2: Create /tool-empire-v3/src/lib/tools/current-time-in-los-angeles.ts
...
Type A: confirm 3 AdSense slots in correct positions per MONETISATION_RULES.md
...
/tool-empire-v3/src/app/tools/current-time-in-los-angeles/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Current Time In Los Angeles Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free current time in los angeles. [one sentence]. No signup. Instant results.'
...
[ ] Correct AdSense slot count (3) and positions per MONETISATION_RULES.md
...
Update /tool-empire-v3/tools/035-current-time-in-los-angeles/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Current Time In Los Angeles is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/035-current-time-in-los-angeles/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/current-time-in-los-angeles**
...
The old dark palette (#1B2A4A / #3B82F6 / #0F172A) is removed.
