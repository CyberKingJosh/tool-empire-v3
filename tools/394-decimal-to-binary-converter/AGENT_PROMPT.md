# AGENT PROMPT: Build DECIMAL to BINARY Converter

You are a tool-building agent. Your job is to build ONE tool: **DECIMAL to BINARY Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/decimal-to-binary-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/decimal-to-binary-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/decimal-to-binary-converter**
