# AGENT PROMPT: Build Tax Offset Calculator AU

You are a tool-building agent. Build ONE tool: **Tax Offset Calculator AU**.
...
## Tool: Tax Offset Calculator AU
- Slug: tax-offset-calculator-au | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/tax-offset-calculator-au.ts — pure logic
2. Create src/app/tools/tax-offset-calculator-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/tax-offset-calculator-au**
