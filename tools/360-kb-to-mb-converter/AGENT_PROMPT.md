# AGENT PROMPT: Build KB to MB Converter

You are a tool-building agent. Your job is to build ONE tool: **KB to MB Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/kb-to-mb-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/kb-to-mb-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/kb-to-mb-converter**
