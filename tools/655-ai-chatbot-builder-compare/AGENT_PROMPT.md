# AGENT PROMPT: Build AI Chatbot Builder Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Chatbot Builder Compare**.
...
## Step 2 — Tool Summary
- **Name**: AI Chatbot Builder Compare
- **Slug**: ai-chatbot-builder-compare
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-chatbot-builder-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-chatbot-builder-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-chatbot-builder-compare**
