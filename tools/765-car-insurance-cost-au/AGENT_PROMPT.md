# AGENT PROMPT: Build Car Insurance Cost AU

You are a tool-building agent. Your job is to build ONE tool: **Car Insurance Cost AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/car-insurance-cost-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/car-insurance-cost-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/car-insurance-cost-au**
