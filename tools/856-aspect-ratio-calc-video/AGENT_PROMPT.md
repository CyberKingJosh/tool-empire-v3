# AGENT PROMPT: Build Aspect Ratio Calc Video

You are a tool-building agent. Your job is to build ONE tool: **Aspect Ratio Calc Video**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aspect-ratio-calc-video.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aspect-ratio-calc-video/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/aspect-ratio-calc-video**
