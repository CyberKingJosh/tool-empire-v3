# AGENT PROMPT: Build Guitar Tuner

You are a tool-building agent. Your job is to build ONE tool: **Guitar Tuner**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/guitar-tuner.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/guitar-tuner/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/guitar-tuner**
