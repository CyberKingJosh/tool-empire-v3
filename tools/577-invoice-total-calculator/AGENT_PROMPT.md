# AGENT PROMPT: Build Invoice Total Calculator

You are a tool-building agent. Your job is to build ONE tool: **Invoice Total Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/invoice-total-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/invoice-total-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/invoice-total-calculator**
