---
You are building Tool #067: Dog Age Calculator
...
6. /tool-empire-v3/tools/067-dog-age-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Dog Age Calculator
Target keyword: dog age in human years
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full dog age calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "dog age in human years". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/dog-age-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/dog-age-calculator.ts
...
/tool-empire-v3/src/app/tools/dog-age-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Dog Age Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free dog age calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/067-dog-age-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Dog Age Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/067-dog-age-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/dog-age-calculator**
