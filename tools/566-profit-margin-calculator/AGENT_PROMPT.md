# AGENT PROMPT: Build Profit Margin Calculator

You are a tool-building agent. Your job is to build ONE tool: **Profit Margin Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/profit-margin-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/profit-margin-calculator/page.tsx` — full page component
