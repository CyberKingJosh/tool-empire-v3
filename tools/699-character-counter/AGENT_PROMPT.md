# AGENT PROMPT: Build Character Counter

You are a tool-building agent. Your job is to build ONE tool: **Character Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/character-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/character-counter/page.tsx` — full page component
