# AGENT PROMPT: Build Crypto Tax Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **Crypto Tax Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/crypto-tax-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/crypto-tax-calculator-australia/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/crypto-tax-calculator-australia**
