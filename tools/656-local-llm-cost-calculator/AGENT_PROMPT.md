# AGENT PROMPT: Build Local LLM Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Local LLM Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/local-llm-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/local-llm-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/local-llm-cost-calculator**
