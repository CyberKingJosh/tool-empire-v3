# AGENT PROMPT: Build Lucky Number Generator

You are a tool-building agent. Your job is to build ONE tool: **Lucky Number Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/lucky-number-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/lucky-number-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/lucky-number-generator**
