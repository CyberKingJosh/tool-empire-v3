# AGENT PROMPT: Build Redundancy Pay Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Redundancy Pay Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/redundancy-pay-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/redundancy-pay-calculator-au/page.tsx` — full page component
