# AGENT PROMPT: Build Step Counter Converter

You are a tool-building agent. Your job is to build ONE tool: **Step Counter Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/step-counter-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/step-counter-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/step-counter-converter**
