# AGENT PROMPT: Build Frame Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Frame Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/frame-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/frame-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/frame-rate-calculator**
