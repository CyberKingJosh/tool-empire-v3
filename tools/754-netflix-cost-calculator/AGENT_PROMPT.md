# AGENT PROMPT: Build Netflix Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Netflix Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/netflix-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/netflix-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/netflix-cost-calculator**
