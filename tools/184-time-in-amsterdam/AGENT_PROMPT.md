# AGENT PROMPT: Build Time in Amsterdam

You are a tool-building agent. Your job is to build ONE tool: **Time in Amsterdam**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-amsterdam.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-amsterdam/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-amsterdam**
