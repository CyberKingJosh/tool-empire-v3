---
You are building Tool #029: Monthly AI Spend Tracker
...
6. /tool-empire-v3/tools/029-monthly-ai-spend-tracker/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Monthly AI Spend Tracker
Target keyword: monthly ai spend tracker for teams
Monthly volume: 6,000
Difficulty: Easy
RPM: $14 AUD
Monetisation: Type A
Tier: Emerging
...
API Cost: FREE
Beat difficulty: 2
Free tier: Full monthly ai spend tracker with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "monthly ai spend tracker for teams". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/monthly-ai-spend-tracker/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/monthly-ai-spend-tracker.ts
...
/tool-empire-v3/src/app/tools/monthly-ai-spend-tracker/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Monthly AI Spend Tracker Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free monthly ai spend tracker. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/029-monthly-ai-spend-tracker/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Monthly AI Spend Tracker is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/029-monthly-ai-spend-tracker/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/monthly-ai-spend-tracker**
