---
You are building Tool #028: Hormone Cycle Planner
...
6. /tool-empire-v3/tools/028-hormone-cycle-planner/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Hormone Cycle Planner
Target keyword: hormone cycle productivity planner
Monthly volume: 9,000
Difficulty: Medium
RPM: $8 AUD
Monetisation: Type A
Tier: Emerging
...
API Cost: FREE
Beat difficulty: 3
Free tier: Full hormone cycle planner with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "hormone cycle productivity planner". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/hormone-cycle-planner/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/hormone-cycle-planner.ts
...
/tool-empire-v3/src/app/tools/hormone-cycle-planner/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Hormone Cycle Planner Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free hormone cycle planner. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/028-hormone-cycle-planner/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Hormone Cycle Planner is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/028-hormone-cycle-planner/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/hormone-cycle-planner**
