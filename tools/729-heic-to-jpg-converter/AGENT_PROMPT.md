# AGENT PROMPT: Build HEIC to JPG Converter

You are a tool-building agent. Your job is to build ONE tool: **HEIC to JPG Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/heic-to-jpg-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/heic-to-jpg-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/heic-to-jpg-converter**
