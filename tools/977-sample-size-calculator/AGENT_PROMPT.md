# AGENT PROMPT: Build Sample Size Calculator

You are a tool-building agent. Build ONE tool: **Sample Size Calculator**.
...
- Slug: sample-size-calculator | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/sample-size-calculator.ts — pure logic
2. Create src/app/tools/sample-size-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/sample-size-calculator**
