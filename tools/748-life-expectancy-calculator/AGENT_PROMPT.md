# AGENT PROMPT: Build Life Expectancy Calculator

You are a tool-building agent. Your job is to build ONE tool: **Life Expectancy Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/life-expectancy-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/life-expectancy-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/life-expectancy-calculator**
