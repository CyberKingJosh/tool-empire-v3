# AGENT PROMPT: Build Vector Database Cost Calc

You are a tool-building agent. Your job is to build ONE tool: **Vector Database Cost Calc**.
...
## Step 2 — Tool Summary
- **Name**: Vector Database Cost Calc
- **Slug**: vector-database-cost-calc
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/vector-database-cost-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/vector-database-cost-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/vector-database-cost-calc**
