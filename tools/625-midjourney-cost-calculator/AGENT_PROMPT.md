# AGENT PROMPT: Build Midjourney Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Midjourney Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/midjourney-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/midjourney-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/midjourney-cost-calculator**
