# AGENT PROMPT: Build Grade Calculator

You are a tool-building agent. Your job is to build ONE tool: **Grade Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/grade-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/grade-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/grade-calculator**
