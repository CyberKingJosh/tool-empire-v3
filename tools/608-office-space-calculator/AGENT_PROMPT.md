# AGENT PROMPT: Build Office Space Calculator

You are a tool-building agent. Your job is to build ONE tool: **Office Space Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/office-space-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/office-space-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/office-space-calculator**
