# AGENT PROMPT: Build Body Fat Calculator

You are a tool-building agent. Your job is to build ONE tool: **Body Fat Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/body-fat-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/body-fat-calculator/page.tsx` — full page component
