# AGENT PROMPT: Build GST Inclusive Calculator

You are a tool-building agent. Your job is to build ONE tool: **GST Inclusive Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gst-inclusive-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gst-inclusive-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gst-inclusive-calculator**
