# AGENT PROMPT: Build Readability Score Calculator

You are a tool-building agent. Your job is to build ONE tool: **Readability Score Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/readability-score-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/readability-score-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/readability-score-calculator**
