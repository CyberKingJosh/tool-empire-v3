# AGENT PROMPT: Build JSON Formatter

You are a tool-building agent. Your job is to build ONE tool: **JSON Formatter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/json-formatter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/json-formatter/page.tsx` — full page component
