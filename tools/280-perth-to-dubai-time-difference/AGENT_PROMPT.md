# AGENT PROMPT: Build Perth to Dubai Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Perth to Dubai Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/perth-to-dubai-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/perth-to-dubai-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/perth-to-dubai-time-difference**
