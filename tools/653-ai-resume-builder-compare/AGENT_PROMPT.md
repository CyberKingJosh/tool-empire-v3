# AGENT PROMPT: Build AI Resume Builder Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Resume Builder Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-resume-builder-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-resume-builder-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-resume-builder-compare**
