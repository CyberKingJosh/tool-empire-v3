---
You are building Tool #052: Current Time In Perth
...
6. /tool-empire-v3/tools/052-current-time-in-perth/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Current Time In Perth
Target keyword: current time in perth
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full current time in perth with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "current time in perth". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/current-time-in-perth/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/current-time-in-perth.ts
...
/tool-empire-v3/src/app/tools/current-time-in-perth/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Current Time In Perth Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free current time in perth. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/052-current-time-in-perth/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Current Time In Perth is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/052-current-time-in-perth/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/current-time-in-perth**
