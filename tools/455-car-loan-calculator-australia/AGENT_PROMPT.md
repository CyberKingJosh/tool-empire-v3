# AGENT PROMPT: Build Car Loan Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **Car Loan Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/car-loan-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/car-loan-calculator-australia/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/car-loan-calculator-australia**
