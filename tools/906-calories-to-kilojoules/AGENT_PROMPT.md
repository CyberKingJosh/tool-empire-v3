# AGENT PROMPT: Build Calories to Kilojoules

You are a tool-building agent. Build ONE tool: **Calories to Kilojoules**.
...
## Tool: Calories to Kilojoules
- Slug: calories-to-kilojoules | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/calories-to-kilojoules.ts — pure logic
2. Create src/app/tools/calories-to-kilojoules/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/calories-to-kilojoules**
