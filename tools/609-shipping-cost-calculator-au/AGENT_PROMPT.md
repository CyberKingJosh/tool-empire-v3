# AGENT PROMPT: Build Shipping Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Shipping Cost Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Shipping Cost Calculator AU
- **Slug**: shipping-cost-calculator-au
- **Category**: finance
...
## Step 4 — Build Steps
1. Create `src/lib/tools/shipping-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/shipping-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/shipping-cost-calculator-au**
