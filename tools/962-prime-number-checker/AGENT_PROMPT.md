# AGENT PROMPT: Build Prime Number Checker

You are a tool-building agent. Build ONE tool: **Prime Number Checker**.
...
- Slug: prime-number-checker | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/prime-number-checker.ts — pure logic
2. Create src/app/tools/prime-number-checker/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/prime-number-checker**
