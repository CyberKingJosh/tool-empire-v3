# AGENT PROMPT: Build Plagiarism Percentage Calc

You are a tool-building agent. Your job is to build ONE tool: **Plagiarism Percentage Calc**.
...
## Step 2 — Tool Summary
- **Name**: Plagiarism Percentage Calc
- **Slug**: plagiarism-percentage-calc
- **Category**: education
...
## Step 4 — Build Steps
1. Create `src/lib/tools/plagiarism-percentage-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/plagiarism-percentage-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/plagiarism-percentage-calc**
