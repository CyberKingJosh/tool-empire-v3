# AGENT PROMPT: Build Stopwatch Online

You are a tool-building agent. Your job is to build ONE tool: **Stopwatch Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/stopwatch-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/stopwatch-online/page.tsx` — full page component
