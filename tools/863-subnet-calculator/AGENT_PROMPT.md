# AGENT PROMPT: Build Subnet Calculator

You are a tool-building agent. Your job is to build ONE tool: **Subnet Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/subnet-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/subnet-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/subnet-calculator**
