# AGENT PROMPT: Build Time in Istanbul

You are a tool-building agent. Your job is to build ONE tool: **Time in Istanbul**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-istanbul.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-istanbul/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-istanbul**
