# AGENT PROMPT: Build Name Compatibility Calc

You are a tool-building agent. Your job is to build ONE tool: **Name Compatibility Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/name-compatibility-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/name-compatibility-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/name-compatibility-calc**
