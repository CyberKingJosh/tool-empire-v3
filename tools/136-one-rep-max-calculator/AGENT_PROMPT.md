---
You are building Tool #136: One Rep Max Calculator
...
6. /tool-empire-v3/tools/136-one-rep-max-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: One Rep Max Calculator
Target keyword: one rep max calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full one rep max calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "one rep max calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/one-rep-max-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/one-rep-max-calculator.ts
...
/tool-empire-v3/src/app/tools/one-rep-max-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'One Rep Max Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free one rep max calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/136-one-rep-max-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. One Rep Max Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/136-one-rep-max-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/one-rep-max-calculator**
