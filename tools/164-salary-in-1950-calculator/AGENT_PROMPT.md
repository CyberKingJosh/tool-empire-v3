---
You are building Tool #164: Salary In 1950 Calculator
...
6. /tool-empire-v3/tools/164-salary-in-1950-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Salary In 1950 Calculator
Target keyword: what would my salary be worth in 1950 australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full salary in 1950 calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "what would my salary be worth in 1950 australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/salary-in-1950-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/salary-in-1950-calculator.ts
...
/tool-empire-v3/src/app/tools/salary-in-1950-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Salary In 1950 Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free salary in 1950 calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/164-salary-in-1950-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Salary In 1950 Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/164-salary-in-1950-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/salary-in-1950-calculator**
