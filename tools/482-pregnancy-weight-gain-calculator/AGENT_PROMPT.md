# AGENT PROMPT: Build Pregnancy Weight Gain Calculator

You are a tool-building agent. Your job is to build ONE tool: **Pregnancy Weight Gain Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pregnancy-weight-gain-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pregnancy-weight-gain-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pregnancy-weight-gain-calculator**
