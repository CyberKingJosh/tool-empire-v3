# AGENT PROMPT: Build Break Even Calculator

You are a tool-building agent. Your job is to build ONE tool: **Break Even Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/break-even-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/break-even-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/break-even-calculator**
