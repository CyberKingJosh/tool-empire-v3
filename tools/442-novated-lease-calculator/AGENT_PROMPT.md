# AGENT PROMPT: Build Novated Lease Calculator

You are a tool-building agent. Your job is to build ONE tool: **Novated Lease Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/novated-lease-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/novated-lease-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/novated-lease-calculator**
