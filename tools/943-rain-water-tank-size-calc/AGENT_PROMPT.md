# AGENT PROMPT: Build Rain Water Tank Size Calc

You are a tool-building agent. Build ONE tool: **Rain Water Tank Size Calc**.
...
## Tool: Rain Water Tank Size Calc
- Slug: rain-water-tank-size-calc | Category: general | Type: A | Tier: Two | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/rain-water-tank-size-calc.ts — pure logic
2. Create src/app/tools/rain-water-tank-size-calc/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/rain-water-tank-size-calc**
