# AGENT PROMPT: Build Capacitor Calculator

You are a tool-building agent. Your job is to build ONE tool: **Capacitor Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/capacitor-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/capacitor-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/capacitor-calculator**
