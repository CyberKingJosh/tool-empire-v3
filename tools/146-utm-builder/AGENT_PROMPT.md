---
You are building Tool #146: UTM Builder
...
6. /tool-empire-v3/tools/146-utm-builder/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: UTM Builder
Target keyword: utm builder free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full utm builder with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Related tools:
- SERP Preview Tool at /tools/serp-preview-tool
...
Search "utm builder free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/utm-builder/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/utm-builder.ts
...
/tool-empire-v3/src/app/tools/utm-builder/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'UTM Builder Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free utm builder. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/146-utm-builder/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. UTM Builder is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/146-utm-builder/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/utm-builder**
