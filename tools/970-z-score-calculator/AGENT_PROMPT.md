# AGENT PROMPT: Build Z Score Calculator

You are a tool-building agent. Build ONE tool: **Z Score Calculator**.
...
- Slug: z-score-calculator | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/z-score-calculator.ts — pure logic
2. Create src/app/tools/z-score-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/z-score-calculator**
