# AGENT PROMPT: Build Love Calculator

You are a tool-building agent. Your job is to build ONE tool: **Love Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/love-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/love-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/love-calculator**
