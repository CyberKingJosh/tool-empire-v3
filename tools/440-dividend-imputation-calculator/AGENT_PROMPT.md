# AGENT PROMPT: Build Dividend Imputation Calculator

You are a tool-building agent. Your job is to build ONE tool: **Dividend Imputation Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dividend-imputation-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dividend-imputation-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dividend-imputation-calculator**
