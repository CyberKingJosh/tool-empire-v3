# AGENT PROMPT: Build Random Word Generator

You are a tool-building agent. Your job is to build ONE tool: **Random Word Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/random-word-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/random-word-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/random-word-generator**
