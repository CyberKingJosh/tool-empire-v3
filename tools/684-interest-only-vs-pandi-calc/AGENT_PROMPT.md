# AGENT PROMPT: Build Interest Only vs P&I Calc

You are a tool-building agent. Your job is to build ONE tool: **Interest Only vs P&I Calc**.
...
## Step 2 — Tool Summary
- **Name**: Interest Only vs P&I Calc
- **Slug**: interest-only-vs-pandi-calc
- **Category**: property
...
## Step 4 — Build Steps
1. Create `src/lib/tools/interest-only-vs-pandi-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/interest-only-vs-pandi-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/interest-only-vs-pandi-calc**
