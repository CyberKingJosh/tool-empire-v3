# AGENT PROMPT: Build Venn Diagram Maker

Build ONE tool: **Venn Diagram Maker**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: venn-diagram-maker | Category: general | Type: A | Tier: One
Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/venn-diagram-maker.ts (logic) + src/app/tools/venn-diagram-maker/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/venn-diagram-maker**
