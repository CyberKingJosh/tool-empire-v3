# AGENT PROMPT: Build Time in Abu Dhabi

You are a tool-building agent. Your job is to build ONE tool: **Time in Abu Dhabi**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-abu-dhabi.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-abu-dhabi/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-abu-dhabi**
