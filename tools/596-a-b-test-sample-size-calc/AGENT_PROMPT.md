# AGENT PROMPT: Build A/B Test Sample Size Calc

You are a tool-building agent. Your job is to build ONE tool: **A/B Test Sample Size Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/a-b-test-sample-size-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/a-b-test-sample-size-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/a-b-test-sample-size-calc**
