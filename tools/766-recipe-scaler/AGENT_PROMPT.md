# AGENT PROMPT: Build Recipe Scaler

You are a tool-building agent. Your job is to build ONE tool: **Recipe Scaler**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/recipe-scaler.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/recipe-scaler/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/recipe-scaler**
