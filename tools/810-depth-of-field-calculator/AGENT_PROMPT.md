# AGENT PROMPT: Build Depth of Field Calculator

You are a tool-building agent. Your job is to build ONE tool: **Depth of Field Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/depth-of-field-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/depth-of-field-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/depth-of-field-calculator**
