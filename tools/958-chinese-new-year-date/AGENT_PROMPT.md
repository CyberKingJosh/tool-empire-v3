# AGENT PROMPT: Build Chinese New Year Date

You are a tool-building agent. Build ONE tool: **Chinese New Year Date**.
...
## Tool: Chinese New Year Date
- Slug: chinese-new-year-date | Category: date | Type: A | Tier: One | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/chinese-new-year-date.ts — pure logic
2. Create src/app/tools/chinese-new-year-date/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/chinese-new-year-date**
