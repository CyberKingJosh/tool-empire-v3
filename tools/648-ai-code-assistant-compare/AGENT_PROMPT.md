# AGENT PROMPT: Build AI Code Assistant Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Code Assistant Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-code-assistant-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-code-assistant-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-code-assistant-compare**
