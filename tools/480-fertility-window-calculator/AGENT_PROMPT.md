# AGENT PROMPT: Build Fertility Window Calculator

You are a tool-building agent. Your job is to build ONE tool: **Fertility Window Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fertility-window-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fertility-window-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fertility-window-calculator**
