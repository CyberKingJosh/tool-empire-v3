# AGENT PROMPT: Build Business Valuation Calculator

You are a tool-building agent. Your job is to build ONE tool: **Business Valuation Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/business-valuation-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/business-valuation-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/business-valuation-calculator**
