# AGENT PROMPT: Build Study Abroad Cost AU

You are a tool-building agent. Your job is to build ONE tool: **Study Abroad Cost AU**.
...
## Step 2 — Tool Summary
- **Name**: Study Abroad Cost AU
- **Slug**: study-abroad-cost-au
- **Category**: education
...
## Step 4 — Build Steps
1. Create `src/lib/tools/study-abroad-cost-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/study-abroad-cost-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/study-abroad-cost-au**
