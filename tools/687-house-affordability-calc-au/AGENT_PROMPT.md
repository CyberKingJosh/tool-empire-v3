# AGENT PROMPT: Build House Affordability Calc AU

You are a tool-building agent. Your job is to build ONE tool: **House Affordability Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/house-affordability-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/house-affordability-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/house-affordability-calc-au**
