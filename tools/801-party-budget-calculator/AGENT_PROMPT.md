# AGENT PROMPT: Build Party Budget Calculator

You are a tool-building agent. Your job is to build ONE tool: **Party Budget Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/party-budget-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/party-budget-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/party-budget-calculator**
