# AGENT PROMPT: Build Australian Visa Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Australian Visa Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/australian-visa-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/australian-visa-cost-calculator/page.tsx` — full page component
