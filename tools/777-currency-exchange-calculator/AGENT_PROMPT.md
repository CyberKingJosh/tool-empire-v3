# AGENT PROMPT: Build Currency Exchange Calculator

You are a tool-building agent. Your job is to build ONE tool: **Currency Exchange Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/currency-exchange-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/currency-exchange-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/currency-exchange-calculator**
