# AGENT PROMPT: Build Emoji Picker

You are a tool-building agent. Your job is to build ONE tool: **Emoji Picker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/emoji-picker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/emoji-picker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/emoji-picker**
