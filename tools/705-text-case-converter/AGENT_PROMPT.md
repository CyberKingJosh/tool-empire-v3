# AGENT PROMPT: Build Text Case Converter

You are a tool-building agent. Your job is to build ONE tool: **Text Case Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/text-case-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/text-case-converter/page.tsx` — full page component
