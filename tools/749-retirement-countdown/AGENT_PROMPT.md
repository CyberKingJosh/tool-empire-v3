# AGENT PROMPT: Build Retirement Countdown

You are a tool-building agent. Your job is to build ONE tool: **Retirement Countdown**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/retirement-countdown.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/retirement-countdown/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/retirement-countdown**
