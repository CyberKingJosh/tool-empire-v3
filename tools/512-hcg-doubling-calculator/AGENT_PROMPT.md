# AGENT PROMPT: Build HCG Doubling Calculator

You are a tool-building agent. Your job is to build ONE tool: **HCG Doubling Calculator**.
...
## Step 2 — Tool Summary
- **Name**: HCG Doubling Calculator
- **Slug**: hcg-doubling-calculator
- **Category**: health
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hcg-doubling-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hcg-doubling-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hcg-doubling-calculator**
