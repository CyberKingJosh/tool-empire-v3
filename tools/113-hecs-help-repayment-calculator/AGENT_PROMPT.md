---
You are building Tool #113: HECS HELP Repayment Calculator
...
6. /tool-empire-v3/tools/113-hecs-help-repayment-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: HECS HELP Repayment Calculator
Target keyword: hecs help repayment calculator australia 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full hecs help repayment calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "hecs help repayment calculator australia 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/hecs-help-repayment-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/hecs-help-repayment-calculator.ts
...
/tool-empire-v3/src/app/tools/hecs-help-repayment-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'HECS HELP Repayment Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free hecs help repayment calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/113-hecs-help-repayment-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. HECS HELP Repayment Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/113-hecs-help-repayment-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/hecs-help-repayment-calculator**
