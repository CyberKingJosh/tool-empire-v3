# AGENT PROMPT: Build Calorie Deficit Calculator

You are a tool-building agent. Your job is to build ONE tool: **Calorie Deficit Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/calorie-deficit-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/calorie-deficit-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/calorie-deficit-calculator**
