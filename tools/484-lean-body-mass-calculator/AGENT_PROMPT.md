# AGENT PROMPT: Build Lean Body Mass Calculator

You are a tool-building agent. Your job is to build ONE tool: **Lean Body Mass Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/lean-body-mass-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/lean-body-mass-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/lean-body-mass-calculator**
