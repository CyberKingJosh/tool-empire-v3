# AGENT PROMPT: Build Base64 Encoder Decoder

You are a tool-building agent. Your job is to build ONE tool: **Base64 Encoder Decoder**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/base64-encoder-decoder.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/base64-encoder-decoder/page.tsx` — full page component
