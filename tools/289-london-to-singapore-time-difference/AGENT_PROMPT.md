# AGENT PROMPT: Build London to Singapore Time Difference

You are a tool-building agent. Your job is to build ONE tool: **London to Singapore Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: London to Singapore Time Difference
- **Slug**: london-to-singapore-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/london-to-singapore-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/london-to-singapore-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/london-to-singapore-time-difference**
