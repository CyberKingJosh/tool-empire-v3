# AGENT PROMPT: Build Property Investment Calc AU

You are a tool-building agent. Your job is to build ONE tool: **Property Investment Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/property-investment-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/property-investment-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/property-investment-calc-au**
