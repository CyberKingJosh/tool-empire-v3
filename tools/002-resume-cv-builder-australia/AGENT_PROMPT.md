---
You are building Tool #002: Resume CV Builder Australia
...
6. /tool-empire-v3/tools/002-resume-cv-builder-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Resume CV Builder Australia
Target keyword: free resume builder australia
Monthly volume: 1,200,000
Difficulty: Hard
RPM: $12 AUD
Monetisation: Type D
Tier: Track A
Build time estimate: 90 min
Category: writing
API Cost: FREE
Beat difficulty: N/A
Free tier: Full resume cv builder australia preview on screen, 3 free exports per month
$1 AUD export: Yes — PDF of generated document
Pro tier: Unlimited exports, saved history, custom branding, team sharing
Competitors and their weaknesses:
- wordcounter.net: Functional but generic design
- grammarly.com: Requires signup
- hemingwayapp.com: Limited free features

Australian data needed: No
Related tools:
- Character Counter at /tools/character-counter
- Lorem Ipsum Generator at /tools/lorem-ipsum-generator
- Markdown Editor Online at /tools/markdown-editor-online
- Text Case Converter at /tools/text-case-converter

Affiliate: Grammarly Premium — AI-powered writing assistant — grammarly.com/premium

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: editorial magazine
2. Differentiation: Real-time analysis as you type — no submit button needed, results update live
3. Unforgettable detail: The word count animates like a speedometer needle swinging to the final number
4. Font pairing: Editorial Authority (DM Sans) or Bold Magazine (Bebas Neue + Nunito)
5. Colour palette: Primary #8B2FC9 | Accent #6225A0 | Surface #FBF8FF | Text #1A0A2E | Result #E8A838

COMPETITOR RESEARCH — Do this before any code:
Search "free resume builder australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/resume-cv-builder-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/resume-cv-builder-australia.ts
...
Type D: StripeExport + ProUpgrade. AUD pricing throughout.
...
/tool-empire-v3/src/app/tools/resume-cv-builder-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Resume CV Builder Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free resume cv builder australia. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/002-resume-cv-builder-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Resume CV Builder Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/002-resume-cv-builder-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/resume-cv-builder-australia**
