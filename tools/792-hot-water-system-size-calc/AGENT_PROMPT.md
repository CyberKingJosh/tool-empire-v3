# AGENT PROMPT: Build Hot Water System Size Calc

You are a tool-building agent. Your job is to build ONE tool: **Hot Water System Size Calc**.
...
## Step 2 — Tool Summary
- **Name**: Hot Water System Size Calc
- **Slug**: hot-water-system-size-calc
- **Category**: general
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hot-water-system-size-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hot-water-system-size-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hot-water-system-size-calc**
