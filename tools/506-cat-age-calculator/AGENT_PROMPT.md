# AGENT PROMPT: Build Cat Age Calculator

You are a tool-building agent. Your job is to build ONE tool: **Cat Age Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cat-age-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cat-age-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cat-age-calculator**
