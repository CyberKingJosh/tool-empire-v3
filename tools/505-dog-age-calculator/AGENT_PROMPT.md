# AGENT PROMPT: Build Dog Age Calculator

You are a tool-building agent. Your job is to build ONE tool: **Dog Age Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dog-age-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dog-age-calculator/page.tsx` — full page component
