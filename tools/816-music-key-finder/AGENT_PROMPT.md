# AGENT PROMPT: Build Music Key Finder

You are a tool-building agent. Your job is to build ONE tool: **Music Key Finder**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/music-key-finder.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/music-key-finder/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/music-key-finder**
