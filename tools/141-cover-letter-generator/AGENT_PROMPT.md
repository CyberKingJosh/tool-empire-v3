---
You are building Tool #141: Cover Letter Generator
...
6. /tool-empire-v3/tools/141-cover-letter-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Cover Letter Generator
Target keyword: cover letter generator free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full cover letter generator preview on screen for free
...
Search "cover letter generator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/cover-letter-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/cover-letter-generator.ts
...
/tool-empire-v3/src/app/tools/cover-letter-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Cover Letter Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free cover letter generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/141-cover-letter-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Cover Letter Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/141-cover-letter-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/cover-letter-generator**
