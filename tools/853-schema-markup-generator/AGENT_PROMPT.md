# AGENT PROMPT: Build Schema Markup Generator

You are a tool-building agent. Your job is to build ONE tool: **Schema Markup Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/schema-markup-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/schema-markup-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/schema-markup-generator**
