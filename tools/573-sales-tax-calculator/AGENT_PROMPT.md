# AGENT PROMPT: Build Sales Tax Calculator

You are a tool-building agent. Your job is to build ONE tool: **Sales Tax Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sales-tax-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sales-tax-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sales-tax-calculator**
