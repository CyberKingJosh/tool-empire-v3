# AGENT PROMPT: Build Acronym Generator

You are a tool-building agent. Your job is to build ONE tool: **Acronym Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/acronym-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/acronym-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/acronym-generator**
