# AGENT PROMPT: Build Parental Leave Pay Calculator

You are a tool-building agent. Your job is to build ONE tool: **Parental Leave Pay Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/parental-leave-pay-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/parental-leave-pay-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/parental-leave-pay-calculator**
