# AGENT PROMPT: Build Letterhead Template

Build ONE tool: **Letterhead Template**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: letterhead-template | Category: general | Type: A | Tier: One
Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/letterhead-template.ts (logic) + src/app/tools/letterhead-template/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/letterhead-template**
