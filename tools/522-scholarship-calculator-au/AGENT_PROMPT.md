# AGENT PROMPT: Build Scholarship Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Scholarship Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Scholarship Calculator AU
- **Slug**: scholarship-calculator-au
- **Category**: education
...
## Step 4 — Build Steps
1. Create `src/lib/tools/scholarship-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/scholarship-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/scholarship-calculator-au**
