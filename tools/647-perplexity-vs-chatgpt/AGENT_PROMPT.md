# AGENT PROMPT: Build Perplexity vs ChatGPT

You are a tool-building agent. Your job is to build ONE tool: **Perplexity vs ChatGPT**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/perplexity-vs-chatgpt.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/perplexity-vs-chatgpt/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/perplexity-vs-chatgpt**
