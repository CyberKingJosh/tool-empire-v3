# AGENT PROMPT: Build AI Voice Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Voice Cost Calculator**.
...
## Step 2 — Tool Summary
- **Name**: AI Voice Cost Calculator
- **Slug**: ai-voice-cost-calculator
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-voice-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-voice-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-voice-cost-calculator**
