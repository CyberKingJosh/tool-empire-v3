# AGENT PROMPT: Build Roman Numeral Converter

You are a tool-building agent. Your job is to build ONE tool: **Roman Numeral Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/roman-numeral-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/roman-numeral-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/roman-numeral-converter**
