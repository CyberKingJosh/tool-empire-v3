# AGENT PROMPT: Build Bitrate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Bitrate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bitrate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bitrate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bitrate-calculator**
