---
You are building Tool #139: Terms And Conditions Generator
...
6. /tool-empire-v3/tools/139-terms-and-conditions-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Terms And Conditions Generator
Target keyword: terms and conditions generator free
Monthly volume: 300,000
Difficulty: Medium
RPM: $20 AUD
Monetisation: Type B
Tier: 1
Build time estimate: 40 min
Category: legal
API Cost: FREE
Beat difficulty: N/A
Free tier: Full terms and conditions generator preview on screen for free
$1 AUD export: Yes — PDF of generated document
Pro tier: N/A
Competitors and their weaknesses:
- lawpath.com.au: Requires signup and payment
- legalvision.com.au: Lead generation, not free tool
- docusign.com: Enterprise pricing, not for individuals

Australian data needed: Yes — Australian consumer law references, ABN requirements
Related tools:
- Privacy Policy Generator at /tools/privacy-policy-generator
- NDA Generator at /tools/nda-generator
- Carbon Footprint Commute AU at /tools/carbon-footprint-commute-au
- EV vs Petrol Australia at /tools/ev-vs-petrol-australia

Affiliate: LawPath — Australian legal documents and advice — lawpath.com.au

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: refined luxury
2. Differentiation: Free preview on screen, professional PDF for $1 — no signup wall like every competitor
3. Unforgettable detail: The generated document appears with a subtle typewriter animation, letter by letter for the first line
4. Font pairing: Editorial Authority (DM Sans 700-800 + DM Mono)
5. Colour palette: Primary #1C1C3A | Accent #6B4FA0 | Surface #F8F7FF | Text #0D0D24 | Result #4A90D9

COMPETITOR RESEARCH — Do this before any code:
Search "terms and conditions generator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/terms-and-conditions-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/terms-and-conditions-generator.ts
...
/tool-empire-v3/src/app/tools/terms-and-conditions-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Terms And Conditions Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free terms and conditions generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/139-terms-and-conditions-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Terms And Conditions Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/139-terms-and-conditions-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/terms-and-conditions-generator**
