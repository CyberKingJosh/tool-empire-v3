---
You are building Tool #076: Temperature Converter
...
6. /tool-empire-v3/tools/076-temperature-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Temperature Converter
Target keyword: temperature converter
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full temperature converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
- Fahrenheit To Celsius at /tools/fahrenheit-to-celsius
...
Search "temperature converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/temperature-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/temperature-converter.ts
...
/tool-empire-v3/src/app/tools/temperature-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Temperature Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free temperature converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/076-temperature-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Temperature Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/076-temperature-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/temperature-converter**
