# AGENT PROMPT: Build Markup Calculator

You are a tool-building agent. Your job is to build ONE tool: **Markup Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/markup-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/markup-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/markup-calculator**
