# AGENT PROMPT: Build Travel Budget Calculator

You are a tool-building agent. Your job is to build ONE tool: **Travel Budget Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/travel-budget-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/travel-budget-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/travel-budget-calculator**
