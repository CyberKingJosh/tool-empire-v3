# AGENT PROMPT: Build Compound Interest Calculator

You are a tool-building agent. Your job is to build ONE tool: **Compound Interest Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/compound-interest-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/compound-interest-calculator/page.tsx` — full page component
