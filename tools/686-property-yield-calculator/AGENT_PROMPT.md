# AGENT PROMPT: Build Property Yield Calculator

You are a tool-building agent. Your job is to build ONE tool: **Property Yield Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/property-yield-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/property-yield-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/property-yield-calculator**
