---
You are building Tool #154: AI Chatbot Comparison 2026
...
6. /tool-empire-v3/tools/154-ai-chatbot-comparison-2026/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Chatbot Comparison 2026
Target keyword: best ai chatbot comparison 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ai chatbot comparison 2026 with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "best ai chatbot comparison 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-chatbot-comparison-2026/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-chatbot-comparison-2026.ts
...
/tool-empire-v3/src/app/tools/ai-chatbot-comparison-2026/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Chatbot Comparison 2026 Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai chatbot comparison 2026. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/154-ai-chatbot-comparison-2026/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Chatbot Comparison 2026 is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/154-ai-chatbot-comparison-2026/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-chatbot-comparison-2026**
