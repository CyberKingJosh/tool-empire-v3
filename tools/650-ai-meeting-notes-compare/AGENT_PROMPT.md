# AGENT PROMPT: Build AI Meeting Notes Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Meeting Notes Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-meeting-notes-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-meeting-notes-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-meeting-notes-compare**
