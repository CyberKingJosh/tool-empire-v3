# AGENT PROMPT: Build Miles to Nautical Miles

You are a tool-building agent. Build ONE tool: **Miles to Nautical Miles**.
...
## Tool: Miles to Nautical Miles
- Slug: miles-to-nautical-miles | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/miles-to-nautical-miles.ts — pure logic
2. Create src/app/tools/miles-to-nautical-miles/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/miles-to-nautical-miles**
