# AGENT PROMPT: Build World Clock

You are a tool-building agent. Your job is to build ONE tool: **World Clock**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/world-clock.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/world-clock/page.tsx` — full page component
