# AGENT PROMPT: Build Fish Tank Stocking Calc

You are a tool-building agent. Build ONE tool: **Fish Tank Stocking Calc**.
...
## Tool: Fish Tank Stocking Calc
- Slug: fish-tank-stocking-calc | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/fish-tank-stocking-calc.ts — pure logic
2. Create src/app/tools/fish-tank-stocking-calc/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/fish-tank-stocking-calc**
