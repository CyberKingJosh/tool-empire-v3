# AGENT PROMPT: Build Concrete Calculator

You are a tool-building agent. Your job is to build ONE tool: **Concrete Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/concrete-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/concrete-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/concrete-calculator**
