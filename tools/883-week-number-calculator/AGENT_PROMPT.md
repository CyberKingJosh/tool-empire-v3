# AGENT PROMPT: Build Week Number Calculator

You are a tool-building agent. Your job is to build ONE tool: **Week Number Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/week-number-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/week-number-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/week-number-calculator**
