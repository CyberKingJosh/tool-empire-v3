# AGENT PROMPT: Build ETH to USD Converter

You are a tool-building agent. Your job is to build ONE tool: **ETH to USD Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/eth-to-usd-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/eth-to-usd-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/eth-to-usd-converter**
