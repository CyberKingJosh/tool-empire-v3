# AGENT PROMPT: Build CIDR Calculator

You are a tool-building agent. Your job is to build ONE tool: **CIDR Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cidr-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cidr-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cidr-calculator**
