# AGENT PROMPT: Build Rental Yield Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **Rental Yield Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/rental-yield-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/rental-yield-calculator-australia/page.tsx` — full page component
