# AGENT PROMPT: Build Strata Fee Calculator

You are a tool-building agent. Your job is to build ONE tool: **Strata Fee Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/strata-fee-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/strata-fee-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/strata-fee-calculator**
