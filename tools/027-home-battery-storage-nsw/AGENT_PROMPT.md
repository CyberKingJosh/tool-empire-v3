---
You are building Tool #027: Home Battery Storage NSW
...
6. /tool-empire-v3/tools/027-home-battery-storage-nsw/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Home Battery Storage NSW
Target keyword: home battery storage payback calculator nsw
Monthly volume: 11,000
Difficulty: Medium
RPM: $18 AUD
Monetisation: Type A
Tier: Emerging
...
API Cost: FREE
Beat difficulty: 3
Free tier: Full home battery storage nsw with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "home battery storage payback calculator nsw". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/home-battery-storage-nsw/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/home-battery-storage-nsw.ts
...
/tool-empire-v3/src/app/tools/home-battery-storage-nsw/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Home Battery Storage NSW Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free home battery storage nsw. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/027-home-battery-storage-nsw/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Home Battery Storage NSW is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/027-home-battery-storage-nsw/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/home-battery-storage-nsw**
