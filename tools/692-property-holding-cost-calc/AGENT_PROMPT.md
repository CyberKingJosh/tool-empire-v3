# AGENT PROMPT: Build Property Holding Cost Calc

You are a tool-building agent. Your job is to build ONE tool: **Property Holding Cost Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/property-holding-cost-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/property-holding-cost-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/property-holding-cost-calc**
