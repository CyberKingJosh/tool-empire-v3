# AGENT PROMPT: Build AI Model Context Window Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Model Context Window Compare**.
...
## Step 3 — Design Brief
- Palette: Purple AI (#1A0A2E background, #A855F7 accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-model-context-window-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-model-context-window-compare/page.tsx` — full page component
