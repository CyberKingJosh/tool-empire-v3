# AGENT PROMPT: Build Pay Stub Generator

Build ONE tool: **Pay Stub Generator**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: pay-stub-generator | Category: finance | Type: A | Tier: One
Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/pay-stub-generator.ts (logic) + src/app/tools/pay-stub-generator/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/pay-stub-generator**
