# AGENT PROMPT: Build Stone to Pounds

You are a tool-building agent. Build ONE tool: **Stone to Pounds**.
...
## Tool: Stone to Pounds
- Slug: stone-to-pounds | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/stone-to-pounds.ts — pure logic
2. Create src/app/tools/stone-to-pounds/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/stone-to-pounds**
