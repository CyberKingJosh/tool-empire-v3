# AGENT PROMPT: Build Time in Buenos Aires

You are a tool-building agent. Your job is to build ONE tool: **Time in Buenos Aires**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-buenos-aires.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-buenos-aires/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-buenos-aires**
