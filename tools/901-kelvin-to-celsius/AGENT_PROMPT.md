# AGENT PROMPT: Build Kelvin to Celsius

You are a tool-building agent. Build ONE tool: **Kelvin to Celsius**.
...
## Tool: Kelvin to Celsius
- Slug: kelvin-to-celsius | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/kelvin-to-celsius.ts — pure logic
2. Create src/app/tools/kelvin-to-celsius/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/kelvin-to-celsius**
