# AGENT PROMPT: Build Pet Insurance Cost AU

You are a tool-building agent. Your job is to build ONE tool: **Pet Insurance Cost AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pet-insurance-cost-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pet-insurance-cost-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pet-insurance-cost-au**
