---
You are building Tool #078: Length Converter
...
6. /tool-empire-v3/tools/078-length-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Length Converter
Target keyword: length converter
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full length converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "length converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/length-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/length-converter.ts
...
/tool-empire-v3/src/app/tools/length-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Length Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free length converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/078-length-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Length Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/078-length-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/length-converter**
