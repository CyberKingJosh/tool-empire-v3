# AGENT PROMPT: Build Paris to New York Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Paris to New York Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Paris to New York Time Difference
- **Slug**: paris-to-new-york-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/paris-to-new-york-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/paris-to-new-york-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/paris-to-new-york-time-difference**
