---
You are building Tool #008: LLM Model Price Comparison
...
6. /tool-empire-v3/tools/008-llm-model-price-comparison/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: LLM Model Price Comparison
Target keyword: llm model comparison cost calculator 2026
...
API Cost: FREE
Beat difficulty: 2
Free tier: Full llm model price comparison with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
- AI Agent Productivity Gain at /tools/ai-agent-productivity-gain
...
Search "llm model comparison cost calculator 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/llm-model-price-comparison/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/llm-model-price-comparison.ts
...
/tool-empire-v3/src/app/tools/llm-model-price-comparison/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'LLM Model Price Comparison Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free llm model price comparison. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/008-llm-model-price-comparison/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. LLM Model Price Comparison is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/008-llm-model-price-comparison/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/llm-model-price-comparison**
