# AGENT PROMPT: Build Rental Income Calculator

You are a tool-building agent. Your job is to build ONE tool: **Rental Income Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/rental-income-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/rental-income-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/rental-income-calculator**
