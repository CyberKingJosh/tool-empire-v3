---
You are building Tool #071: Unit Converter
...
6. /tool-empire-v3/tools/071-unit-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Unit Converter
Target keyword: unit converter
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full unit converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "unit converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/unit-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/unit-converter.ts
...
/tool-empire-v3/src/app/tools/unit-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Unit Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free unit converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/071-unit-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Unit Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/071-unit-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/unit-converter**
