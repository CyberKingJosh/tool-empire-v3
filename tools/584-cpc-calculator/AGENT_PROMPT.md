# AGENT PROMPT: Build CPC Calculator

You are a tool-building agent. Your job is to build ONE tool: **CPC Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cpc-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cpc-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cpc-calculator**
