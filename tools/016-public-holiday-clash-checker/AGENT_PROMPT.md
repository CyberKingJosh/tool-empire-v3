---
You are building Tool #016: Public Holiday Clash Checker
...
6. /tool-empire-v3/tools/016-public-holiday-clash-checker/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Public Holiday Clash Checker
Target keyword: public holiday clash checker remote teams
...
API Cost: YELLOW
Beat difficulty: 1
Free tier: Full public holiday clash checker with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Step 2: Create /tool-empire-v3/src/lib/tools/public-holiday-clash-checker.ts
...
/tool-empire-v3/src/app/tools/public-holiday-clash-checker/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Public Holiday Clash Checker Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free public holiday clash checker. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/016-public-holiday-clash-checker/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Public Holiday Clash Checker is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/016-public-holiday-clash-checker/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/public-holiday-clash-checker**
