# AGENT PROMPT: Build Grid Generator CSS

You are a tool-building agent. Your job is to build ONE tool: **Grid Generator CSS**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/grid-generator-css.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/grid-generator-css/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/grid-generator-css**
