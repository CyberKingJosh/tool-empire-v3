# AGENT PROMPT: Build Claude Pro vs Free Compare

You are a tool-building agent. Your job is to build ONE tool: **Claude Pro vs Free Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/claude-pro-vs-free-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/claude-pro-vs-free-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/claude-pro-vs-free-compare**
