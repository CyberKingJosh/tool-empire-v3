# AGENT PROMPT: Build Conception Date Calculator

You are a tool-building agent. Your job is to build ONE tool: **Conception Date Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/conception-date-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/conception-date-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/conception-date-calculator**
