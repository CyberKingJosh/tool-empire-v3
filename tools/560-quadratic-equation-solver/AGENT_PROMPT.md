# AGENT PROMPT: Build Quadratic Equation Solver

You are a tool-building agent. Your job is to build ONE tool: **Quadratic Equation Solver**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/quadratic-equation-solver.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/quadratic-equation-solver/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/quadratic-equation-solver**
