---
You are building Tool #060: Age Calculator
...
6. /tool-empire-v3/tools/060-age-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Age Calculator
Target keyword: age calculator online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full age calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "age calculator online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/age-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/age-calculator.ts
...
/tool-empire-v3/src/app/tools/age-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Age Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free age calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/060-age-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Age Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/060-age-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/age-calculator**
