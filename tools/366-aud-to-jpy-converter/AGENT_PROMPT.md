# AGENT PROMPT: Build AUD to JPY Converter

You are a tool-building agent. Your job is to build ONE tool: **AUD to JPY Converter**.
...
## Step 2 — Tool Summary
- **Name**: AUD to JPY Converter
- **Slug**: aud-to-jpy-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aud-to-jpy-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aud-to-jpy-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/aud-to-jpy-converter**
