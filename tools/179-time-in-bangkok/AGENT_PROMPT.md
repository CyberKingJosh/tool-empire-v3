# AGENT PROMPT: Build Time in Bangkok

You are a tool-building agent. Your job is to build ONE tool: **Time in Bangkok**.
...
## Step 2 — Tool Summary
- **Name**: Time in Bangkok
- **Slug**: time-in-bangkok
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-bangkok.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-bangkok/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-bangkok**
