# AGENT PROMPT: Build Instagram Engagement Calc

You are a tool-building agent. Your job is to build ONE tool: **Instagram Engagement Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/instagram-engagement-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/instagram-engagement-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/instagram-engagement-calc**
