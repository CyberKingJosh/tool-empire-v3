---
You are building Tool #144: Citation Generator
...
6. /tool-empire-v3/tools/144-citation-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Citation Generator
Target keyword: citation generator free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full citation generator preview on screen for free
$1 AUD export: Yes — PDF of generated document
Pro tier: N/A
Competitors and their weaknesses:
- citation.com: Outdated, ad-heavy
- mybib.com: Requires account for some features
- easybib.com: Limited free citations

Australian data needed: Yes — Australian GPA scale (HD/D/C/P/F), ATAR if relevant
Related tools:
- GPA Calculator at /tools/gpa-calculator
...
Affiliate: Coursera Plus — Unlimited access to 7,000+ courses — coursera.org/courseraplus

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: playful toy-like
2. Differentiation: Supports both Australian (HD/D/C/P/F) and US (4.0) GPA scales — no competitor does both
3. Unforgettable detail: The GPA result appears on a mini report card that flips open with a 3D CSS animation
4. Font pairing: Playful Energy (Syne 700-800 + Outfit)
5. Colour palette: Primary #F4511E | Accent #BF360C | Surface #FFF8F5 | Text #1A0900 | Result #0288D1

COMPETITOR RESEARCH — Do this before any code:
Search "citation generator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/citation-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/citation-generator.ts
...
/tool-empire-v3/src/app/tools/citation-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Citation Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free citation generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/144-citation-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Citation Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/144-citation-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/citation-generator**
