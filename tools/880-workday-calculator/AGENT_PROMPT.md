# AGENT PROMPT: Build Workday Calculator

You are a tool-building agent. Your job is to build ONE tool: **Workday Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/workday-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/workday-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/workday-calculator**
