# AGENT PROMPT: Build Electricity Cost Calc AU

You are a tool-building agent. Your job is to build ONE tool: **Electricity Cost Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/electricity-cost-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/electricity-cost-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/electricity-cost-calc-au**
