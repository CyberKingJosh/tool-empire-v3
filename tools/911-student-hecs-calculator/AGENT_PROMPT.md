# AGENT PROMPT: Build Student HECS Calculator

You are a tool-building agent. Build ONE tool: **Student HECS Calculator**.
...
## Tool: Student HECS Calculator
- Slug: student-hecs-calculator | Category: finance | Type: A | Tier: One | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/student-hecs-calculator.ts — pure logic
2. Create src/app/tools/student-hecs-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/student-hecs-calculator**
