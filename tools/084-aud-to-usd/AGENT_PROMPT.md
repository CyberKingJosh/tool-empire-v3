---
You are building Tool #084: AUD To USD
...
6. /tool-empire-v3/tools/084-aud-to-usd/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AUD To USD
Target keyword: aud to usd
...
API Cost: YELLOW
Beat difficulty: N/A
Free tier: Full aud to usd with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "aud to usd". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/aud-to-usd/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/aud-to-usd.ts
...
/tool-empire-v3/src/app/tools/aud-to-usd/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AUD To USD Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free aud to usd. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/084-aud-to-usd/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AUD To USD is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/084-aud-to-usd/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/aud-to-usd**
