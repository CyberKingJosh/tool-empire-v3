# AGENT PROMPT: Build Land Tax Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **Land Tax Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/land-tax-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/land-tax-calculator-australia/page.tsx` — full page component
