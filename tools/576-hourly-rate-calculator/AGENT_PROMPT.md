# AGENT PROMPT: Build Hourly Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Hourly Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hourly-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hourly-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hourly-rate-calculator**
