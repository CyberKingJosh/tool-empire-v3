# AGENT PROMPT: Build Time in Kuwait City

You are a tool-building agent. Your job is to build ONE tool: **Time in Kuwait City**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-kuwait-city.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-kuwait-city/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-kuwait-city**
