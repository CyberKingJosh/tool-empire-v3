# AGENT PROMPT: Build New York to Chicago Time Difference

You are a tool-building agent. Your job is to build ONE tool: **New York to Chicago Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: New York to Chicago Time Difference
- **Slug**: new-york-to-chicago-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/new-york-to-chicago-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/new-york-to-chicago-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/new-york-to-chicago-time-difference**
