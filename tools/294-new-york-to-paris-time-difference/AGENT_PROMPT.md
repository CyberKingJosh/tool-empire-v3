# AGENT PROMPT: Build New York to Paris Time Difference

You are a tool-building agent. Your job is to build ONE tool: **New York to Paris Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: New York to Paris Time Difference
- **Slug**: new-york-to-paris-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/new-york-to-paris-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/new-york-to-paris-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/new-york-to-paris-time-difference**
