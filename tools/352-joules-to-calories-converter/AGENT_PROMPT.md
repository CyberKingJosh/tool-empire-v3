# AGENT PROMPT: Build JOULES to CALORIES Converter

You are a tool-building agent. Your job is to build ONE tool: **JOULES to CALORIES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/joules-to-calories-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/joules-to-calories-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/joules-to-calories-converter**
