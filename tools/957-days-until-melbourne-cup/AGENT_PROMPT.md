# AGENT PROMPT: Build Days Until Melbourne Cup

You are a tool-building agent. Build ONE tool: **Days Until Melbourne Cup**.
...
## Tool: Days Until Melbourne Cup
- Slug: days-until-melbourne-cup | Category: date | Type: A | Tier: Two | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-melbourne-cup.ts — pure logic
2. Create src/app/tools/days-until-melbourne-cup/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-melbourne-cup**
