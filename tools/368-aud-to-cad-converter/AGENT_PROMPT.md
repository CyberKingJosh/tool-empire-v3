# AGENT PROMPT: Build AUD to CAD Converter

You are a tool-building agent. Your job is to build ONE tool: **AUD to CAD Converter**.
...
## Step 2 — Tool Summary
- **Name**: AUD to CAD Converter
- **Slug**: aud-to-cad-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aud-to-cad-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aud-to-cad-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/aud-to-cad-converter**
