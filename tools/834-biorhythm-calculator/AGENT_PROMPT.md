# AGENT PROMPT: Build Biorhythm Calculator

You are a tool-building agent. Your job is to build ONE tool: **Biorhythm Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/biorhythm-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/biorhythm-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/biorhythm-calculator**
