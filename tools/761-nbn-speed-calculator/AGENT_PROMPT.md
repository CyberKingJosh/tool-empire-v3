# AGENT PROMPT: Build NBN Speed Calculator

You are a tool-building agent. Your job is to build ONE tool: **NBN Speed Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/nbn-speed-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/nbn-speed-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/nbn-speed-calculator**
