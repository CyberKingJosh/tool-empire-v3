# AGENT PROMPT: Build Number Line Generator

Build ONE tool: **Number Line Generator**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: number-line-generator | Category: education | Type: A | Tier: One
Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/number-line-generator.ts (logic) + src/app/tools/number-line-generator/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/number-line-generator**
