# AGENT PROMPT: Build Whisper API Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Whisper API Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/whisper-api-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/whisper-api-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/whisper-api-cost-calculator**
