# AGENT PROMPT: Build Days Until Fathers Day AU

You are a tool-building agent. Build ONE tool: **Days Until Fathers Day AU**.
...
## Tool: Days Until Fathers Day AU
- Slug: days-until-fathers-day-au | Category: date | Type: A | Tier: Two | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-fathers-day-au.ts — pure logic
2. Create src/app/tools/days-until-fathers-day-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-fathers-day-au**
