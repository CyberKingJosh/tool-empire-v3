# AGENT PROMPT: Build Retaining Wall Calculator

You are a tool-building agent. Your job is to build ONE tool: **Retaining Wall Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/retaining-wall-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/retaining-wall-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/retaining-wall-calculator**
