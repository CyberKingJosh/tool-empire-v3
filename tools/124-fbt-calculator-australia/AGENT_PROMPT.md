---
You are building Tool #124: FBT Calculator Australia
...
6. /tool-empire-v3/tools/124-fbt-calculator-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: FBT Calculator Australia
Target keyword: fringe benefits tax calculator australia
Monthly volume: 70,000
Difficulty: Medium
RPM: $22 AUD
Monetisation: Type A
Tier: 1
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full fbt calculator australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "fringe benefits tax calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/fbt-calculator-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/fbt-calculator-australia.ts
...
/tool-empire-v3/src/app/tools/fbt-calculator-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'FBT Calculator Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free fbt calculator australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/124-fbt-calculator-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. FBT Calculator Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/124-fbt-calculator-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/fbt-calculator-australia**
