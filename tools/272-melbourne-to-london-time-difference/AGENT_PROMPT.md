# AGENT PROMPT: Build Melbourne to London Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Melbourne to London Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/melbourne-to-london-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/melbourne-to-london-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/melbourne-to-london-time-difference**
