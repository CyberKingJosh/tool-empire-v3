# AGENT PROMPT: Build Standard Deviation Calc

You are a tool-building agent. Your job is to build ONE tool: **Standard Deviation Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/standard-deviation-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/standard-deviation-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/standard-deviation-calc**
