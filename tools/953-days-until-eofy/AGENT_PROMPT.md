# AGENT PROMPT: Build Days Until EOFY

You are a tool-building agent. Build ONE tool: **Days Until EOFY**.
...
## Tool: Days Until EOFY
- Slug: days-until-eofy | Category: date | Type: A | Tier: Two | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-eofy.ts — pure logic
2. Create src/app/tools/days-until-eofy/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-eofy**
