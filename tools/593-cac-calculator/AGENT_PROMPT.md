# AGENT PROMPT: Build CAC Calculator

You are a tool-building agent. Your job is to build ONE tool: **CAC Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cac-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cac-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cac-calculator**
