# AGENT PROMPT: Build Tablespoon to Grams

You are a tool-building agent. Build ONE tool: **Tablespoon to Grams**.
...
## Tool: Tablespoon to Grams
- Slug: tablespoon-to-grams | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/tablespoon-to-grams.ts — pure logic
2. Create src/app/tools/tablespoon-to-grams/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/tablespoon-to-grams**
