# AGENT PROMPT: Build Data Transfer Calculator

You are a tool-building agent. Your job is to build ONE tool: **Data Transfer Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/data-transfer-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/data-transfer-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/data-transfer-calculator**
