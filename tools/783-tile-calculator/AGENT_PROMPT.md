# AGENT PROMPT: Build Tile Calculator

You are a tool-building agent. Your job is to build ONE tool: **Tile Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tile-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tile-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tile-calculator**
