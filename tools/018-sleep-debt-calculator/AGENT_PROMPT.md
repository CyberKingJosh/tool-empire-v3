---
You are building Tool #018: Sleep Debt Calculator
...
6. /tool-empire-v3/tools/018-sleep-debt-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Sleep Debt Calculator
Target keyword: sleep debt calculator free
...
API Cost: FREE
Beat difficulty: 2
Free tier: Full sleep debt calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "sleep debt calculator free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/sleep-debt-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/sleep-debt-calculator.ts
...
/tool-empire-v3/src/app/tools/sleep-debt-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Sleep Debt Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free sleep debt calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/018-sleep-debt-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Sleep Debt Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/018-sleep-debt-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/sleep-debt-calculator**
