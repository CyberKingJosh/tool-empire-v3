# AGENT PROMPT: Build Jet Lag Calculator

You are a tool-building agent. Your job is to build ONE tool: **Jet Lag Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/jet-lag-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/jet-lag-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/jet-lag-calculator**
