# AGENT PROMPT: Build YARDS to METERS Converter

You are a tool-building agent. Your job is to build ONE tool: **YARDS to METERS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/yards-to-meters-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/yards-to-meters-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/yards-to-meters-converter**
