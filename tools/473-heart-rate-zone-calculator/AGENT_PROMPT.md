# AGENT PROMPT: Build Heart Rate Zone Calculator

You are a tool-building agent. Your job is to build ONE tool: **Heart Rate Zone Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/heart-rate-zone-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/heart-rate-zone-calculator/page.tsx` — full page component
...
Then open: **http://localhost:3000/tools/heart-rate-zone-calculator**
