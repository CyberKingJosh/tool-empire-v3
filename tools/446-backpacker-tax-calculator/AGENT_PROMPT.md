# AGENT PROMPT: Build Backpacker Tax Calculator

You are a tool-building agent. Your job is to build ONE tool: **Backpacker Tax Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/backpacker-tax-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/backpacker-tax-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/backpacker-tax-calculator**
