# AGENT PROMPT: Build Creatine Calculator

You are a tool-building agent. Your job is to build ONE tool: **Creatine Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/creatine-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/creatine-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/creatine-calculator**
