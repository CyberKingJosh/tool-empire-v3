# AGENT PROMPT: Build PDF Splitter

You are a tool-building agent. Your job is to build ONE tool: **PDF Splitter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pdf-splitter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pdf-splitter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pdf-splitter**
