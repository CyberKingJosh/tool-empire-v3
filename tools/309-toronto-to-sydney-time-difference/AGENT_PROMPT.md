# AGENT PROMPT: Build Toronto to Sydney Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Toronto to Sydney Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Toronto to Sydney Time Difference
- **Slug**: toronto-to-sydney-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/toronto-to-sydney-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/toronto-to-sydney-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/toronto-to-sydney-time-difference**
