# AGENT PROMPT: Build Bibliography Generator

You are a tool-building agent. Your job is to build ONE tool: **Bibliography Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bibliography-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bibliography-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bibliography-generator**
