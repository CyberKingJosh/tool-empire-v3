---
You are building Tool #012: AI vs Freelancer Cost
...
6. /tool-empire-v3/tools/012-ai-vs-freelancer-cost/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI vs Freelancer Cost
Target keyword: ai vs freelancer cost comparison calculator
...
API Cost: FREE
Beat difficulty: 1
Free tier: Full ai vs freelancer cost with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai vs freelancer cost comparison calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-vs-freelancer-cost/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-vs-freelancer-cost.ts
...
/tool-empire-v3/src/app/tools/ai-vs-freelancer-cost/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI vs Freelancer Cost Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai vs freelancer cost. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/012-ai-vs-freelancer-cost/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI vs Freelancer Cost is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/012-ai-vs-freelancer-cost/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-vs-freelancer-cost**
