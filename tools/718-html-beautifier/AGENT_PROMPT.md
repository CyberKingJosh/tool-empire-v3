# AGENT PROMPT: Build HTML Beautifier

You are a tool-building agent. Your job is to build ONE tool: **HTML Beautifier**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/html-beautifier.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/html-beautifier/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/html-beautifier**
