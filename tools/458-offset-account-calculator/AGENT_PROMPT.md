# AGENT PROMPT: Build Offset Account Calculator

You are a tool-building agent. Your job is to build ONE tool: **Offset Account Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/offset-account-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/offset-account-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/offset-account-calculator**
