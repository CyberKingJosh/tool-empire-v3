# AGENT PROMPT: Build AI Writing Speed Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Writing Speed Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-writing-speed-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-writing-speed-calculator/page.tsx` — full page component
