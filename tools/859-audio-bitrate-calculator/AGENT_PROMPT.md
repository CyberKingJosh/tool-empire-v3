# AGENT PROMPT: Build Audio Bitrate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Audio Bitrate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/audio-bitrate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/audio-bitrate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/audio-bitrate-calculator**
