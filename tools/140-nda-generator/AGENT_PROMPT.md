---
You are building Tool #140: NDA Generator
...
6. /tool-empire-v3/tools/140-nda-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: NDA Generator
Target keyword: nda generator free australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full nda generator preview on screen for free
...
Search "nda generator free australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/nda-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/nda-generator.ts
...
/tool-empire-v3/src/app/tools/nda-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'NDA Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free nda generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/140-nda-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. NDA Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/140-nda-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/nda-generator**
