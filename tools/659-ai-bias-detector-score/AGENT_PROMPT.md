# AGENT PROMPT: Build AI Bias Detector Score

You are a tool-building agent. Your job is to build ONE tool: **AI Bias Detector Score**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-bias-detector-score.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-bias-detector-score/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-bias-detector-score**
