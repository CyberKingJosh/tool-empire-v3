# AGENT PROMPT: Build Sydney to New York Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Sydney to New York Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sydney-to-new-york-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sydney-to-new-york-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sydney-to-new-york-time-difference**
