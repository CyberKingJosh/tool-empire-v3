---
You are building Tool #089: Scientific Calculator
...
6. /tool-empire-v3/tools/089-scientific-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Scientific Calculator
Target keyword: scientific calculator online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full scientific calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- calculator.net: Functional but visually outdated
- mathway.com: Requires signup for step-by-step
- symbolab.com: Paywall for advanced features

Australian data needed: No
Related tools:
- Percentage Calculator at /tools/percentage-calculator
- Fraction Calculator at /tools/fraction-calculator
- Carbon Footprint Commute AU at /tools/carbon-footprint-commute-au
- EV vs Petrol Australia at /tools/ev-vs-petrol-australia

Affiliate: Wolfram Alpha Pro — Step-by-step mathematical solutions — wolframalpha.com/pro

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: clean clinical
2. Differentiation: Shows step-by-step working — not just the answer, the HOW
3. Unforgettable detail: The calculation steps appear one by one with a chalk-on-blackboard animation style
...
Search "scientific calculator online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/scientific-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/scientific-calculator.ts
...
/tool-empire-v3/src/app/tools/scientific-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Scientific Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free scientific calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/089-scientific-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Scientific Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/089-scientific-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/scientific-calculator**
