# AGENT PROMPT: Build Cash Flow Calculator

You are a tool-building agent. Your job is to build ONE tool: **Cash Flow Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cash-flow-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cash-flow-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cash-flow-calculator**
