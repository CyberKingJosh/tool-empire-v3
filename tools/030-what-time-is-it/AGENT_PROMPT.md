---
You are building Tool #030: What Time Is It
...
6. /tool-empire-v3/tools/030-what-time-is-it/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: What Time Is It
Target keyword: what time is it
Monthly volume: 200,000,000
Difficulty: Hard
RPM: $3 AUD
Monetisation: Type A
Tier: 0
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full what time is it with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "what time is it". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/what-time-is-it/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/what-time-is-it.ts
...
/tool-empire-v3/src/app/tools/what-time-is-it/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'What Time Is It Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free what time is it. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/030-what-time-is-it/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. What Time Is It is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/030-what-time-is-it/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/what-time-is-it**
