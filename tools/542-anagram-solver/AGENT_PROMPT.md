# AGENT PROMPT: Build Anagram Solver

You are a tool-building agent. Your job is to build ONE tool: **Anagram Solver**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/anagram-solver.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/anagram-solver/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/anagram-solver**
