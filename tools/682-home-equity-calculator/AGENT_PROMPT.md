# AGENT PROMPT: Build Home Equity Calculator

You are a tool-building agent. Your job is to build ONE tool: **Home Equity Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/home-equity-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/home-equity-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/home-equity-calculator**
