# AGENT PROMPT: Build Golf Handicap Calculator

You are a tool-building agent. Build ONE tool: **Golf Handicap Calculator**.
...
## Tool: Golf Handicap Calculator
- Slug: golf-handicap-calculator | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/golf-handicap-calculator.ts — pure logic
2. Create src/app/tools/golf-handicap-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/golf-handicap-calculator**
