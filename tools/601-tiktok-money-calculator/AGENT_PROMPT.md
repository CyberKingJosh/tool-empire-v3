# AGENT PROMPT: Build TikTok Money Calculator

You are a tool-building agent. Your job is to build ONE tool: **TikTok Money Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tiktok-money-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tiktok-money-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tiktok-money-calculator**
