# AGENT PROMPT: Build Fine-Tuning Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Fine-Tuning Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fine-tuning-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fine-tuning-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fine-tuning-cost-calculator**
