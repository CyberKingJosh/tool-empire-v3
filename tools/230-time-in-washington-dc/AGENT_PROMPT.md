# AGENT PROMPT: Build Time in Washington DC

You are a tool-building agent. Your job is to build ONE tool: **Time in Washington DC**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-washington-dc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-washington-dc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-washington-dc**
