# AGENT PROMPT: Build Tokyo to Singapore Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Tokyo to Singapore Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tokyo-to-singapore-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tokyo-to-singapore-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tokyo-to-singapore-time-difference**
