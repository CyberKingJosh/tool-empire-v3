# AGENT PROMPT: Build Color Palette Generator

You are a tool-building agent. Your job is to build ONE tool: **Color Palette Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/color-palette-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/color-palette-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/color-palette-generator**
