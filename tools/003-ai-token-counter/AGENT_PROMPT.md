---
You are building Tool #003: AI Token Counter
...
6. /tool-empire-v3/tools/003-ai-token-counter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Token Counter
Target keyword: token counter ai chatgpt claude
...
API Cost: FREE
Beat difficulty: 3
Free tier: Full ai token counter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "token counter ai chatgpt claude". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-token-counter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-token-counter.ts
...
/tool-empire-v3/src/app/tools/ai-token-counter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Token Counter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai token counter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/003-ai-token-counter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Token Counter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/003-ai-token-counter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-token-counter**
