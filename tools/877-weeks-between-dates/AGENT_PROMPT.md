# AGENT PROMPT: Build Weeks Between Dates

You are a tool-building agent. Your job is to build ONE tool: **Weeks Between Dates**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/weeks-between-dates.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/weeks-between-dates/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/weeks-between-dates**
