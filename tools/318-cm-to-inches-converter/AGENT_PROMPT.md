# AGENT PROMPT: Build CM to INCHES Converter

You are a tool-building agent. Your job is to build ONE tool: **CM to INCHES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cm-to-inches-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cm-to-inches-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cm-to-inches-converter**
