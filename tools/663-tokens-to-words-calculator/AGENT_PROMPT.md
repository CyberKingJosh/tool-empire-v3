# AGENT PROMPT: Build Tokens to Words Calculator

You are a tool-building agent. Your job is to build ONE tool: **Tokens to Words Calculator**.
...
## Step 2 — Tool Summary
- **Name**: Tokens to Words Calculator
- **Slug**: tokens-to-words-calculator
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tokens-to-words-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tokens-to-words-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/tokens-to-words-calculator**
