# AGENT PROMPT: Build CM to Feet

You are a tool-building agent. Build ONE tool: **CM to Feet**.
...
## Tool: CM to Feet
- Slug: cm-to-feet | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/cm-to-feet.ts — pure logic
2. Create src/app/tools/cm-to-feet/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/cm-to-feet**
