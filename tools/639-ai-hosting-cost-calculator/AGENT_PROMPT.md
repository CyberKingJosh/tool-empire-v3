# AGENT PROMPT: Build AI Hosting Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Hosting Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-hosting-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-hosting-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-hosting-cost-calculator**
