# AGENT PROMPT: Build VOLTS to WATTS Converter

You are a tool-building agent. Your job is to build ONE tool: **VOLTS to WATTS Converter**.
...
## Step 2 — Tool Summary
- **Name**: VOLTS to WATTS Converter
- **Slug**: volts-to-watts-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/volts-to-watts-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/volts-to-watts-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/volts-to-watts-converter**
