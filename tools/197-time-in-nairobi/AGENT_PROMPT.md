# AGENT PROMPT: Build Time in Nairobi

You are a tool-building agent. Your job is to build ONE tool: **Time in Nairobi**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-nairobi.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-nairobi/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-nairobi**
