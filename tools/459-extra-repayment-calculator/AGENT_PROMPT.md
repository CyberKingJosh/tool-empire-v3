# AGENT PROMPT: Build Extra Repayment Calculator

You are a tool-building agent. Your job is to build ONE tool: **Extra Repayment Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/extra-repayment-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/extra-repayment-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/extra-repayment-calculator**
