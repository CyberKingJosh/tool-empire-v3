# AGENT PROMPT: Build Absolute Value Calculator

Build ONE tool: **Absolute Value Calculator**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: absolute-value-calculator | Category: education | Type: A | Tier: One
Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/absolute-value-calculator.ts (logic) + src/app/tools/absolute-value-calculator/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/absolute-value-calculator**
