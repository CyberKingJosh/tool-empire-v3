# AGENT PROMPT: Build JPG to PNG Converter

You are a tool-building agent. Your job is to build ONE tool: **JPG to PNG Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/jpg-to-png-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/jpg-to-png-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/jpg-to-png-converter**
