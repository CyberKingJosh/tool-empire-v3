# AGENT PROMPT: Build Refinance Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Refinance Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/refinance-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/refinance-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/refinance-calculator-au**
