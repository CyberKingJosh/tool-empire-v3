# AGENT PROMPT: Build PSI to BAR Converter

You are a tool-building agent. Your job is to build ONE tool: **PSI to BAR Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/psi-to-bar-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/psi-to-bar-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/psi-to-bar-converter**
