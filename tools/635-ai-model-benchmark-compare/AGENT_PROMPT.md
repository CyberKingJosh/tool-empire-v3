# AGENT PROMPT: Build AI Model Benchmark Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Model Benchmark Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-model-benchmark-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-model-benchmark-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-model-benchmark-compare**
