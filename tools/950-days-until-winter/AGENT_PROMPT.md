# AGENT PROMPT: Build Days Until Winter

You are a tool-building agent. Build ONE tool: **Days Until Winter**.
...
## Tool: Days Until Winter
- Slug: days-until-winter | Category: date | Type: A | Tier: One | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/days-until-winter.ts — pure logic
2. Create src/app/tools/days-until-winter/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/days-until-winter**
