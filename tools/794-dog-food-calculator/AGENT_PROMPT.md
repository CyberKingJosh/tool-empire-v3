# AGENT PROMPT: Build Dog Food Calculator

You are a tool-building agent. Your job is to build ONE tool: **Dog Food Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dog-food-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dog-food-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dog-food-calculator**
