# AGENT PROMPT: Build Building vs Buying Calc AU

You are a tool-building agent. Your job is to build ONE tool: **Building vs Buying Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/building-vs-buying-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/building-vs-buying-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/building-vs-buying-calc-au**
