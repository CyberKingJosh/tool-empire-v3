# AGENT PROMPT: Build JSON to CSV Converter

You are a tool-building agent. Your job is to build ONE tool: **JSON to CSV Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/json-to-csv-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/json-to-csv-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/json-to-csv-converter**
