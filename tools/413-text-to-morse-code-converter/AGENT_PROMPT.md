# AGENT PROMPT: Build TEXT to MORSE-CODE Converter

You are a tool-building agent. Your job is to build ONE tool: **TEXT to MORSE-CODE Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/text-to-morse-code-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/text-to-morse-code-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/text-to-morse-code-converter**
