# AGENT PROMPT: Build Gig Economy Tax Calc AU

You are a tool-building agent. Build ONE tool: **Gig Economy Tax Calc AU**.
...
## Tool: Gig Economy Tax Calc AU
- Slug: gig-economy-tax-calc-au | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/gig-economy-tax-calc-au.ts — pure logic
2. Create src/app/tools/gig-economy-tax-calc-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/gig-economy-tax-calc-au**
