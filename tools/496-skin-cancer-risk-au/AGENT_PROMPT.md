# AGENT PROMPT: Build Skin Cancer Risk AU

You are a tool-building agent. Your job is to build ONE tool: **Skin Cancer Risk AU**.
...
## Step 2 — Tool Summary
- **Name**: Skin Cancer Risk AU
- **Slug**: skin-cancer-risk-au
- **Category**: health
...
## Step 4 — Build Steps
1. Create `src/lib/tools/skin-cancer-risk-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/skin-cancer-risk-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/skin-cancer-risk-au**
