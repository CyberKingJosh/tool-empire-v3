# AGENT PROMPT: Build Time in Cairo

You are a tool-building agent. Your job is to build ONE tool: **Time in Cairo**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-cairo.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-cairo/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-cairo**
