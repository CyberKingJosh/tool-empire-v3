# AGENT PROMPT: Build Internet Speed Test

You are a tool-building agent. Your job is to build ONE tool: **Internet Speed Test**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/internet-speed-test.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/internet-speed-test/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/internet-speed-test**
