# AGENT PROMPT: Build Scientific Calculator Adv

You are a tool-building agent. Build ONE tool: **Scientific Calculator Adv**.
...
## Tool: Scientific Calculator Adv
- Slug: scientific-calculator-adv | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/scientific-calculator-adv.ts — pure logic
2. Create src/app/tools/scientific-calculator-adv/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/scientific-calculator-adv**
