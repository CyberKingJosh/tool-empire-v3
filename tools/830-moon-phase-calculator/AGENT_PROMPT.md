# AGENT PROMPT: Build Moon Phase Calculator

You are a tool-building agent. Your job is to build ONE tool: **Moon Phase Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/moon-phase-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/moon-phase-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/moon-phase-calculator**
