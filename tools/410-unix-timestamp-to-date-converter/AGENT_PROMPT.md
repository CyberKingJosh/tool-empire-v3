# AGENT PROMPT: Build UNIX-TIMESTAMP to DATE Converter

You are a tool-building agent. Your job is to build ONE tool: **UNIX-TIMESTAMP to DATE Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/unix-timestamp-to-date-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/unix-timestamp-to-date-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/unix-timestamp-to-date-converter**
