# AGENT PROMPT: Build Timer Online

You are a tool-building agent. Your job is to build ONE tool: **Timer Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/timer-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/timer-online/page.tsx` — full page component
