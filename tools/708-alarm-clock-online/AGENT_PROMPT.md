# AGENT PROMPT: Build Alarm Clock Online

You are a tool-building agent. Your job is to build ONE tool: **Alarm Clock Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/alarm-clock-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/alarm-clock-online/page.tsx` — full page component
