# AGENT PROMPT: Build Property Depreciation Calc AU

You are a tool-building agent. Your job is to build ONE tool: **Property Depreciation Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/property-depreciation-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/property-depreciation-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/property-depreciation-calc-au**
