# AGENT PROMPT: Build Stroke Risk Calculator

You are a tool-building agent. Your job is to build ONE tool: **Stroke Risk Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/stroke-risk-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/stroke-risk-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/stroke-risk-calculator**
