# AGENT PROMPT: Build Line Graph Maker

Build ONE tool: **Line Graph Maker**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: line-graph-maker | Category: general | Type: A | Tier: One
Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/line-graph-maker.ts (logic) + src/app/tools/line-graph-maker/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/line-graph-maker**
