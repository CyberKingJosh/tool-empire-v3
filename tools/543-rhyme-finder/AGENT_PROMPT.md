# AGENT PROMPT: Build Rhyme Finder

You are a tool-building agent. Your job is to build ONE tool: **Rhyme Finder**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/rhyme-finder.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/rhyme-finder/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/rhyme-finder**
