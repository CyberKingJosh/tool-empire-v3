# AGENT PROMPT: Build Flexbox Generator

You are a tool-building agent. Your job is to build ONE tool: **Flexbox Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/flexbox-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/flexbox-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/flexbox-generator**
