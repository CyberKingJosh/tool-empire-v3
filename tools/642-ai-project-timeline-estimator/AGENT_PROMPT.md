# AGENT PROMPT: Build AI Project Timeline Estimator

You are a tool-building agent. Your job is to build ONE tool: **AI Project Timeline Estimator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-project-timeline-estimator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-project-timeline-estimator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-project-timeline-estimator**
