# AGENT PROMPT: Build Image Compressor

You are a tool-building agent. Your job is to build ONE tool: **Image Compressor**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/image-compressor.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/image-compressor/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/image-compressor**
