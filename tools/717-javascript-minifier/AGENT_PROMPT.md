# AGENT PROMPT: Build JavaScript Minifier

You are a tool-building agent. Your job is to build ONE tool: **JavaScript Minifier**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/javascript-minifier.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/javascript-minifier/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/javascript-minifier**
