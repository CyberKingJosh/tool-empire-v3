# AGENT PROMPT: Build Coffee Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Coffee Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/coffee-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/coffee-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/coffee-cost-calculator**
