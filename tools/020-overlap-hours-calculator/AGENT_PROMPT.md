---
You are building Tool #020: Overlap Hours Calculator
...
6. /tool-empire-v3/tools/020-overlap-hours-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Overlap Hours Calculator
Target keyword: overlap hours calculator global remote teams
...
API Cost: FREE
Beat difficulty: 4
Free tier: Full overlap hours calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "overlap hours calculator global remote teams". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/overlap-hours-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/overlap-hours-calculator.ts
...
/tool-empire-v3/src/app/tools/overlap-hours-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Overlap Hours Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free overlap hours calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/020-overlap-hours-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Overlap Hours Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/020-overlap-hours-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/overlap-hours-calculator**
