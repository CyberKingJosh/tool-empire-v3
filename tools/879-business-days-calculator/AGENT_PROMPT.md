# AGENT PROMPT: Build Business Days Calculator

You are a tool-building agent. Your job is to build ONE tool: **Business Days Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/business-days-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/business-days-calculator/page.tsx` — full page component
