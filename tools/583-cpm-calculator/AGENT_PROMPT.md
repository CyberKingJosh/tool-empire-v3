# AGENT PROMPT: Build CPM Calculator

You are a tool-building agent. Your job is to build ONE tool: **CPM Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cpm-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cpm-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cpm-calculator**
