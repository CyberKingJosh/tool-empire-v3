# AGENT PROMPT: Build NDIS Budget Calculator

You are a tool-building agent. Build ONE tool: **NDIS Budget Calculator**.
...
## Tool: NDIS Budget Calculator
- Slug: ndis-budget-calculator | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/ndis-budget-calculator.ts — pure logic
2. Create src/app/tools/ndis-budget-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/ndis-budget-calculator**
