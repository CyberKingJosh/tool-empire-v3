# AGENT PROMPT: Build Debt to Equity Calculator

You are a tool-building agent. Your job is to build ONE tool: **Debt to Equity Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/debt-to-equity-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/debt-to-equity-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/debt-to-equity-calculator**
