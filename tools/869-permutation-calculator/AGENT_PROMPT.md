# AGENT PROMPT: Build Permutation Calculator

You are a tool-building agent. Your job is to build ONE tool: **Permutation Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/permutation-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/permutation-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/permutation-calculator**
