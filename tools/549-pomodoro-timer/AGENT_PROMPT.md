# AGENT PROMPT: Build Pomodoro Timer

You are a tool-building agent. Your job is to build ONE tool: **Pomodoro Timer**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pomodoro-timer.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pomodoro-timer/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pomodoro-timer**
