# AGENT PROMPT: Build Freelance Quote Calculator

You are a tool-building agent. Your job is to build ONE tool: **Freelance Quote Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/freelance-quote-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/freelance-quote-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/freelance-quote-calculator**
