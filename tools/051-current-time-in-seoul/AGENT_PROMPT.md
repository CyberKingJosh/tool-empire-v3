---
You are building Tool #051: Current Time In Seoul
...
6. /tool-empire-v3/tools/051-current-time-in-seoul/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Current Time In Seoul
Target keyword: current time in seoul
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full current time in seoul with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "current time in seoul". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/current-time-in-seoul/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/current-time-in-seoul.ts
...
/tool-empire-v3/src/app/tools/current-time-in-seoul/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Current Time In Seoul Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free current time in seoul. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/051-current-time-in-seoul/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Current Time In Seoul is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/051-current-time-in-seoul/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/current-time-in-seoul**
