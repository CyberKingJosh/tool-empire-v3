# AGENT PROMPT: Build Billionaire Calculator

You are a tool-building agent. Your job is to build ONE tool: **Billionaire Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/billionaire-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/billionaire-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/billionaire-calculator**
