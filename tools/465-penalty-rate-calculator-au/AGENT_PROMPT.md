# AGENT PROMPT: Build Penalty Rate Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Penalty Rate Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/penalty-rate-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/penalty-rate-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/penalty-rate-calculator-au**
