# AGENT PROMPT: Build First Home Guarantee Calc

You are a tool-building agent. Your job is to build ONE tool: **First Home Guarantee Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/first-home-guarantee-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/first-home-guarantee-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/first-home-guarantee-calc**
