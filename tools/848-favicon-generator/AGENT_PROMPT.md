# AGENT PROMPT: Build Favicon Generator

You are a tool-building agent. Your job is to build ONE tool: **Favicon Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/favicon-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/favicon-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/favicon-generator**
