# AGENT PROMPT: Build Capital Gains Tax Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Capital Gains Tax Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/capital-gains-tax-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/capital-gains-tax-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/capital-gains-tax-calculator-au**
