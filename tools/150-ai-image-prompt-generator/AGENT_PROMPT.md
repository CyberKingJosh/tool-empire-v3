---
You are building Tool #150: AI Image Prompt Generator
...
6. /tool-empire-v3/tools/150-ai-image-prompt-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Image Prompt Generator
Target keyword: ai image prompt generator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ai image prompt generator preview on screen for free
...
Search "ai image prompt generator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-image-prompt-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-image-prompt-generator.ts
...
/tool-empire-v3/src/app/tools/ai-image-prompt-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Image Prompt Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai image prompt generator. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/150-ai-image-prompt-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Image Prompt Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/150-ai-image-prompt-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-image-prompt-generator**
