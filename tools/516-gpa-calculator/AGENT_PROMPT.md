# AGENT PROMPT: Build GPA Calculator

You are a tool-building agent. Your job is to build ONE tool: **GPA Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gpa-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gpa-calculator/page.tsx` — full page component
