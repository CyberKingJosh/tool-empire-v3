# AGENT PROMPT: Build Swimming Calorie Calculator

You are a tool-building agent. Your job is to build ONE tool: **Swimming Calorie Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/swimming-calorie-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/swimming-calorie-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/swimming-calorie-calculator**
