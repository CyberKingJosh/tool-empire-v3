# AGENT PROMPT: Build Paraphrase Tool

You are a tool-building agent. Your job is to build ONE tool: **Paraphrase Tool**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/paraphrase-tool.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/paraphrase-tool/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/paraphrase-tool**
