# AGENT PROMPT: Build PARSECS to LIGHT-YEARS Converter

You are a tool-building agent. Your job is to build ONE tool: **PARSECS to LIGHT-YEARS Converter**.
...
## Step 2 — Tool Summary
- **Name**: PARSECS to LIGHT-YEARS Converter
- **Slug**: parsecs-to-light-years-converter
- **Category**: converter
...
## Step 3 — Design Brief
- Palette: Steel Convert (#1A1A2E background, #06D6A0 accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/parsecs-to-light-years-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/parsecs-to-light-years-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/parsecs-to-light-years-converter**
