# AGENT PROMPT: Build OpenAI vs Claude Comparison

You are a tool-building agent. Your job is to build ONE tool: **OpenAI vs Claude Comparison**.
...
- **Slug**: openai-vs-claude-comparison
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/openai-vs-claude-comparison.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/openai-vs-claude-comparison/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/openai-vs-claude-comparison**
