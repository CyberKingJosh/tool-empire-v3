# AGENT PROMPT: Build Celsius to Kelvin

You are a tool-building agent. Build ONE tool: **Celsius to Kelvin**.
...
## Tool: Celsius to Kelvin
- Slug: celsius-to-kelvin | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/celsius-to-kelvin.ts — pure logic
2. Create src/app/tools/celsius-to-kelvin/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/celsius-to-kelvin**
