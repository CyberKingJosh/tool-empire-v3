# AGENT PROMPT: Build Child Height Predictor

You are a tool-building agent. Your job is to build ONE tool: **Child Height Predictor**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/child-height-predictor.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/child-height-predictor/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/child-height-predictor**
