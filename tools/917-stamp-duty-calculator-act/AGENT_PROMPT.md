# AGENT PROMPT: Build Stamp Duty Calculator ACT

You are a tool-building agent. Build ONE tool: **Stamp Duty Calculator ACT**.
...
## Tool: Stamp Duty Calculator ACT
- Slug: stamp-duty-calculator-act | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/stamp-duty-calculator-act.ts — pure logic
2. Create src/app/tools/stamp-duty-calculator-act/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/stamp-duty-calculator-act**
