# AGENT PROMPT: Build Nap Calculator

You are a tool-building agent. Your job is to build ONE tool: **Nap Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/nap-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/nap-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/nap-calculator**
