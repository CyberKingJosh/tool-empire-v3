# AGENT PROMPT: Build Days Between Dates

You are a tool-building agent. Your job is to build ONE tool: **Days Between Dates**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/days-between-dates.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/days-between-dates/page.tsx` — full page component
