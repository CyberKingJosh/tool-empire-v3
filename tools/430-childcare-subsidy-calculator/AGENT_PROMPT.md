# AGENT PROMPT: Build Childcare Subsidy Calculator

You are a tool-building agent. Your job is to build ONE tool: **Childcare Subsidy Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/childcare-subsidy-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/childcare-subsidy-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/childcare-subsidy-calculator**
