# AGENT PROMPT: Build Alcohol Dilution Calculator

You are a tool-building agent. Your job is to build ONE tool: **Alcohol Dilution Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/alcohol-dilution-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/alcohol-dilution-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/alcohol-dilution-calculator**
