# AGENT PROMPT: Build Youth Allowance Calculator

You are a tool-building agent. Your job is to build ONE tool: **Youth Allowance Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/youth-allowance-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/youth-allowance-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/youth-allowance-calculator**
