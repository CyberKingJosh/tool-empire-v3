# AGENT PROMPT: Build Payroll Tax Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **Payroll Tax Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/payroll-tax-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/payroll-tax-calculator-australia/page.tsx` — full page component
