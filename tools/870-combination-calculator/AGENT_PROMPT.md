# AGENT PROMPT: Build Combination Calculator

You are a tool-building agent. Your job is to build ONE tool: **Combination Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/combination-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/combination-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/combination-calculator**
