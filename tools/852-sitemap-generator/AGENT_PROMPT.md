# AGENT PROMPT: Build Sitemap Generator

You are a tool-building agent. Your job is to build ONE tool: **Sitemap Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sitemap-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sitemap-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sitemap-generator**
