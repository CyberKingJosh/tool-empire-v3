# AGENT PROMPT: Build Study Hours Calculator

You are a tool-building agent. Your job is to build ONE tool: **Study Hours Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/study-hours-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/study-hours-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/study-hours-calculator**
