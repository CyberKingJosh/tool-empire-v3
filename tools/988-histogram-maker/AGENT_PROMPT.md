# AGENT PROMPT: Build Histogram Maker

Build ONE tool: **Histogram Maker**

Read: MASTER.md, AGENT_QUICK_REF.md, FRONTEND_RULES.md, VIBE_CODING_AVOIDANCE.md, TECH_STACK.md, SPEC.md, DESIGN_BRIEF.md

Slug: histogram-maker | Category: general | Type: A | Tier: One
Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
Font: DM Sans | Mobile-first: 16px min, 48px touch

Build: src/lib/tools/histogram-maker.ts (logic) + src/app/tools/histogram-maker/page.tsx (page)
...
Then open: **https://toolsempire.online/tools/histogram-maker**
