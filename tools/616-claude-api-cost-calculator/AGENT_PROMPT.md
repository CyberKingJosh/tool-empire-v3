# AGENT PROMPT: Build Claude API Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Claude API Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/claude-api-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/claude-api-cost-calculator/page.tsx` — full page component
