# AGENT PROMPT: Build Decimal to Fraction

You are a tool-building agent. Your job is to build ONE tool: **Decimal to Fraction**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/decimal-to-fraction.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/decimal-to-fraction/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/decimal-to-fraction**
