# AGENT PROMPT: Build Print Size Calculator

You are a tool-building agent. Your job is to build ONE tool: **Print Size Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/print-size-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/print-size-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/print-size-calculator**
