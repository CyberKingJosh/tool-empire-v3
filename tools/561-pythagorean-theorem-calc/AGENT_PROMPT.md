# AGENT PROMPT: Build Pythagorean Theorem Calc

You are a tool-building agent. Your job is to build ONE tool: **Pythagorean Theorem Calc**.
...
## Step 2 — Tool Summary
- **Name**: Pythagorean Theorem Calc
- **Slug**: pythagorean-theorem-calc
- **Category**: education
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pythagorean-theorem-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pythagorean-theorem-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pythagorean-theorem-calc**
