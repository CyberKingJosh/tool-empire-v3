# AGENT PROMPT: Build FAHRENHEIT to CELSIUS Converter

You are a tool-building agent. Your job is to build ONE tool: **FAHRENHEIT to CELSIUS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fahrenheit-to-celsius-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fahrenheit-to-celsius-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fahrenheit-to-celsius-converter**
