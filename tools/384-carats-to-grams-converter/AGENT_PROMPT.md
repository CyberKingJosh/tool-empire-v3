# AGENT PROMPT: Build CARATS to GRAMS Converter

You are a tool-building agent. Your job is to build ONE tool: **CARATS to GRAMS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/carats-to-grams-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/carats-to-grams-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/carats-to-grams-converter**
