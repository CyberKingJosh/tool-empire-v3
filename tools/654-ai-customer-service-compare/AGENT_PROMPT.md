# AGENT PROMPT: Build AI Customer Service Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Customer Service Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-customer-service-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-customer-service-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-customer-service-compare**
