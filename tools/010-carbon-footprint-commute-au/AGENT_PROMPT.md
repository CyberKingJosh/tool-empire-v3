---
You are building Tool #010: Carbon Footprint Commute AU
...
6. /tool-empire-v3/tools/010-carbon-footprint-commute-au/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Carbon Footprint Commute AU
Target keyword: carbon footprint daily commute australia
Monthly volume: 7,500
Difficulty: Easy
RPM: $10 AUD
Monetisation: Type A
Tier: Emerging
...
API Cost: FREE
Beat difficulty: 2
Free tier: Full carbon footprint commute au with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "carbon footprint daily commute australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/carbon-footprint-commute-au/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/carbon-footprint-commute-au.ts
...
/tool-empire-v3/src/app/tools/carbon-footprint-commute-au/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Carbon Footprint Commute AU Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free carbon footprint commute au. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/010-carbon-footprint-commute-au/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Carbon Footprint Commute AU is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/010-carbon-footprint-commute-au/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/carbon-footprint-commute-au**
