# AGENT PROMPT: Build Cycling Calorie Calculator

You are a tool-building agent. Your job is to build ONE tool: **Cycling Calorie Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cycling-calorie-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cycling-calorie-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cycling-calorie-calculator**
