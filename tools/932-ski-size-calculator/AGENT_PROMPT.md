# AGENT PROMPT: Build Ski Size Calculator

You are a tool-building agent. Build ONE tool: **Ski Size Calculator**.
...
## Tool: Ski Size Calculator
- Slug: ski-size-calculator | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/ski-size-calculator.ts — pure logic
2. Create src/app/tools/ski-size-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/ski-size-calculator**
