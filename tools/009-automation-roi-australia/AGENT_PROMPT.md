---
You are building Tool #009: Automation ROI Australia
...
6. /tool-empire-v3/tools/009-automation-roi-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Automation ROI Australia
Target keyword: automation roi calculator small business australia
Monthly volume: 7,000
Difficulty: Easy
RPM: $14 AUD
Monetisation: Type A
Tier: Emerging
...
API Cost: FREE
Beat difficulty: 2
Free tier: Full automation roi australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "automation roi calculator small business australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/automation-roi-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/automation-roi-australia.ts
...
/tool-empire-v3/src/app/tools/automation-roi-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Automation ROI Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free automation roi australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/009-automation-roi-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Automation ROI Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/009-automation-roi-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/automation-roi-australia**
