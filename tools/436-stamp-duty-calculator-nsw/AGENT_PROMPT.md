# AGENT PROMPT: Build Stamp Duty Calculator NSW

You are a tool-building agent. Your job is to build ONE tool: **Stamp Duty Calculator NSW**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/stamp-duty-calculator-nsw.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/stamp-duty-calculator-nsw/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/stamp-duty-calculator-nsw**
