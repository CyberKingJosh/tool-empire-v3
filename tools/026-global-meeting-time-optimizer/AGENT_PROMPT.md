---
You are building Tool #026: Global Meeting Time Optimizer
...
6. /tool-empire-v3/tools/026-global-meeting-time-optimizer/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Global Meeting Time Optimizer
Target keyword: global team meeting time optimizer
...
API Cost: FREE
Beat difficulty: 5
Free tier: Full global meeting time optimizer with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
- Time Zone Converter at /tools/time-zone-converter
...
Search "global team meeting time optimizer". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/global-meeting-time-optimizer/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/global-meeting-time-optimizer.ts
...
/tool-empire-v3/src/app/tools/global-meeting-time-optimizer/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Global Meeting Time Optimizer Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free global meeting time optimizer. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/026-global-meeting-time-optimizer/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Global Meeting Time Optimizer is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/026-global-meeting-time-optimizer/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/global-meeting-time-optimizer**
