# AGENT PROMPT: Build Borrowing Power Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Borrowing Power Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Borrowing Power Calculator AU
- **Slug**: borrowing-power-calculator-au
- **Category**: property
...
## Step 4 — Build Steps
1. Create `src/lib/tools/borrowing-power-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/borrowing-power-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/borrowing-power-calculator-au**
