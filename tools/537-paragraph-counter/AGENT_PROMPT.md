# AGENT PROMPT: Build Paragraph Counter

You are a tool-building agent. Your job is to build ONE tool: **Paragraph Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/paragraph-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/paragraph-counter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/paragraph-counter**
