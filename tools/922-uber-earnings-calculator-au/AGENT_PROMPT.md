# AGENT PROMPT: Build Uber Earnings Calculator AU

You are a tool-building agent. Build ONE tool: **Uber Earnings Calculator AU**.
...
## Tool: Uber Earnings Calculator AU
- Slug: uber-earnings-calculator-au | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/uber-earnings-calculator-au.ts — pure logic
2. Create src/app/tools/uber-earnings-calculator-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/uber-earnings-calculator-au**
