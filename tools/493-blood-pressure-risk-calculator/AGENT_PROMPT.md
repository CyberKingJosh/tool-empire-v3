# AGENT PROMPT: Build Blood Pressure Risk Calculator

You are a tool-building agent. Your job is to build ONE tool: **Blood Pressure Risk Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/blood-pressure-risk-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/blood-pressure-risk-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/blood-pressure-risk-calculator**
