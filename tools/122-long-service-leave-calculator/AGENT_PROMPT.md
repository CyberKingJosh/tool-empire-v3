---
You are building Tool #122: Long Service Leave Calculator
...
6. /tool-empire-v3/tools/122-long-service-leave-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Long Service Leave Calculator
Target keyword: long service leave calculator australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full long service leave calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "long service leave calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/long-service-leave-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/long-service-leave-calculator.ts
...
/tool-empire-v3/src/app/tools/long-service-leave-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Long Service Leave Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free long service leave calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/122-long-service-leave-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Long Service Leave Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/122-long-service-leave-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/long-service-leave-calculator**
