# AGENT PROMPT: Build Body Corporate Fee Calc

You are a tool-building agent. Your job is to build ONE tool: **Body Corporate Fee Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/body-corporate-fee-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/body-corporate-fee-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/body-corporate-fee-calc**
