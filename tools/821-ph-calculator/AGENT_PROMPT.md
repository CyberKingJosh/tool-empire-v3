# AGENT PROMPT: Build pH Calculator

You are a tool-building agent. Your job is to build ONE tool: **pH Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ph-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ph-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ph-calculator**
