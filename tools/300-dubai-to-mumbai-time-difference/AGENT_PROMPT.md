# AGENT PROMPT: Build Dubai to Mumbai Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Dubai to Mumbai Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Dubai to Mumbai Time Difference
- **Slug**: dubai-to-mumbai-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dubai-to-mumbai-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dubai-to-mumbai-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dubai-to-mumbai-time-difference**
