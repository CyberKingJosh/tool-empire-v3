# AGENT PROMPT: Build Influencer Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Influencer Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/influencer-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/influencer-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/influencer-rate-calculator**
