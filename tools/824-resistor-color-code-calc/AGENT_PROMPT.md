# AGENT PROMPT: Build Resistor Color Code Calc

You are a tool-building agent. Your job is to build ONE tool: **Resistor Color Code Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/resistor-color-code-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/resistor-color-code-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/resistor-color-code-calc**
