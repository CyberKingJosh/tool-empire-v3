# AGENT PROMPT: Build AI Image Generator Cost Calc

You are a tool-building agent. Your job is to build ONE tool: **AI Image Generator Cost Calc**.
...
## Step 2 — Tool Summary
- **Name**: AI Image Generator Cost Calc
- **Slug**: ai-image-generator-cost-calc
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-image-generator-cost-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-image-generator-cost-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-image-generator-cost-calc**
