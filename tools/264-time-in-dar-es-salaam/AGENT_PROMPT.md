# AGENT PROMPT: Build Time in Dar es Salaam

You are a tool-building agent. Your job is to build ONE tool: **Time in Dar es Salaam**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-dar-es-salaam.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-dar-es-salaam/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-dar-es-salaam**
