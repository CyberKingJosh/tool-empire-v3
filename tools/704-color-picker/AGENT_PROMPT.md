# AGENT PROMPT: Build Color Picker

You are a tool-building agent. Your job is to build ONE tool: **Color Picker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/color-picker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/color-picker/page.tsx` — full page component
