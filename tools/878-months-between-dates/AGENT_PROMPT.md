# AGENT PROMPT: Build Months Between Dates

You are a tool-building agent. Your job is to build ONE tool: **Months Between Dates**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/months-between-dates.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/months-between-dates/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/months-between-dates**
