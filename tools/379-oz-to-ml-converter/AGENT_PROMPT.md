# AGENT PROMPT: Build OZ to ML Converter

You are a tool-building agent. Your job is to build ONE tool: **OZ to ML Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/oz-to-ml-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/oz-to-ml-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/oz-to-ml-converter**
