# AGENT PROMPT: Build Flight Time Calculator

You are a tool-building agent. Your job is to build ONE tool: **Flight Time Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/flight-time-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/flight-time-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/flight-time-calculator**
