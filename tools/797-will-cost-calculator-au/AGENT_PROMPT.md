# AGENT PROMPT: Build Will Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Will Cost Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/will-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/will-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/will-cost-calculator-au**
