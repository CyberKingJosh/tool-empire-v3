# AGENT PROMPT: Build Bench Press Calculator

You are a tool-building agent. Your job is to build ONE tool: **Bench Press Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bench-press-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bench-press-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bench-press-calculator**
