# AGENT PROMPT: Build Fraction to Decimal

You are a tool-building agent. Your job is to build ONE tool: **Fraction to Decimal**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fraction-to-decimal.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fraction-to-decimal/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fraction-to-decimal**
