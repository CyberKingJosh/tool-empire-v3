---
You are building Tool #053: Current Time In Jakarta
...
6. /tool-empire-v3/tools/053-current-time-in-jakarta/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Current Time In Jakarta
Target keyword: current time in jakarta
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full current time in jakarta with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "current time in jakarta". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/current-time-in-jakarta/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/current-time-in-jakarta.ts
...
/tool-empire-v3/src/app/tools/current-time-in-jakarta/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Current Time In Jakarta Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free current time in jakarta. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/053-current-time-in-jakarta/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Current Time In Jakarta is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/053-current-time-in-jakarta/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/current-time-in-jakarta**
