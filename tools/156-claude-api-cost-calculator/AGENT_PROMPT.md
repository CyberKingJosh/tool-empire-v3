---
You are building Tool #156: Claude API Cost Calculator
...
6. /tool-empire-v3/tools/156-claude-api-cost-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Claude API Cost Calculator
Target keyword: claude api cost calculator 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full claude api cost calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "claude api cost calculator 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/claude-api-cost-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/claude-api-cost-calculator.ts
...
/tool-empire-v3/src/app/tools/claude-api-cost-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Claude API Cost Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free claude api cost calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/156-claude-api-cost-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Claude API Cost Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/156-claude-api-cost-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/claude-api-cost-calculator**
