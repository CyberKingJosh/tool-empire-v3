# AGENT PROMPT: Build Bandwidth Calculator

You are a tool-building agent. Your job is to build ONE tool: **Bandwidth Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bandwidth-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bandwidth-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bandwidth-calculator**
