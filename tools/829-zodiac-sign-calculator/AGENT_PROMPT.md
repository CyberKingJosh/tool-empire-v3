# AGENT PROMPT: Build Zodiac Sign Calculator

You are a tool-building agent. Your job is to build ONE tool: **Zodiac Sign Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/zodiac-sign-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/zodiac-sign-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/zodiac-sign-calculator**
