# AGENT PROMPT: Build SQL Formatter

You are a tool-building agent. Your job is to build ONE tool: **SQL Formatter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sql-formatter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sql-formatter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sql-formatter**
