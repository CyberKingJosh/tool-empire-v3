# AGENT PROMPT: Build Epoch Converter

You are a tool-building agent. Your job is to build ONE tool: **Epoch Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/epoch-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/epoch-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/epoch-converter**
