# AGENT PROMPT: Build CSV to JSON Converter

You are a tool-building agent. Your job is to build ONE tool: **CSV to JSON Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/csv-to-json-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/csv-to-json-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/csv-to-json-converter**
