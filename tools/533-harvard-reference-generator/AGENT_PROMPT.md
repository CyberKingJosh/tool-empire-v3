# AGENT PROMPT: Build Harvard Reference Generator

You are a tool-building agent. Your job is to build ONE tool: **Harvard Reference Generator**.
...
## Step 2 — Tool Summary
- **Name**: Harvard Reference Generator
- **Slug**: harvard-reference-generator
- **Category**: education
...
## Step 3 — Design Brief
- Palette: Deep Blue (#0A1628 background, #4A9DFF accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/harvard-reference-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/harvard-reference-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/harvard-reference-generator**
