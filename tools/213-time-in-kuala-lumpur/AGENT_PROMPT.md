# AGENT PROMPT: Build Time in Kuala Lumpur

You are a tool-building agent. Your job is to build ONE tool: **Time in Kuala Lumpur**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-kuala-lumpur.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-kuala-lumpur/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-kuala-lumpur**
