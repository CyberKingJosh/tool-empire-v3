# AGENT PROMPT: Build Discount Calculator

You are a tool-building agent. Your job is to build ONE tool: **Discount Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/discount-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/discount-calculator/page.tsx` — full page component
