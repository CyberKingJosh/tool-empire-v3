# AGENT PROMPT: Build Meeting Time Planner

You are a tool-building agent. Your job is to build ONE tool: **Meeting Time Planner**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/meeting-time-planner.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/meeting-time-planner/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/meeting-time-planner**
