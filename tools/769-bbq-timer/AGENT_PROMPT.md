# AGENT PROMPT: Build BBQ Timer

You are a tool-building agent. Your job is to build ONE tool: **BBQ Timer**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bbq-timer.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bbq-timer/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bbq-timer**
