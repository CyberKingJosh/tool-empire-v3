# AGENT PROMPT: Build Tip Calculator

You are a tool-building agent. Your job is to build ONE tool: **Tip Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tip-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tip-calculator/page.tsx` — full page component
