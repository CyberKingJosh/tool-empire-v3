# AGENT PROMPT: Build Flashcard Maker

You are a tool-building agent. Your job is to build ONE tool: **Flashcard Maker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/flashcard-maker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/flashcard-maker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/flashcard-maker**
