---
You are building Tool #123: Payroll Tax Calculator Australia
...
6. /tool-empire-v3/tools/123-payroll-tax-calculator-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Payroll Tax Calculator Australia
Target keyword: payroll tax calculator australia by state
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full payroll tax calculator australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Related tools:
- Invoice Generator Australia at /tools/invoice-generator-australia
...
Search "payroll tax calculator australia by state". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/payroll-tax-calculator-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/payroll-tax-calculator-australia.ts
...
/tool-empire-v3/src/app/tools/payroll-tax-calculator-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Payroll Tax Calculator Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free payroll tax calculator australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/123-payroll-tax-calculator-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Payroll Tax Calculator Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/123-payroll-tax-calculator-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/payroll-tax-calculator-australia**
