# AGENT PROMPT: Build EV Charging Cost Calc AU

You are a tool-building agent. Your job is to build ONE tool: **EV Charging Cost Calc AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ev-charging-cost-calc-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ev-charging-cost-calc-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ev-charging-cost-calc-au**
