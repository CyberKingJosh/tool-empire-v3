# AGENT PROMPT: Build Time in Kathmandu

You are a tool-building agent. Your job is to build ONE tool: **Time in Kathmandu**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-kathmandu.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-kathmandu/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-kathmandu**
