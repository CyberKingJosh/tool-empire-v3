# AGENT PROMPT: Build Debt Snowball Calculator

You are a tool-building agent. Your job is to build ONE tool: **Debt Snowball Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/debt-snowball-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/debt-snowball-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/debt-snowball-calculator**
