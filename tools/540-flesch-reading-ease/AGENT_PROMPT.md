# AGENT PROMPT: Build Flesch Reading Ease

You are a tool-building agent. Your job is to build ONE tool: **Flesch Reading Ease**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/flesch-reading-ease.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/flesch-reading-ease/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/flesch-reading-ease**
