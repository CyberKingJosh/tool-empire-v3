# AGENT PROMPT: Build First Home Buyer Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **First Home Buyer Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/first-home-buyer-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/first-home-buyer-calculator-au/page.tsx` — full page component
