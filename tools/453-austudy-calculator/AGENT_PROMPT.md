# AGENT PROMPT: Build Austudy Calculator

You are a tool-building agent. Your job is to build ONE tool: **Austudy Calculator**.
...
## Step 2 — Tool Summary
- **Name**: Austudy Calculator
- **Slug**: austudy-calculator
- **Category**: finance
...
## Step 4 — Build Steps
1. Create `src/lib/tools/austudy-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/austudy-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/austudy-calculator**
