# AGENT PROMPT: Build METERS to FEET Converter

You are a tool-building agent. Your job is to build ONE tool: **METERS to FEET Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/meters-to-feet-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/meters-to-feet-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/meters-to-feet-converter**
