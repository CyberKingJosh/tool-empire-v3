# AGENT PROMPT: Build Fake Name Generator

You are a tool-building agent. Your job is to build ONE tool: **Fake Name Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fake-name-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fake-name-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fake-name-generator**
