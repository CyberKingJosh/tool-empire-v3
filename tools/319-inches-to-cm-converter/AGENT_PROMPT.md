# AGENT PROMPT: Build INCHES to CM Converter

You are a tool-building agent. Your job is to build ONE tool: **INCHES to CM Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/inches-to-cm-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/inches-to-cm-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/inches-to-cm-converter**
