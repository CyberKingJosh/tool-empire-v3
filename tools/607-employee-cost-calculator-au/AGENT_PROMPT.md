# AGENT PROMPT: Build Employee Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Employee Cost Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Employee Cost Calculator AU
- **Slug**: employee-cost-calculator-au
- **Category**: finance
...
## Step 4 — Build Steps
1. Create `src/lib/tools/employee-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/employee-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/employee-cost-calculator-au**
