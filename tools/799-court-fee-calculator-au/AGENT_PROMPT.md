# AGENT PROMPT: Build Court Fee Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Court Fee Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/court-fee-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/court-fee-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/court-fee-calculator-au**
