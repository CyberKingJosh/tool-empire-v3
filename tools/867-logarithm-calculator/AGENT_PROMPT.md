# AGENT PROMPT: Build Logarithm Calculator

You are a tool-building agent. Your job is to build ONE tool: **Logarithm Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/logarithm-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/logarithm-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/logarithm-calculator**
