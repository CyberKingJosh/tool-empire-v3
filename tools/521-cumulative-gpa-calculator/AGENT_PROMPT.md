# AGENT PROMPT: Build Cumulative GPA Calculator

You are a tool-building agent. Your job is to build ONE tool: **Cumulative GPA Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cumulative-gpa-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cumulative-gpa-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cumulative-gpa-calculator**
