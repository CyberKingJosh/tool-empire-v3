# AGENT PROMPT: Build AUD to EUR Converter

You are a tool-building agent. Your job is to build ONE tool: **AUD to EUR Converter**.
...
## Step 2 — Tool Summary
- **Name**: AUD to EUR Converter
- **Slug**: aud-to-eur-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aud-to-eur-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aud-to-eur-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/aud-to-eur-converter**
