# AGENT PROMPT: Build HEX to RGB Converter

You are a tool-building agent. Your job is to build ONE tool: **HEX to RGB Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/hex-to-rgb-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/hex-to-rgb-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/hex-to-rgb-converter**
