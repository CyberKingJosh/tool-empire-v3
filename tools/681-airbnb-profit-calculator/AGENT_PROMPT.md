# AGENT PROMPT: Build Airbnb Profit Calculator

You are a tool-building agent. Your job is to build ONE tool: **Airbnb Profit Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/airbnb-profit-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/airbnb-profit-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/airbnb-profit-calculator**
