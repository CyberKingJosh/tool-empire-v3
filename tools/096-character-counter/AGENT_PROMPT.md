---
You are building Tool #096: Character Counter
...
6. /tool-empire-v3/tools/096-character-counter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Character Counter
Target keyword: character counter online
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full character counter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "character counter online". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/character-counter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/character-counter.ts
...
/tool-empire-v3/src/app/tools/character-counter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Character Counter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free character counter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/096-character-counter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Character Counter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/096-character-counter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/character-counter**
