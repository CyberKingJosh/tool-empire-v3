# AGENT PROMPT: Build Army Body Fat Calculator

You are a tool-building agent. Your job is to build ONE tool: **Army Body Fat Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/army-body-fat-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/army-body-fat-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/army-body-fat-calculator**
