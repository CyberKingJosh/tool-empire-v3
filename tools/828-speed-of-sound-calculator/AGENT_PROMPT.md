# AGENT PROMPT: Build Speed of Sound Calculator

You are a tool-building agent. Your job is to build ONE tool: **Speed of Sound Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/speed-of-sound-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/speed-of-sound-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/speed-of-sound-calculator**
