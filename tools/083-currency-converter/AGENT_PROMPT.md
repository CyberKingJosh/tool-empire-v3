---
You are building Tool #083: Currency Converter
...
6. /tool-empire-v3/tools/083-currency-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Currency Converter
Target keyword: currency converter
...
API Cost: YELLOW
Beat difficulty: N/A
Free tier: Full currency converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "currency converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/currency-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/currency-converter.ts
...
/tool-empire-v3/src/app/tools/currency-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Currency Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free currency converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/083-currency-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Currency Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/083-currency-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/currency-converter**
