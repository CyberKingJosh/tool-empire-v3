# AGENT PROMPT: Build Molarity Calculator

You are a tool-building agent. Your job is to build ONE tool: **Molarity Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/molarity-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/molarity-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/molarity-calculator**
