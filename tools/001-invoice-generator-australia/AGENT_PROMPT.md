---
You are building Tool #001: Invoice Generator Australia
...
6. /tool-empire-v3/tools/001-invoice-generator-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Invoice Generator Australia
Target keyword: free invoice generator australia
Monthly volume: 450,000
Difficulty: Medium
RPM: $18 AUD
Monetisation: Type B
Tier: Track A
Build time estimate: 60 min
Category: finance
API Cost: FREE
Beat difficulty: N/A
Free tier: Full invoice generator australia preview on screen for free
$1 AUD export: Yes — PDF of generated document
Pro tier: N/A
Competitors and their weaknesses:
- ato.gov.au: Clunky interface, multi-step navigation
- moneysmart.gov.au: Government site, slow, no instant results
- paycalculator.com.au: Outdated design, limited to salary only

Australian data needed: Yes — ATO tax brackets 2025-26, super rate 11.5% (moving to 12%), Medicare levy 2%, GST 10%
Related tools:
- ABN Profit After Tax at /tools/abn-profit-after-tax
- ABN vs TFN Tax Comparison at /tools/abn-vs-tfn-tax-comparison
- Freelance Superannuation Calculator at /tools/freelance-superannuation-calculator
- Automation ROI Australia at /tools/automation-roi-australia

Affiliate: Xero Accounting — Best cloud accounting for Australian businesses — xero.com/au/

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: refined luxury
2. Differentiation: Australian data hardcoded with quarterly update labels — beats all US/UK-defaulting competitors
3. Unforgettable detail: The result breakdown animates step-by-step, showing each line item adding up to the total
4. Font pairing: Editorial Authority (DM Sans 700-800 + DM Mono)
5. Colour palette: Primary #0F4C75 | Accent #1B6CA8 | Surface #F0F7FF | Text #0A2540 | Result #00A878

COMPETITOR RESEARCH — Do this before any code:
Search "free invoice generator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/invoice-generator-australia/page.tsx
Import ToolLayout from shared. Set all props correctly.
Tier: Track A — 2 AdSense slots.
Tool interaction must be above fold on 375px mobile. Non-negotiable.

Step 2: Create /tool-empire-v3/src/lib/tools/invoice-generator-australia.ts
...
Type B: StripeExport inside ResultDisplay, AUD pricing. Also add AdSense slots.
...
/tool-empire-v3/src/app/tools/invoice-generator-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Invoice Generator Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free invoice generator australia. [one sentence]. No signup. Instant results.'
Schema: HowTo
...
Update /tool-empire-v3/tools/001-invoice-generator-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Invoice Generator Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/001-invoice-generator-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/invoice-generator-australia**
