# AGENT PROMPT: Build Catering Calculator

You are a tool-building agent. Your job is to build ONE tool: **Catering Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/catering-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/catering-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/catering-calculator**
