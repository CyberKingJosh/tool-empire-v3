# AGENT PROMPT: Build LCM Calculator

You are a tool-building agent. Build ONE tool: **LCM Calculator**.
...
## Tool: LCM Calculator
- Slug: lcm-calculator | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/lcm-calculator.ts — pure logic
2. Create src/app/tools/lcm-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/lcm-calculator**
