# AGENT PROMPT: Build SECONDS to MINUTES Converter

You are a tool-building agent. Your job is to build ONE tool: **SECONDS to MINUTES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/seconds-to-minutes-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/seconds-to-minutes-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/seconds-to-minutes-converter**
