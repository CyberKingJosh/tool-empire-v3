# AGENT PROMPT: Build Time in Phnom Penh

You are a tool-building agent. Your job is to build ONE tool: **Time in Phnom Penh**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-phnom-penh.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-phnom-penh/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-phnom-penh**
