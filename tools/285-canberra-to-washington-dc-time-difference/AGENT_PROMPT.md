# AGENT PROMPT: Build Canberra to Washington DC Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Canberra to Washington DC Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/canberra-to-washington-dc-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/canberra-to-washington-dc-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/canberra-to-washington-dc-time-difference**
