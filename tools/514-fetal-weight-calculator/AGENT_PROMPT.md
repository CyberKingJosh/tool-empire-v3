# AGENT PROMPT: Build Fetal Weight Calculator

You are a tool-building agent. Your job is to build ONE tool: **Fetal Weight Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fetal-weight-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fetal-weight-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fetal-weight-calculator**
