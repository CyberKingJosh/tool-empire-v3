# AGENT PROMPT: Build Pool Volume Calculator

You are a tool-building agent. Build ONE tool: **Pool Volume Calculator**.
...
## Tool: Pool Volume Calculator
- Slug: pool-volume-calculator | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/pool-volume-calculator.ts — pure logic
2. Create src/app/tools/pool-volume-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/pool-volume-calculator**
