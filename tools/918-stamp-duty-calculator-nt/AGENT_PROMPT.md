# AGENT PROMPT: Build Stamp Duty Calculator NT

You are a tool-building agent. Build ONE tool: **Stamp Duty Calculator NT**.
...
## Tool: Stamp Duty Calculator NT
- Slug: stamp-duty-calculator-nt | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/stamp-duty-calculator-nt.ts — pure logic
2. Create src/app/tools/stamp-duty-calculator-nt/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/stamp-duty-calculator-nt**
