---
You are building Tool #121: Redundancy Pay Calculator AU
...
6. /tool-empire-v3/tools/121-redundancy-pay-calculator-au/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Redundancy Pay Calculator AU
Target keyword: redundancy pay calculator australia
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full redundancy pay calculator au with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "redundancy pay calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/redundancy-pay-calculator-au/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/redundancy-pay-calculator-au.ts
...
/tool-empire-v3/src/app/tools/redundancy-pay-calculator-au/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Redundancy Pay Calculator AU Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free redundancy pay calculator au. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/121-redundancy-pay-calculator-au/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Redundancy Pay Calculator AU is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/121-redundancy-pay-calculator-au/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/redundancy-pay-calculator-au**
