# AGENT PROMPT: Build EUR to GBP Converter

You are a tool-building agent. Your job is to build ONE tool: **EUR to GBP Converter**.
...
## Step 2 — Tool Summary
- **Name**: EUR to GBP Converter
- **Slug**: eur-to-gbp-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/eur-to-gbp-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/eur-to-gbp-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/eur-to-gbp-converter**
