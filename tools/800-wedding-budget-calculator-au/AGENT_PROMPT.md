# AGENT PROMPT: Build Wedding Budget Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Wedding Budget Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Wedding Budget Calculator AU
- **Slug**: wedding-budget-calculator-au
- **Category**: finance
...
## Step 4 — Build Steps
1. Create `src/lib/tools/wedding-budget-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/wedding-budget-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/wedding-budget-calculator-au**
