# AGENT PROMPT: Build Paycheck Calculator

You are a tool-building agent. Your job is to build ONE tool: **Paycheck Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/paycheck-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/paycheck-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/paycheck-calculator**
