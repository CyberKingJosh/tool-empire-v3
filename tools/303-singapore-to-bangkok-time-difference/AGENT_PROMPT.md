# AGENT PROMPT: Build Singapore to Bangkok Time Difference

You are a tool-building agent. Your job is to build ONE tool: **Singapore to Bangkok Time Difference**.
...
## Step 2 — Tool Summary
- **Name**: Singapore to Bangkok Time Difference
- **Slug**: singapore-to-bangkok-time-difference
- **Category**: time
...
## Step 4 — Build Steps
1. Create `src/lib/tools/singapore-to-bangkok-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/singapore-to-bangkok-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/singapore-to-bangkok-time-difference**
