# AGENT PROMPT: Build Fixed vs Variable Rate Calc

You are a tool-building agent. Your job is to build ONE tool: **Fixed vs Variable Rate Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fixed-vs-variable-rate-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fixed-vs-variable-rate-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/fixed-vs-variable-rate-calc**
