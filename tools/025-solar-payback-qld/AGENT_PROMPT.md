---
You are building Tool #025: Solar Payback QLD
...
6. /tool-empire-v3/tools/025-solar-payback-qld/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Solar Payback QLD
Target keyword: solar payback calculator queensland 2026
...
API Cost: FREE
Beat difficulty: 3
Free tier: Full solar payback qld with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "solar payback calculator queensland 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/solar-payback-qld/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/solar-payback-qld.ts
...
/tool-empire-v3/src/app/tools/solar-payback-qld/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Solar Payback QLD Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free solar payback qld. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/025-solar-payback-qld/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Solar Payback QLD is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/025-solar-payback-qld/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/solar-payback-qld**
