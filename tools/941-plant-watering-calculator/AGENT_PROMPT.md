# AGENT PROMPT: Build Plant Watering Calculator

You are a tool-building agent. Build ONE tool: **Plant Watering Calculator**.
...
## Tool: Plant Watering Calculator
- Slug: plant-watering-calculator | Category: general | Type: A | Tier: One | API: FREE
- Palette: Clean Slate (#0F0F14 bg, #3B82F6 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/plant-watering-calculator.ts — pure logic
2. Create src/app/tools/plant-watering-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/plant-watering-calculator**
