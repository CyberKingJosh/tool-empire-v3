# AGENT PROMPT: Build Weighted Grade Calculator

You are a tool-building agent. Your job is to build ONE tool: **Weighted Grade Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/weighted-grade-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/weighted-grade-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/weighted-grade-calculator**
