---
You are building Tool #117: Rental Yield Calculator Australia
...
6. /tool-empire-v3/tools/117-rental-yield-calculator-australia/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Rental Yield Calculator Australia
Target keyword: rental yield calculator australia
Monthly volume: 180,000
Difficulty: Medium
RPM: $22 AUD
Monetisation: Type A
Tier: 1
Build time estimate: 35 min
Category: property
API Cost: FREE
Beat difficulty: N/A
Free tier: Full rental yield calculator australia with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- domain.com.au: Lead generation, requires contact details
- realestate.com.au: Commercial agenda, pushes listings
- canstar.com.au: Comparison site with sponsored results bias

Australian data needed: Yes — stamp duty rates by state, LMI thresholds, first home buyer grants by state
Related tools:
- Salary Needed To Buy House at /tools/salary-needed-to-buy-house
- Sydney vs Melbourne Calculator at /tools/sydney-vs-melbourne-calculator
- Cost of Living AU Cities at /tools/cost-of-living-au-cities
- Mortgage Calculator Australia at /tools/mortgage-calculator-australia

Affiliate: Canstar Home Loans — Compare 100+ Australian home loan rates — canstar.com.au/home-loans/

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: refined luxury
2. Differentiation: State-by-state Australian data with exact government rates — not generic estimates
3. Unforgettable detail: A mini house icon fills with color proportional to the result — empty for low values, full for high
4. Font pairing: Minimal Luxury (Cormorant Garamond 600 + Jost)
5. Colour palette: Primary #1A3A5C | Accent #C9A84C | Surface #F8F6F0 | Text #0A1A2A | Result #00875A

COMPETITOR RESEARCH — Do this before any code:
Search "rental yield calculator australia". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/rental-yield-calculator-australia/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/rental-yield-calculator-australia.ts
...
/tool-empire-v3/src/app/tools/rental-yield-calculator-australia/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Rental Yield Calculator Australia Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free rental yield calculator australia. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/117-rental-yield-calculator-australia/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Rental Yield Calculator Australia is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/117-rental-yield-calculator-australia/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/rental-yield-calculator-australia**
