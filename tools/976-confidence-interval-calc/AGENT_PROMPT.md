# AGENT PROMPT: Build Confidence Interval Calc

You are a tool-building agent. Build ONE tool: **Confidence Interval Calc**.
...
## Tool: Confidence Interval Calc
- Slug: confidence-interval-calc | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/confidence-interval-calc.ts — pure logic
2. Create src/app/tools/confidence-interval-calc/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/confidence-interval-calc**
