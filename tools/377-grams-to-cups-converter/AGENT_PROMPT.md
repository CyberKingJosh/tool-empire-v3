# AGENT PROMPT: Build GRAMS to CUPS Converter

You are a tool-building agent. Your job is to build ONE tool: **GRAMS to CUPS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/grams-to-cups-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/grams-to-cups-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/grams-to-cups-converter**
