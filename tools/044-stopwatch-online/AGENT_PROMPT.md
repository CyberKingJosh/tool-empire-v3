---
You are building Tool #044: Stopwatch Online
...
6. /tool-empire-v3/tools/044-stopwatch-online/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Stopwatch Online
Target keyword: online stopwatch
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full stopwatch online with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "online stopwatch". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/stopwatch-online/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/stopwatch-online.ts
...
/tool-empire-v3/src/app/tools/stopwatch-online/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Stopwatch Online Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free stopwatch online. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/044-stopwatch-online/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Stopwatch Online is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/044-stopwatch-online/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/stopwatch-online**
