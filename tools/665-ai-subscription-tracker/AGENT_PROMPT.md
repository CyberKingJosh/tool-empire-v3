# AGENT PROMPT: Build AI Subscription Tracker

You are a tool-building agent. Your job is to build ONE tool: **AI Subscription Tracker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-subscription-tracker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-subscription-tracker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-subscription-tracker**
