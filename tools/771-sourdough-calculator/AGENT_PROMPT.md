# AGENT PROMPT: Build Sourdough Calculator

You are a tool-building agent. Your job is to build ONE tool: **Sourdough Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sourdough-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sourdough-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sourdough-calculator**
