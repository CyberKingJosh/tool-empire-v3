# AGENT PROMPT: Build Pounds to Stone

You are a tool-building agent. Build ONE tool: **Pounds to Stone**.
...
## Tool: Pounds to Stone
- Slug: pounds-to-stone | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/pounds-to-stone.ts — pure logic
2. Create src/app/tools/pounds-to-stone/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/pounds-to-stone**
