# AGENT PROMPT: Build Domain Name Checker

You are a tool-building agent. Your job is to build ONE tool: **Domain Name Checker**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/domain-name-checker.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/domain-name-checker/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/domain-name-checker**
