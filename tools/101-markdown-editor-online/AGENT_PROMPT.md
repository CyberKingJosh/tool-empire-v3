---
You are building Tool #101: Markdown Editor Online
...
6. /tool-empire-v3/tools/101-markdown-editor-online/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Markdown Editor Online
Target keyword: markdown editor online free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full markdown editor online with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "markdown editor online free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/markdown-editor-online/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/markdown-editor-online.ts
...
/tool-empire-v3/src/app/tools/markdown-editor-online/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Markdown Editor Online Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free markdown editor online. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/101-markdown-editor-online/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Markdown Editor Online is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/101-markdown-editor-online/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/markdown-editor-online**
