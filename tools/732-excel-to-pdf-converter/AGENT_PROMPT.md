# AGENT PROMPT: Build Excel to PDF Converter

You are a tool-building agent. Your job is to build ONE tool: **Excel to PDF Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/excel-to-pdf-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/excel-to-pdf-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/excel-to-pdf-converter**
