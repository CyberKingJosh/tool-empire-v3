# AGENT PROMPT: Build Social Media ROI Calculator

You are a tool-building agent. Your job is to build ONE tool: **Social Media ROI Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/social-media-roi-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/social-media-roi-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/social-media-roi-calculator**
