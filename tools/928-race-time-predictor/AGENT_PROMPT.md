# AGENT PROMPT: Build Race Time Predictor

You are a tool-building agent. Build ONE tool: **Race Time Predictor**.
...
## Tool: Race Time Predictor
- Slug: race-time-predictor | Category: health | Type: A | Tier: One | API: FREE
- Palette: Green Health (#1A5C45 bg, #00E676 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/race-time-predictor.ts — pure logic
2. Create src/app/tools/race-time-predictor/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/race-time-predictor**
