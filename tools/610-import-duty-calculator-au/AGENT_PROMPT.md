# AGENT PROMPT: Build Import Duty Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Import Duty Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/import-duty-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/import-duty-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/import-duty-calculator-au**
