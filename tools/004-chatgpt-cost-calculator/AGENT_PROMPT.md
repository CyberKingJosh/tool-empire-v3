---
You are building Tool #004: ChatGPT Cost Calculator
...
6. /tool-empire-v3/tools/004-chatgpt-cost-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: ChatGPT Cost Calculator
Target keyword: chatgpt api cost calculator
...
API Cost: FREE
Beat difficulty: 2
Free tier: Full chatgpt cost calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "chatgpt api cost calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/chatgpt-cost-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/chatgpt-cost-calculator.ts
...
/tool-empire-v3/src/app/tools/chatgpt-cost-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'ChatGPT Cost Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free chatgpt cost calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/004-chatgpt-cost-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. ChatGPT Cost Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/004-chatgpt-cost-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/chatgpt-cost-calculator**
