# AGENT PROMPT: Build Screen Time Calculator

You are a tool-building agent. Your job is to build ONE tool: **Screen Time Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/screen-time-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/screen-time-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/screen-time-calculator**
