# AGENT PROMPT: Build Customer Lifetime Value Calc

You are a tool-building agent. Your job is to build ONE tool: **Customer Lifetime Value Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/customer-lifetime-value-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/customer-lifetime-value-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/customer-lifetime-value-calc**
