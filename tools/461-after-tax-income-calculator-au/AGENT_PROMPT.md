# AGENT PROMPT: Build After Tax Income Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **After Tax Income Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: After Tax Income Calculator AU
- **Slug**: after-tax-income-calculator-au
- **Category**: finance
...
## Step 4 — Build Steps
1. Create `src/lib/tools/after-tax-income-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/after-tax-income-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/after-tax-income-calculator-au**
