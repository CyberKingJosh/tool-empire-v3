# AGENT PROMPT: Build AI Safety Score Calculator

You are a tool-building agent. Your job is to build ONE tool: **AI Safety Score Calculator**.
...
## Step 2 — Tool Summary
- **Name**: AI Safety Score Calculator
- **Slug**: ai-safety-score-calculator
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-safety-score-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-safety-score-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-safety-score-calculator**
