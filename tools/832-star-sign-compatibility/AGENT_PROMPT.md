# AGENT PROMPT: Build Star Sign Compatibility

You are a tool-building agent. Your job is to build ONE tool: **Star Sign Compatibility**.
...
## Step 2 — Tool Summary
- **Name**: Star Sign Compatibility
- **Slug**: star-sign-compatibility
- **Category**: viral
...
## Step 4 — Build Steps
1. Create `src/lib/tools/star-sign-compatibility.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/star-sign-compatibility/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/star-sign-compatibility**
