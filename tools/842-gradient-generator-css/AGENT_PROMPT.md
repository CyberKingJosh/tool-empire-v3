# AGENT PROMPT: Build Gradient Generator CSS

You are a tool-building agent. Your job is to build ONE tool: **Gradient Generator CSS**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/gradient-generator-css.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/gradient-generator-css/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/gradient-generator-css**
