# AGENT PROMPT: Build Word Counter

You are a tool-building agent. Your job is to build ONE tool: **Word Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/word-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/word-counter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/word-counter**
