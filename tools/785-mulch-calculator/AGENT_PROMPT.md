# AGENT PROMPT: Build Mulch Calculator

You are a tool-building agent. Your job is to build ONE tool: **Mulch Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mulch-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mulch-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mulch-calculator**
