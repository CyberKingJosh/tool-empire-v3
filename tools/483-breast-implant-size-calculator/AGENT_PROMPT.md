# AGENT PROMPT: Build Breast Implant Size Calculator

You are a tool-building agent. Your job is to build ONE tool: **Breast Implant Size Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/breast-implant-size-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/breast-implant-size-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/breast-implant-size-calculator**
