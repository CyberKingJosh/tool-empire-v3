# AGENT PROMPT: Build Solar Savings Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Solar Savings Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Solar Savings Calculator AU
- **Slug**: solar-savings-calculator-au
- **Category**: general
...
## Step 4 — Build Steps
1. Create `src/lib/tools/solar-savings-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/solar-savings-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/solar-savings-calculator-au**
