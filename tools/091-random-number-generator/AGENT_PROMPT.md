---
You are building Tool #091: Random Number Generator
...
6. /tool-empire-v3/tools/091-random-number-generator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Random Number Generator
Target keyword: random number generator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full random number generator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "random number generator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/random-number-generator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/random-number-generator.ts
...
/tool-empire-v3/src/app/tools/random-number-generator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Random Number Generator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free random number generator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/091-random-number-generator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Random Number Generator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/091-random-number-generator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/random-number-generator**
