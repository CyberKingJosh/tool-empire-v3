---
You are building Tool #013: AI Agent Productivity Gain
...
6. /tool-empire-v3/tools/013-ai-agent-productivity-gain/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Agent Productivity Gain
Target keyword: ai agent productivity gain calculator
...
API Cost: FREE
Beat difficulty: 1
Free tier: Full ai agent productivity gain with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai agent productivity gain calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-agent-productivity-gain/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-agent-productivity-gain.ts
...
/tool-empire-v3/src/app/tools/ai-agent-productivity-gain/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Agent Productivity Gain Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai agent productivity gain. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/013-ai-agent-productivity-gain/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Agent Productivity Gain is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/013-ai-agent-productivity-gain/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-agent-productivity-gain**
