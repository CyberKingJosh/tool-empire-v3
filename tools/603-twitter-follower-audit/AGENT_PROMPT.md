# AGENT PROMPT: Build Twitter Follower Audit

You are a tool-building agent. Your job is to build ONE tool: **Twitter Follower Audit**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/twitter-follower-audit.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/twitter-follower-audit/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/twitter-follower-audit**
