# AGENT PROMPT: Build PX to EM Converter

You are a tool-building agent. Your job is to build ONE tool: **PX to EM Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/px-to-em-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/px-to-em-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/px-to-em-converter**
