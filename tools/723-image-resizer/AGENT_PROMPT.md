# AGENT PROMPT: Build Image Resizer

You are a tool-building agent. Your job is to build ONE tool: **Image Resizer**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/image-resizer.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/image-resizer/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/image-resizer**
