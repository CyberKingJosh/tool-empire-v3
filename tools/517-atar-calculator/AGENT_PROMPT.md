# AGENT PROMPT: Build ATAR Calculator

You are a tool-building agent. Your job is to build ONE tool: **ATAR Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/atar-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/atar-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/atar-calculator**
