---
You are building Tool #031: World Clock
...
6. /tool-empire-v3/tools/031-world-clock/SPEC.md — your specific tool data
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full world clock with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "world clock". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/world-clock/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/world-clock.ts
...
/tool-empire-v3/src/app/tools/world-clock/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'World Clock Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free world clock. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/031-world-clock/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. World Clock is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/031-world-clock/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/world-clock**
