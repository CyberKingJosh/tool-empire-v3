# AGENT PROMPT: Build Day of Week Calculator

You are a tool-building agent. Your job is to build ONE tool: **Day of Week Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/day-of-week-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/day-of-week-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/day-of-week-calculator**
