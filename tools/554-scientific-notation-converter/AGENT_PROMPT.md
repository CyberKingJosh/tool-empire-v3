# AGENT PROMPT: Build Scientific Notation Converter

You are a tool-building agent. Your job is to build ONE tool: **Scientific Notation Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/scientific-notation-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/scientific-notation-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/scientific-notation-converter**
