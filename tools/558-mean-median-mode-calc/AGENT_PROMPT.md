# AGENT PROMPT: Build Mean Median Mode Calc

You are a tool-building agent. Your job is to build ONE tool: **Mean Median Mode Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/mean-median-mode-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/mean-median-mode-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/mean-median-mode-calc**
