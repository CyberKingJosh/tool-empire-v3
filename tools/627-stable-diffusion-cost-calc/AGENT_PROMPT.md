# AGENT PROMPT: Build Stable Diffusion Cost Calc

You are a tool-building agent. Your job is to build ONE tool: **Stable Diffusion Cost Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/stable-diffusion-cost-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/stable-diffusion-cost-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/stable-diffusion-cost-calc**
