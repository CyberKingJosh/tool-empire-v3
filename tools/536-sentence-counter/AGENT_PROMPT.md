# AGENT PROMPT: Build Sentence Counter

You are a tool-building agent. Your job is to build ONE tool: **Sentence Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sentence-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sentence-counter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sentence-counter**
