# AGENT PROMPT: Build TDEE Calculator

You are a tool-building agent. Your job is to build ONE tool: **TDEE Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/tdee-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/tdee-calculator/page.tsx` — full page component
