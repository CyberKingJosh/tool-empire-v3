# AGENT PROMPT: Build Word to PDF Converter

You are a tool-building agent. Your job is to build ONE tool: **Word to PDF Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/word-to-pdf-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/word-to-pdf-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/word-to-pdf-converter**
