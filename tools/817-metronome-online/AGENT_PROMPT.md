# AGENT PROMPT: Build Metronome Online

You are a tool-building agent. Your job is to build ONE tool: **Metronome Online**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/metronome-online.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/metronome-online/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/metronome-online**
