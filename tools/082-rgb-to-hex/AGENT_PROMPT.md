---
You are building Tool #082: RGB To Hex
...
6. /tool-empire-v3/tools/082-rgb-to-hex/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: RGB To Hex
Target keyword: rgb to hex converter
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full rgb to hex with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "rgb to hex converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/rgb-to-hex/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/rgb-to-hex.ts
...
/tool-empire-v3/src/app/tools/rgb-to-hex/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'RGB To Hex Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free rgb to hex. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/082-rgb-to-hex/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. RGB To Hex is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/082-rgb-to-hex/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/rgb-to-hex**
