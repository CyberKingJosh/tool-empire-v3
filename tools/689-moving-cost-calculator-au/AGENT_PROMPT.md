# AGENT PROMPT: Build Moving Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Moving Cost Calculator AU**.
...
## Step 2 — Tool Summary
- **Name**: Moving Cost Calculator AU
- **Slug**: moving-cost-calculator-au
- **Category**: property
...
## Step 4 — Build Steps
1. Create `src/lib/tools/moving-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/moving-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/moving-cost-calculator-au**
