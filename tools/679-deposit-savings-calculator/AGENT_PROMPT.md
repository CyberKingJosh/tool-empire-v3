# AGENT PROMPT: Build Deposit Savings Calculator

You are a tool-building agent. Your job is to build ONE tool: **Deposit Savings Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/deposit-savings-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/deposit-savings-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/deposit-savings-calculator**
