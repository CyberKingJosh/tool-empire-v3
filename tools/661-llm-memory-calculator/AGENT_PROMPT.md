# AGENT PROMPT: Build LLM Memory Calculator

You are a tool-building agent. Your job is to build ONE tool: **LLM Memory Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/llm-memory-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/llm-memory-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/llm-memory-calculator**
