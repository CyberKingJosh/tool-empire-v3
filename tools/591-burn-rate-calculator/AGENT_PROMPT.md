# AGENT PROMPT: Build Burn Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Burn Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/burn-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/burn-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/burn-rate-calculator**
