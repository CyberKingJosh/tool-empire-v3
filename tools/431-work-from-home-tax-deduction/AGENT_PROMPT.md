# AGENT PROMPT: Build Work From Home Tax Deduction

You are a tool-building agent. Your job is to build ONE tool: **Work From Home Tax Deduction**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/work-from-home-tax-deduction.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/work-from-home-tax-deduction/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/work-from-home-tax-deduction**
