# AGENT PROMPT: Build Price Elasticity Calculator

You are a tool-building agent. Your job is to build ONE tool: **Price Elasticity Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/price-elasticity-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/price-elasticity-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/price-elasticity-calculator**
