# AGENT PROMPT: Build Date Add Subtract

You are a tool-building agent. Your job is to build ONE tool: **Date Add Subtract**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/date-add-subtract.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/date-add-subtract/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/date-add-subtract**
