# AGENT PROMPT: Build Decking Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Decking Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/decking-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/decking-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/decking-calculator-au**
