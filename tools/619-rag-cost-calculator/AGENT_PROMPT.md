# AGENT PROMPT: Build RAG Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **RAG Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/rag-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/rag-cost-calculator/page.tsx` — full page component
