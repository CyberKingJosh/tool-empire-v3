# AGENT PROMPT: Build BAR to PSI Converter

You are a tool-building agent. Your job is to build ONE tool: **BAR to PSI Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bar-to-psi-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bar-to-psi-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bar-to-psi-converter**
