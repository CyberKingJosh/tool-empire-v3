# AGENT PROMPT: Build KMH to MPH Converter

You are a tool-building agent. Your job is to build ONE tool: **KMH to MPH Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/kmh-to-mph-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/kmh-to-mph-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/kmh-to-mph-converter**
