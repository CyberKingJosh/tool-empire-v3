# AGENT PROMPT: Build PDF to Word Converter

You are a tool-building agent. Your job is to build ONE tool: **PDF to Word Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pdf-to-word-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pdf-to-word-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pdf-to-word-converter**
