# AGENT PROMPT: Build DECIMAL to OCTAL Converter

You are a tool-building agent. Your job is to build ONE tool: **DECIMAL to OCTAL Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/decimal-to-octal-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/decimal-to-octal-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/decimal-to-octal-converter**
