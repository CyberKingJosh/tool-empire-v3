---
You are building Tool #014: AI vs Agency Social Media
...
6. /tool-empire-v3/tools/014-ai-vs-agency-social-media/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI vs Agency Social Media
Target keyword: ai vs agency cost comparison social media
...
API Cost: FREE
Beat difficulty: 1
Free tier: Full ai vs agency social media with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai vs agency cost comparison social media". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-vs-agency-social-media/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-vs-agency-social-media.ts
...
/tool-empire-v3/src/app/tools/ai-vs-agency-social-media/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI vs Agency Social Media Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai vs agency social media. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/014-ai-vs-agency-social-media/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI vs Agency Social Media is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/014-ai-vs-agency-social-media/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-vs-agency-social-media**
