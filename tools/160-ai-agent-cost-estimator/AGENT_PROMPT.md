---
You are building Tool #160: AI Agent Cost Estimator
...
6. /tool-empire-v3/tools/160-ai-agent-cost-estimator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Agent Cost Estimator
Target keyword: ai agent development cost estimator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ai agent cost estimator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai agent development cost estimator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-agent-cost-estimator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-agent-cost-estimator.ts
...
/tool-empire-v3/src/app/tools/ai-agent-cost-estimator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Agent Cost Estimator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai agent cost estimator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/160-ai-agent-cost-estimator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Agent Cost Estimator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/160-ai-agent-cost-estimator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-agent-cost-estimator**
