# AGENT PROMPT: Build Correlation Calculator

You are a tool-building agent. Build ONE tool: **Correlation Calculator**.
...
## Tool: Correlation Calculator
- Slug: correlation-calculator | Category: education | Type: A | Tier: One | API: FREE
- Palette: Deep Blue (#0A1628 bg, #4A9DFF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/correlation-calculator.ts — pure logic
2. Create src/app/tools/correlation-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/correlation-calculator**
