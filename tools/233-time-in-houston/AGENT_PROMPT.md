# AGENT PROMPT: Build Time in Houston

You are a tool-building agent. Your job is to build ONE tool: **Time in Houston**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-houston.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-houston/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-houston**
