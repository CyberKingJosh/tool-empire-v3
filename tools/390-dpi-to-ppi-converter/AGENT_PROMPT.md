# AGENT PROMPT: Build DPI to PPI Converter

You are a tool-building agent. Your job is to build ONE tool: **DPI to PPI Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dpi-to-ppi-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dpi-to-ppi-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dpi-to-ppi-converter**
