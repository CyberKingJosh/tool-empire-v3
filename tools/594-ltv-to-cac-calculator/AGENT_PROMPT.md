# AGENT PROMPT: Build LTV to CAC Calculator

You are a tool-building agent. Your job is to build ONE tool: **LTV to CAC Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ltv-to-cac-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ltv-to-cac-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ltv-to-cac-calculator**
