---
You are building Tool #072: Celsius To Fahrenheit
...
6. /tool-empire-v3/tools/072-celsius-to-fahrenheit/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Celsius To Fahrenheit
Target keyword: celsius to fahrenheit
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full celsius to fahrenheit with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "celsius to fahrenheit". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/celsius-to-fahrenheit/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/celsius-to-fahrenheit.ts
...
/tool-empire-v3/src/app/tools/celsius-to-fahrenheit/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Celsius To Fahrenheit Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free celsius to fahrenheit. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/072-celsius-to-fahrenheit/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Celsius To Fahrenheit is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/072-celsius-to-fahrenheit/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/celsius-to-fahrenheit**
