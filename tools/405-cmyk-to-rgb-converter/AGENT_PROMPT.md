# AGENT PROMPT: Build CMYK to RGB Converter

You are a tool-building agent. Your job is to build ONE tool: **CMYK to RGB Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cmyk-to-rgb-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cmyk-to-rgb-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cmyk-to-rgb-converter**
