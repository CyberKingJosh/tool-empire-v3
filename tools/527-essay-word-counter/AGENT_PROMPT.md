# AGENT PROMPT: Build Essay Word Counter

You are a tool-building agent. Your job is to build ONE tool: **Essay Word Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/essay-word-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/essay-word-counter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/essay-word-counter**
