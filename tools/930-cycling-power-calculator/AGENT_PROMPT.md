# AGENT PROMPT: Build Cycling Power Calculator

You are a tool-building agent. Build ONE tool: **Cycling Power Calculator**.
...
## Tool: Cycling Power Calculator
- Slug: cycling-power-calculator | Category: health | Type: A | Tier: One | API: FREE
- Palette: Green Health (#1A5C45 bg, #00E676 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/cycling-power-calculator.ts — pure logic
2. Create src/app/tools/cycling-power-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/cycling-power-calculator**
