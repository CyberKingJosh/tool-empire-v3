# AGENT PROMPT: Build Timezone Converter

You are a tool-building agent. Your job is to build ONE tool: **Timezone Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/timezone-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/timezone-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/timezone-converter**
