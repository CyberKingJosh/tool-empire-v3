---
You are building Tool #032: Time Zone Converter
...
6. /tool-empire-v3/tools/032-time-zone-converter/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Time Zone Converter
Target keyword: time zone converter
Monthly volume: 40,000,000
Difficulty: Medium
RPM: $4 AUD
Monetisation: Type A
Tier: 0
Build time estimate: 20 min
Category: time
API Cost: FREE
Beat difficulty: N/A
Free tier: Full time zone converter with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "time zone converter". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/time-zone-converter/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/time-zone-converter.ts
...
/tool-empire-v3/src/app/tools/time-zone-converter/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Time Zone Converter Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free time zone converter. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/032-time-zone-converter/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Time Zone Converter is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/032-time-zone-converter/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/time-zone-converter**
