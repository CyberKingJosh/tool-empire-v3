# AGENT PROMPT: Build Uni Cost Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Uni Cost Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/uni-cost-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/uni-cost-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/uni-cost-calculator-au**
