# AGENT PROMPT: Build Pizza Dough Calculator

You are a tool-building agent. Your job is to build ONE tool: **Pizza Dough Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/pizza-dough-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/pizza-dough-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/pizza-dough-calculator**
