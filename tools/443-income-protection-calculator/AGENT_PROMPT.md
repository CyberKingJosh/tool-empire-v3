# AGENT PROMPT: Build Income Protection Calculator

You are a tool-building agent. Your job is to build ONE tool: **Income Protection Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/income-protection-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/income-protection-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/income-protection-calculator**
