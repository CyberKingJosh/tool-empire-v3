# AGENT PROMPT: Build KG to LBS Converter

You are a tool-building agent. Your job is to build ONE tool: **KG to LBS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/kg-to-lbs-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/kg-to-lbs-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/kg-to-lbs-converter**
