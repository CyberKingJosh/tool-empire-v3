---
You are building Tool #147: SERP Preview Tool
...
6. /tool-empire-v3/tools/147-serp-preview-tool/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: SERP Preview Tool
Target keyword: serp preview tool free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full serp preview tool with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
Competitors and their weaknesses:
- seobility.net: Limited free checks
- mangools.com: Free trial only
- ahrefs.com/free-seo-tools: Very limited free tier

Australian data needed: No
Related tools:
- UTM Builder at /tools/utm-builder
...
Affiliate: Ahrefs — Complete SEO toolset for professionals — ahrefs.com

DESIGN BRIEF — Write this in DECISIONS.md before any code:
1. Tone: bold maximalist
2. Differentiation: Live preview that exactly matches current Google SERP format — updated for 2026
3. Unforgettable detail: The SERP preview renders live as you type, exactly matching Google's current result format
4. Font pairing: Bold Magazine (Bebas Neue + Nunito)
5. Colour palette: Primary #C84B31 | Accent #E05B3A | Surface #FFF8F6 | Text #2A0F07 | Result #2563EB

COMPETITOR RESEARCH — Do this before any code:
Search "serp preview tool free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/serp-preview-tool/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/serp-preview-tool.ts
...
/tool-empire-v3/src/app/tools/serp-preview-tool/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'SERP Preview Tool Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free serp preview tool. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/147-serp-preview-tool/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. SERP Preview Tool is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/147-serp-preview-tool/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/serp-preview-tool**
