# AGENT PROMPT: Build Random Number Generator

You are a tool-building agent. Your job is to build ONE tool: **Random Number Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/random-number-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/random-number-generator/page.tsx` — full page component
