# AGENT PROMPT: Build WATTS to AMPS Converter

You are a tool-building agent. Your job is to build ONE tool: **WATTS to AMPS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/watts-to-amps-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/watts-to-amps-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/watts-to-amps-converter**
