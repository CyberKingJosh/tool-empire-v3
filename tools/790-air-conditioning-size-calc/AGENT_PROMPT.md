# AGENT PROMPT: Build Air Conditioning Size Calc

You are a tool-building agent. Your job is to build ONE tool: **Air Conditioning Size Calc**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/air-conditioning-size-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/air-conditioning-size-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/air-conditioning-size-calc**
