# AGENT PROMPT: Build Work Related Expense Calc AU

You are a tool-building agent. Build ONE tool: **Work Related Expense Calc AU**.
...
## Tool: Work Related Expense Calc AU
- Slug: work-related-expense-calc-au | Category: finance | Type: A | Tier: Two | API: FREE
- Palette: Navy Finance (#0F4C75 bg, #FFB400 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/work-related-expense-calc-au.ts — pure logic
2. Create src/app/tools/work-related-expense-calc-au/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/work-related-expense-calc-au**
