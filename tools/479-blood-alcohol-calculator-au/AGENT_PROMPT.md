# AGENT PROMPT: Build Blood Alcohol Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Blood Alcohol Calculator AU**.
...
## Step 3 — Design Brief
- Palette: Green Health (#1A5C45 background, #00E676 accent)
...
## Step 4 — Build Steps
1. Create `src/lib/tools/blood-alcohol-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/blood-alcohol-calculator-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/blood-alcohol-calculator-au**
