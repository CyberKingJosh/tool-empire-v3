# AGENT PROMPT: Build Prompt Token Counter

You are a tool-building agent. Your job is to build ONE tool: **Prompt Token Counter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/prompt-token-counter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/prompt-token-counter/page.tsx` — full page component
