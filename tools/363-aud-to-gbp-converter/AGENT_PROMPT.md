# AGENT PROMPT: Build AUD to GBP Converter

You are a tool-building agent. Your job is to build ONE tool: **AUD to GBP Converter**.
...
## Step 2 — Tool Summary
- **Name**: AUD to GBP Converter
- **Slug**: aud-to-gbp-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aud-to-gbp-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aud-to-gbp-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/aud-to-gbp-converter**
