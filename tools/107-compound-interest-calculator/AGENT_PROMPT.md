---
You are building Tool #107: Compound Interest Calculator
...
6. /tool-empire-v3/tools/107-compound-interest-calculator/SPEC.md — your specific tool data
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full compound interest calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "compound interest calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/compound-interest-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/compound-interest-calculator.ts
...
/tool-empire-v3/src/app/tools/compound-interest-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Compound Interest Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free compound interest calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/107-compound-interest-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Compound Interest Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/107-compound-interest-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/compound-interest-calculator**
