# AGENT PROMPT: Build AI Agent Cost Estimator

You are a tool-building agent. Your job is to build ONE tool: **AI Agent Cost Estimator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-agent-cost-estimator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-agent-cost-estimator/page.tsx` — full page component
