# AGENT PROMPT: Build Deadlift Calculator

You are a tool-building agent. Your job is to build ONE tool: **Deadlift Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/deadlift-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/deadlift-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/deadlift-calculator**
