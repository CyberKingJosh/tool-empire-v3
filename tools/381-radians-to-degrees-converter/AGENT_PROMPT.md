# AGENT PROMPT: Build RADIANS to DEGREES Converter

You are a tool-building agent. Your job is to build ONE tool: **RADIANS to DEGREES Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/radians-to-degrees-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/radians-to-degrees-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/radians-to-degrees-converter**
