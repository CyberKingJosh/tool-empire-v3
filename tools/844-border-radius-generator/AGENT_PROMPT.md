# AGENT PROMPT: Build Border Radius Generator

You are a tool-building agent. Your job is to build ONE tool: **Border Radius Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/border-radius-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/border-radius-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/border-radius-generator**
