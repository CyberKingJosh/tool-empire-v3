# AGENT PROMPT: Build IVF Due Date Calculator

You are a tool-building agent. Your job is to build ONE tool: **IVF Due Date Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ivf-due-date-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ivf-due-date-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ivf-due-date-calculator**
