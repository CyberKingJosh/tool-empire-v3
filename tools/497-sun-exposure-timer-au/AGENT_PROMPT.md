# AGENT PROMPT: Build Sun Exposure Timer AU

You are a tool-building agent. Your job is to build ONE tool: **Sun Exposure Timer AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sun-exposure-timer-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sun-exposure-timer-au/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sun-exposure-timer-au**
