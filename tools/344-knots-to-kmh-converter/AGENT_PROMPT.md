# AGENT PROMPT: Build KNOTS to KMH Converter

You are a tool-building agent. Your job is to build ONE tool: **KNOTS to KMH Converter**.
...
## Step 2 — Tool Summary
- **Name**: KNOTS to KMH Converter
- **Slug**: knots-to-kmh-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/knots-to-kmh-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/knots-to-kmh-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/knots-to-kmh-converter**
