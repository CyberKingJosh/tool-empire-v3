# AGENT PROMPT: Build Aspect Ratio Calculator

You are a tool-building agent. Your job is to build ONE tool: **Aspect Ratio Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aspect-ratio-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aspect-ratio-calculator/page.tsx` — full page component
