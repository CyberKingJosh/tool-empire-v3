# AGENT PROMPT: Build Dual Income Borrowing Calc

You are a tool-building agent. Your job is to build ONE tool: **Dual Income Borrowing Calc**.
...
## Step 2 — Tool Summary
- **Name**: Dual Income Borrowing Calc
- **Slug**: dual-income-borrowing-calc
- **Category**: property
...
## Step 4 — Build Steps
1. Create `src/lib/tools/dual-income-borrowing-calc.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/dual-income-borrowing-calc/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/dual-income-borrowing-calc**
