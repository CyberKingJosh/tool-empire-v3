# AGENT PROMPT: Build Wavelength Calculator

You are a tool-building agent. Your job is to build ONE tool: **Wavelength Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/wavelength-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/wavelength-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/wavelength-calculator**
