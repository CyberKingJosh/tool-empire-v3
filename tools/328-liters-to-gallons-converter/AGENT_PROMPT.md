# AGENT PROMPT: Build LITERS to GALLONS Converter

You are a tool-building agent. Your job is to build ONE tool: **LITERS to GALLONS Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/liters-to-gallons-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/liters-to-gallons-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/liters-to-gallons-converter**
