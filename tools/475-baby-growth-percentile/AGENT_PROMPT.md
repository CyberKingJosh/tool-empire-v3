# AGENT PROMPT: Build Baby Growth Percentile

You are a tool-building agent. Your job is to build ONE tool: **Baby Growth Percentile**.
...
## Step 2 — Tool Summary
- **Name**: Baby Growth Percentile
- **Slug**: baby-growth-percentile
- **Category**: health
...
## Step 4 — Build Steps
1. Create `src/lib/tools/baby-growth-percentile.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/baby-growth-percentile/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/baby-growth-percentile**
