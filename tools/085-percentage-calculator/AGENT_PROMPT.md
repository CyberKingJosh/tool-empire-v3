---
You are building Tool #085: Percentage Calculator
...
6. /tool-empire-v3/tools/085-percentage-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Percentage Calculator
Target keyword: percentage calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full percentage calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Related tools:
- Scientific Calculator at /tools/scientific-calculator
...
Search "percentage calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/percentage-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/percentage-calculator.ts
...
/tool-empire-v3/src/app/tools/percentage-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Percentage Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free percentage calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/085-percentage-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Percentage Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/085-percentage-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/percentage-calculator**
