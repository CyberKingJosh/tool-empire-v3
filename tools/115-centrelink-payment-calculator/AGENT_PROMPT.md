---
You are building Tool #115: Centrelink Payment Calculator
...
6. /tool-empire-v3/tools/115-centrelink-payment-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Centrelink Payment Calculator
Target keyword: centrelink payment calculator australia 2026
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full centrelink payment calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "centrelink payment calculator australia 2026". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/centrelink-payment-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/centrelink-payment-calculator.ts
...
/tool-empire-v3/src/app/tools/centrelink-payment-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Centrelink Payment Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free centrelink payment calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/115-centrelink-payment-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Centrelink Payment Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/115-centrelink-payment-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/centrelink-payment-calculator**
