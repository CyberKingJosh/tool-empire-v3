# AGENT PROMPT: Build LED Resistor Calculator

You are a tool-building agent. Your job is to build ONE tool: **LED Resistor Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/led-resistor-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/led-resistor-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/led-resistor-calculator**
