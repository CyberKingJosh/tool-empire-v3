# AGENT PROMPT: Build Granny Flat Cost Calculator

You are a tool-building agent. Your job is to build ONE tool: **Granny Flat Cost Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/granny-flat-cost-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/granny-flat-cost-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/granny-flat-cost-calculator**
