# AGENT PROMPT: Build Graphing Calculator

You are a tool-building agent. Your job is to build ONE tool: **Graphing Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/graphing-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/graphing-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/graphing-calculator**
