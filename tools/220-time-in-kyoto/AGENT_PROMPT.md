# AGENT PROMPT: Build Time in Kyoto

You are a tool-building agent. Your job is to build ONE tool: **Time in Kyoto**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-kyoto.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-kyoto/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-kyoto**
