# AGENT PROMPT: Build How Rich Am I Calculator

You are a tool-building agent. Your job is to build ONE tool: **How Rich Am I Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/how-rich-am-i-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/how-rich-am-i-calculator/page.tsx` — full page component
