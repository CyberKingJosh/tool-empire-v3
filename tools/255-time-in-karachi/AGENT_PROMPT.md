# AGENT PROMPT: Build Time in Karachi

You are a tool-building agent. Your job is to build ONE tool: **Time in Karachi**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-karachi.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-karachi/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-karachi**
