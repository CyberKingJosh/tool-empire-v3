# AGENT PROMPT: Build STONES to KG Converter

You are a tool-building agent. Your job is to build ONE tool: **STONES to KG Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/stones-to-kg-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/stones-to-kg-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/stones-to-kg-converter**
