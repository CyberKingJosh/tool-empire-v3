# AGENT PROMPT: Build Time in Athens

You are a tool-building agent. Your job is to build ONE tool: **Time in Athens**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-athens.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-athens/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-athens**
