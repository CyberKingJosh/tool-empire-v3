# AGENT PROMPT: Build Copilot vs Cursor Compare

You are a tool-building agent. Your job is to build ONE tool: **Copilot vs Cursor Compare**.
...
## Step 2 — Tool Summary
- **Name**: Copilot vs Cursor Compare
- **Slug**: copilot-vs-cursor-compare
- **Category**: ai
...
## Step 4 — Build Steps
1. Create `src/lib/tools/copilot-vs-cursor-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/copilot-vs-cursor-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/copilot-vs-cursor-compare**
