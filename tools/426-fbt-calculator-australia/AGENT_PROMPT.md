# AGENT PROMPT: Build FBT Calculator Australia

You are a tool-building agent. Your job is to build ONE tool: **FBT Calculator Australia**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/fbt-calculator-australia.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/fbt-calculator-australia/page.tsx` — full page component
