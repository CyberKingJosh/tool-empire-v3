# AGENT PROMPT: Build AI Presentation Maker Compare

You are a tool-building agent. Your job is to build ONE tool: **AI Presentation Maker Compare**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ai-presentation-maker-compare.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ai-presentation-maker-compare/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/ai-presentation-maker-compare**
