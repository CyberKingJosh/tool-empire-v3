---
You are building Tool #093: Discount Calculator
...
6. /tool-empire-v3/tools/093-discount-calculator/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Discount Calculator
Target keyword: discount calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full discount calculator with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "discount calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/discount-calculator/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/discount-calculator.ts
...
/tool-empire-v3/src/app/tools/discount-calculator/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Discount Calculator Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free discount calculator. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/093-discount-calculator/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Discount Calculator is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/093-discount-calculator/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/discount-calculator**
