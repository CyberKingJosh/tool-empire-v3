# AGENT PROMPT: Build Pints to Cups

You are a tool-building agent. Build ONE tool: **Pints to Cups**.
...
## Tool: Pints to Cups
- Slug: pints-to-cups | Category: converter | Type: A | Tier: One | API: FREE
- Palette: Steel Convert (#1A1A2E bg, #06D6A0 accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/pints-to-cups.ts — pure logic
2. Create src/app/tools/pints-to-cups/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/pints-to-cups**
