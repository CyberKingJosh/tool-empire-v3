# AGENT PROMPT: Build Working Capital Calculator

You are a tool-building agent. Your job is to build ONE tool: **Working Capital Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/working-capital-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/working-capital-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/working-capital-calculator**
