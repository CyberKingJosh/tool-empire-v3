# AGENT PROMPT: Build SQM to SQFT Converter

You are a tool-building agent. Your job is to build ONE tool: **SQM to SQFT Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/sqm-to-sqft-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/sqm-to-sqft-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/sqm-to-sqft-converter**
