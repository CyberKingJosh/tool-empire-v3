---
You are building Tool #152: Will AI Replace My Job
...
6. /tool-empire-v3/tools/152-will-ai-replace-my-job/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Will AI Replace My Job
Target keyword: will ai replace my job calculator
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full will ai replace my job with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "will ai replace my job calculator". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/will-ai-replace-my-job/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/will-ai-replace-my-job.ts
...
/tool-empire-v3/src/app/tools/will-ai-replace-my-job/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Will AI Replace My Job Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free will ai replace my job. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/152-will-ai-replace-my-job/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Will AI Replace My Job is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/152-will-ai-replace-my-job/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/will-ai-replace-my-job**
