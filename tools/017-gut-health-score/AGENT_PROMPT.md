---
You are building Tool #017: Gut Health Score
...
6. /tool-empire-v3/tools/017-gut-health-score/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Gut Health Score
Target keyword: gut health score assessment free
...
API Cost: FREE
Beat difficulty: 3
Free tier: Full gut health score with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "gut health score assessment free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/gut-health-score/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/gut-health-score.ts
...
/tool-empire-v3/src/app/tools/gut-health-score/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Gut Health Score Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free gut health score. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/017-gut-health-score/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Gut Health Score is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/017-gut-health-score/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/gut-health-score**
