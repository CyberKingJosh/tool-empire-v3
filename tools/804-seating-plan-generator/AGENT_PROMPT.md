# AGENT PROMPT: Build Seating Plan Generator

You are a tool-building agent. Your job is to build ONE tool: **Seating Plan Generator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/seating-plan-generator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/seating-plan-generator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/seating-plan-generator**
