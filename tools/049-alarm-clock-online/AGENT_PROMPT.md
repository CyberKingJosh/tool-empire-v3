---
You are building Tool #049: Alarm Clock Online
...
6. /tool-empire-v3/tools/049-alarm-clock-online/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: Alarm Clock Online
Target keyword: online alarm clock
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full alarm clock online with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "online alarm clock". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/alarm-clock-online/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/alarm-clock-online.ts
...
/tool-empire-v3/src/app/tools/alarm-clock-online/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'Alarm Clock Online Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free alarm clock online. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/049-alarm-clock-online/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. Alarm Clock Online is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/049-alarm-clock-online/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/alarm-clock-online**
