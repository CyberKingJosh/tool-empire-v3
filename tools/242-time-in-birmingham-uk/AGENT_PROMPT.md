# AGENT PROMPT: Build Time in Birmingham UK

You are a tool-building agent. Your job is to build ONE tool: **Time in Birmingham UK**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-birmingham-uk.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-birmingham-uk/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-birmingham-uk**
