# AGENT PROMPT: Build Email Open Rate Calculator

You are a tool-building agent. Your job is to build ONE tool: **Email Open Rate Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/email-open-rate-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/email-open-rate-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/email-open-rate-calculator**
