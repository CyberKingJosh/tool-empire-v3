---
You are building Tool #148: AI Detector Free
...
6. /tool-empire-v3/tools/148-ai-detector-free/SPEC.md — your specific tool data

TOOL SUMMARY:
Name: AI Detector Free
Target keyword: ai generated text detector free
...
API Cost: FREE
Beat difficulty: N/A
Free tier: Full ai detector free with instant results, sharing, and copy
$1 AUD export: No
Pro tier: N/A
...
Search "ai generated text detector free". Open top 3 results.
...
Step 1: Create /tool-empire-v3/src/app/tools/ai-detector-free/page.tsx
...
Step 2: Create /tool-empire-v3/src/lib/tools/ai-detector-free.ts
...
/tool-empire-v3/src/app/tools/ai-detector-free/api/route.ts
Zod validation. Rate limited. No client-exposed errors.

Step 8: SEO audit
Title: 'AI Detector Free Free Online | [Domain]'
H1: exact target keyword match only
Meta: 'Free ai detector free. [one sentence]. No signup. Instant results.'
...
Update /tool-empire-v3/tools/148-ai-detector-free/STATUS.md: NOT_STARTED → BUILT
Update /tool-empire-v3/BUILD_STATUS.md: add tool with status BUILT
Final BUILD_LOG.md entry: "All 12 steps complete. AI Detector Free is BUILT."

CONTEXT RECOVERY RULE:
If interrupted: open new Claude Code session. Say:
"Read BUILD_LOG.md in /tool-empire-v3/tools/148-ai-detector-free/ and resume from where it stopped."
...
Then open: **https://toolsempire.online/tools/ai-detector-free**
