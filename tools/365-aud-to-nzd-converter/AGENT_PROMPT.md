# AGENT PROMPT: Build AUD to NZD Converter

You are a tool-building agent. Your job is to build ONE tool: **AUD to NZD Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/aud-to-nzd-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/aud-to-nzd-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/aud-to-nzd-converter**
