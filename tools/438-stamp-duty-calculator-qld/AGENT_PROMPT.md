# AGENT PROMPT: Build Stamp Duty Calculator QLD

You are a tool-building agent. Your job is to build ONE tool: **Stamp Duty Calculator QLD**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/stamp-duty-calculator-qld.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/stamp-duty-calculator-qld/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/stamp-duty-calculator-qld**
