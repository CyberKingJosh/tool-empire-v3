# AGENT PROMPT: Build PNG to JPG Converter

You are a tool-building agent. Your job is to build ONE tool: **PNG to JPG Converter**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/png-to-jpg-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/png-to-jpg-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/png-to-jpg-converter**
