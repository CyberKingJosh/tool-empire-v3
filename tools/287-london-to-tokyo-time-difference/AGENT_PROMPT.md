# AGENT PROMPT: Build London to Tokyo Time Difference

You are a tool-building agent. Your job is to build ONE tool: **London to Tokyo Time Difference**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/london-to-tokyo-time-difference.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/london-to-tokyo-time-difference/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/london-to-tokyo-time-difference**
