# AGENT PROMPT: Build Ovulation Calculator

You are a tool-building agent. Your job is to build ONE tool: **Ovulation Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/ovulation-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/ovulation-calculator/page.tsx` — full page component
