# AGENT PROMPT: Build Numerology Calculator

You are a tool-building agent. Your job is to build ONE tool: **Numerology Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/numerology-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/numerology-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/numerology-calculator**
