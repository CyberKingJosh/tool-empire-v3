# AGENT PROMPT: Build Time in Mauritius

You are a tool-building agent. Your job is to build ONE tool: **Time in Mauritius**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-mauritius.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-mauritius/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-mauritius**
