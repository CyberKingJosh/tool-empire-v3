# AGENT PROMPT: Build Cat Food Calculator

You are a tool-building agent. Your job is to build ONE tool: **Cat Food Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/cat-food-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/cat-food-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/cat-food-calculator**
