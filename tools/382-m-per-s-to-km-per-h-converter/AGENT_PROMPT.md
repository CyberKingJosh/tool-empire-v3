# AGENT PROMPT: Build M-PER-S to KM-PER-H Converter

You are a tool-building agent. Your job is to build ONE tool: **M-PER-S to KM-PER-H Converter**.
...
## Step 2 — Tool Summary
- **Name**: M-PER-S to KM-PER-H Converter
- **Slug**: m-per-s-to-km-per-h-converter
- **Category**: converter
...
## Step 4 — Build Steps
1. Create `src/lib/tools/m-per-s-to-km-per-h-converter.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/m-per-s-to-km-per-h-converter/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/m-per-s-to-km-per-h-converter**
