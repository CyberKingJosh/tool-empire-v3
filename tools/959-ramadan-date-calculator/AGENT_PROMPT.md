# AGENT PROMPT: Build Ramadan Date Calculator

You are a tool-building agent. Build ONE tool: **Ramadan Date Calculator**.
...
## Tool: Ramadan Date Calculator
- Slug: ramadan-date-calculator | Category: date | Type: A | Tier: One | API: FREE
- Palette: Dark Clock (#0A0A0F bg, #00D4FF accent)
- Font: DM Sans | Mobile-first: 16px min, 48px touch targets

## Build Steps
1. Create src/lib/tools/ramadan-date-calculator.ts — pure logic
2. Create src/app/tools/ramadan-date-calculator/page.tsx — full page
...
Then open: **https://toolsempire.online/tools/ramadan-date-calculator**
