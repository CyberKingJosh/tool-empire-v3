# AGENT PROMPT: Build Time in Hong Kong

You are a tool-building agent. Your job is to build ONE tool: **Time in Hong Kong**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-hong-kong.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-hong-kong/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-hong-kong**
