# AGENT PROMPT: Build BMR Calculator

You are a tool-building agent. Your job is to build ONE tool: **BMR Calculator**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/bmr-calculator.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/bmr-calculator/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/bmr-calculator**
