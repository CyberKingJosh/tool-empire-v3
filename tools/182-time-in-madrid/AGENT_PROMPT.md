# AGENT PROMPT: Build Time in Madrid

You are a tool-building agent. Your job is to build ONE tool: **Time in Madrid**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/time-in-madrid.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/time-in-madrid/page.tsx` — full page component
...
Then open: **https://toolsempire.online/tools/time-in-madrid**
