# AGENT PROMPT: Build Leave Loading Calculator AU

You are a tool-building agent. Your job is to build ONE tool: **Leave Loading Calculator AU**.
...
## Step 4 — Build Steps
1. Create `src/lib/tools/leave-loading-calculator-au.ts` — pure calculation logic, zero UI
2. Create `src/app/tools/leave-loading-calculator-au/page.tsx` — full page component
